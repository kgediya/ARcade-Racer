...
//spec_const bool sc_ProxyAlphaOne 96 0
//spec_const bool sc_RayTracedAoTextureHasSwappedViews 97 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 98 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 99 0
//spec_const bool sc_RenderAlphaToColor 100 0
//spec_const bool sc_SSAOEnabled 101 0
//spec_const bool sc_ScreenTextureHasSwappedViews 102 0
//spec_const bool sc_ShaderComplexityAnalyzer 103 0
//spec_const bool sc_TAAEnabled 104 0
//spec_const bool sc_UseFramebufferFetchMarker 105 0
//spec_const bool sc_VertexBlending 106 0
//spec_const bool sc_VertexBlendingUseNormals 107 0
//spec_const int NODE_13_DROPLIST_ITEM 108 0
//spec_const int NODE_181_DROPLIST_ITEM 109 0
//spec_const int NODE_184_DROPLIST_ITEM 110 0
//spec_const int NODE_27_DROPLIST_ITEM 111 0
...
//spec_const int SC_DEVICE_CLASS 115 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 116 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 117 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 118 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 119 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 120 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 121 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 122 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 123 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 124 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 125 -1
//spec_const int baseTexLayout 126 0
//spec_const int detailNormalTexLayout 127 0
//spec_const int intensityTextureLayout 128 0
//spec_const int normalTexLayout 129 0
//spec_const int opacityTexLayout 130 0
//spec_const int sc_AmbientLightMode0 131 0
//spec_const int sc_AmbientLightMode1 132 0
//spec_const int sc_AmbientLightMode2 133 0
//spec_const int sc_AmbientLightMode_Constant 134 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 135 0
//spec_const int sc_AmbientLightMode_FromCamera 136 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 137 0
//spec_const int sc_AmbientLightsCount 138 0
//spec_const int sc_DepthBufferMode 139 0
//spec_const int sc_DirectionalLightsCount 140 0
//spec_const int sc_EnvLightMode 141 0
//spec_const int sc_EnvmapDiffuseLayout 142 0
//spec_const int sc_EnvmapSpecularLayout 143 0
//spec_const int sc_LightEstimationSGCount 144 0
//spec_const int sc_MaxTextureImageUnits 145 0
//spec_const int sc_PointLightsCount 146 0
//spec_const int sc_RayTracedAoTextureLayout 147 0
//spec_const int sc_RayTracedDiffIndTextureLayout 148 0
//spec_const int sc_RayTracedShadowTextureLayout 149 0
//spec_const int sc_RenderingSpace 150 -1
//spec_const int sc_ScreenTextureLayout 151 0
//spec_const int sc_ShaderCacheConstant 152 0
//spec_const int sc_SkinBonesCount 153 0
//spec_const int sc_StereoRenderingMode 154 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 155 0
//spec_const int sc_StereoViewID 156 0
//SG_REFLECTION_END
...
ssGlobals l9_5=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),normalize(sc_Camera.position-varPos),varPos,varColor,varPackedTex.xy,varPackedTex.zw,l9_1,l9_3,l9_4,cross(l9_4,l9_3)*varTangent.w);
#if (NODE_38_DROPLIST_ITEM==1)
{
vec3 l9_6;
Node80_If_else(0.0,vec3(0.0),vec3(0.0),l9_6,l9_5);
}
#else
{
vec3 l9_7;
...
#endif
vec4 param_5;
Node78_Gradient(varPackedTex.y,Tweak_N81,Port_Position1_N078,Tweak_N81,baseColor,param_5,l9_5);
vec4 l9_8=param_5;
vec4 param_10;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_10,l9_5);
vec4 l9_9=param_10;
float l9_10;
...
{
vec2 l9_16;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_16,l9_5);
l9_15=l9_16;
}
#else
{
...
{
vec2 l9_72;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_72,l9_5);
l9_71=l9_72;
}
#else
{
...
{
vec2 l9_74;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_74,l9_5);
l9_73=l9_74;
}
#else
{
...
{
bool l9_75=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_76=l9_69.x;
sc_SoftwareWrapEarly(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_77=l9_76;
float l9_78=l9_69.y;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_79=l9_78;
vec2 l9_80;
float l9_81;
...
{
l9_82=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_82=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_83=l9_77;
float l9_84=1.0;
sc_ClampUV(l9_83,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_82,l9_84);
float l9_85=l9_83;
float l9_86=l9_84;
bool l9_87;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_87=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_88=l9_79;
float l9_89=l9_86;
sc_ClampUV(l9_88,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_87,l9_89);
l9_81=l9_89;
...
#endif
vec2 l9_90=sc_TransformUV(l9_80,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_91=l9_90.x;
float l9_92=l9_81;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_75,l9_92);
float l9_93=l9_90.y;
float l9_94=l9_92;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_75,l9_94);
}
#else
{
bool l9_95=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_96=l9_69.x;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_97=l9_96;
float l9_98=l9_69.y;
sc_SoftwareWrapEarly(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_99=l9_98;
vec2 l9_100;
float l9_101;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_102=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_103=l9_97;
float l9_104=1.0;
sc_ClampUV(l9_103,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_102,l9_104);
float l9_105=l9_103;
float l9_106=l9_104;
bool l9_107;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_107=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_107=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_108=l9_99;
float l9_109=l9_106;
sc_ClampUV(l9_108,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_107,l9_109);
l9_101=l9_109;
...
#endif
vec2 l9_110=sc_TransformUV(l9_100,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_111=l9_110.x;
float l9_112=l9_101;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_95,l9_112);
float l9_113=l9_110.y;
float l9_114=l9_112;
sc_SoftwareWrapLate(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_95,l9_114);
}
#endif
...
{
vec2 l9_118;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_118,l9_5);
l9_117=l9_118;
}
#else
{
...
{
vec2 l9_120;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_120,l9_5);
l9_119=l9_120;
}
#else
{
l9_119=varPackedTex.xy;
}
#endif
l9_117=l9_119;
}
...
{
bool l9_121=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_122=l9_115.x;
sc_SoftwareWrapEarly(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_123=l9_122;
float l9_124=l9_115.y;
sc_SoftwareWrapEarly(l9_124,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_125=l9_124;
vec2 l9_126;
float l9_127;
...
{
l9_128=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_128=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_129=l9_123;
float l9_130=1.0;
sc_ClampUV(l9_129,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_128,l9_130);
float l9_131=l9_129;
float l9_132=l9_130;
bool l9_133;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_133=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_133=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_134=l9_125;
float l9_135=l9_132;
sc_ClampUV(l9_134,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_133,l9_135);
l9_127=l9_135;
...
#endif
vec2 l9_136=sc_TransformUV(l9_126,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_137=l9_136.x;
float l9_138=l9_127;
sc_SoftwareWrapLate(l9_137,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_121,l9_138);
float l9_139=l9_136.y;
float l9_140=l9_138;
sc_SoftwareWrapLate(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_121,l9_140);
}
#else
{
bool l9_141=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_142=l9_115.x;
sc_SoftwareWrapEarly(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_143=l9_142;
float l9_144=l9_115.y;
sc_SoftwareWrapEarly(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_145=l9_144;
vec2 l9_146;
float l9_147;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_148=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_148=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_149=l9_143;
float l9_150=1.0;
sc_ClampUV(l9_149,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_148,l9_150);
float l9_151=l9_149;
float l9_152=l9_150;
bool l9_153;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_153=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
...
float l9_154=l9_145;
float l9_155=l9_152;
sc_ClampUV(l9_154,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_153,l9_155);
l9_147=l9_155;
...
#endif
vec2 l9_156=sc_TransformUV(l9_146,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_157=l9_156.x;
float l9_158=l9_147;
sc_SoftwareWrapLate(l9_157,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_141,l9_158);
float l9_159=l9_156.y;
float l9_160=l9_158;
sc_SoftwareWrapLate(l9_159,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_141,l9_160);
}
#endif
}
#else
...
#endif
float l9_161=clamp(l9_68,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_161<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_161<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
vec4 param_5;
Node78_Gradient(l9_5.y,Tweak_N81,Port_Position1_N078,Tweak_N81,baseColor,param_5,l9_17);
vec4 l9_21=param_5;
vec4 param_10;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_10,l9_17);
vec4 l9_22=param_10;
float l9_23;
#if (ENABLE_OPACITY_TEX)
{
...
{
vec2 l9_27;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_27,l9_17);
l9_26=l9_27;
}
#else
{
...
{
vec2 l9_29;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_29,l9_17);
l9_28=l9_29;
}
#else
{
...
#endif
float l9_80=(l9_21*l9_22).w*l9_23;
float l9_81=l9_80*l9_79;
vec3 l9_82;
#if (ENABLE_NORMALMAP)
{
mat3 l9_83=mat3(l9_2,l9_0,l9_1);
vec2 l9_84;
#if (NODE_181_DROPLIST_ITEM==0)
{
l9_84=l9_5;
...
{
vec2 l9_87;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_87,l9_17);
l9_86=l9_87;
}
#else
{
...
{
vec2 l9_89;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_89,l9_17);
l9_88=l9_89;
}
#else
{
...
{
vec2 l9_143;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_143,l9_17);
l9_142=l9_143;
}
#else
{
...
{
vec2 l9_145;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_145,l9_17);
l9_144=l9_145;
}
#else
{
...
#endif
vec3 l9_205=max(l9_18.xyz,vec3(0.0));
vec4 l9_206;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
l9_206=ngsCalculateLighting(l9_205,l9_204,l9_203,l9_7,l9_8,Port_Emissive_N036,0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
...
#endif
sc_writeFragData0Internal(max(l9_211,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_213;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_231=vec4(mix(vec3(1.0),l9_210.xyz,vec3(l9_209)),l9_209);
}
#else
{
vec4 l9_232;
...
#endif
l9_232=vec4(l9_210.xyz*l9_233,l9_233);
}
#else
{
l9_232=l9_210;
...
{
l9_236=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_236=vec4(0.0);
...
vec4 l9_238=outputMotionVectorsIfNeeded(varPos,max(l9_237,vec4(0.0)));
vec4 l9_239=clamp(l9_238,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_240=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_240-0.0039215689)),min(1.0,l9_240+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_241=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_241).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_242=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_241).xy);
float l9_243=packValue(l9_242);
int l9_250=int(l9_239.w*255.0);
float l9_251=packValue(l9_250);
sc_writeFragData0Internal(vec4(packValue(l9_242),packValue(l9_242),packValue(l9_242),packValue(l9_242)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_243,packValue(l9_242),packValue(l9_242),packValue(l9_242)));
sc_writeFragData2(vec4(l9_251,packValue(l9_250),packValue(l9_250),packValue(l9_250)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_254=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_254).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_259==0)
{
l9_262=texture(sc_OITAlpha0,l9_254);
l9_261=texture(sc_OITDepthLow0,l9_254);
l9_260=texture(sc_OITDepthHigh0,l9_254);
}
else
{
l9_262=vec4(0.0);
...
if (l9_259==1)
{
l9_265=texture(sc_OITAlpha1,l9_254);
l9_264=texture(sc_OITDepthLow1,l9_254);
l9_263=texture(sc_OITDepthHigh1,l9_254);
}
else
{
l9_265=l9_262;
...
if (any(notEqual(l9_263,vec4(0.0)))||any(notEqual(l9_264,vec4(0.0))))
{
int l9_266[8]=l9_255;
unpackValues(l9_263.w,l9_259,l9_266);
unpackValues(l9_263.z,l9_259,l9_266);
unpackValues(l9_263.y,l9_259,l9_266);
unpackValues(l9_263.x,l9_259,l9_266);
unpackValues(l9_264.w,l9_259,l9_266);
unpackValues(l9_264.z,l9_259,l9_266);
unpackValues(l9_264.y,l9_259,l9_266);
unpackValues(l9_264.x,l9_259,l9_266);
int l9_275[8]=l9_256;
unpackValues(l9_265.w,l9_259,l9_275);
unpackValues(l9_265.z,l9_259,l9_275);
unpackValues(l9_265.y,l9_259,l9_275);
unpackValues(l9_265.x,l9_259,l9_275);
}
l9_259++;
continue;
}
...
vec4 l9_280=texture(sc_OITFilteredDepthBoundsTexture,l9_254);
vec2 l9_281=l9_280.xy;
int l9_282;
#if (sc_SkinBonesCount>0)
{
l9_282=encodeDepth(((1.0-l9_280.x)*1000.0)+getDepthOrderingEpsilon(),l9_281);
}
#else
{
l9_282=0;
...
#endif
int l9_283=encodeDepth(viewSpaceDepth(),l9_281);
vec4 l9_284;
l9_284=l9_239*l9_239.w;
vec4 l9_285;
int l9_286=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_286<8)
{
int l9_287=l9_255[l9_286];
int l9_288=l9_283-l9_282;
bool l9_289=l9_287<l9_288;
bool l9_290;
if (l9_289)
{
l9_290=l9_255[l9_286]>0;
}
else
{
l9_290=l9_289;
...
if (l9_290)
{
vec3 l9_291=l9_284.xyz*(1.0-(float(l9_256[l9_286])/255.0));
l9_285=vec4(l9_291.x,l9_291.y,l9_291.z,l9_284.w);
}
else
{
l9_285=l9_284;
...
sc_writeFragData0Internal(l9_284,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
