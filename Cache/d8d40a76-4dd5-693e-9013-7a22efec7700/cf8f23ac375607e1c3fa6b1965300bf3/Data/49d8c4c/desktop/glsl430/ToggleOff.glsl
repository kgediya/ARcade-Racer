...
#endif
vec4 l9_640=l9_18*vec4(colorMultiplier+1.0);
vec4 l9_641=vec4(l9_640.x,l9_640.y,l9_640.z,vec4(0.0).w);
l9_641.w=l9_18.w;
if (isProxyMode)
{
vec4 l9_642;
...
#endif
sc_writeFragData0Internal(max(l9_642,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_644;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_646=clamp(l9_18.w*2.0,0.0,1.0);
}
#else
{
float l9_647;
...
{
l9_647=clamp(dot(l9_641.xyz,vec3(l9_18.w)),0.0,1.0);
}
#else
{
float l9_648;
...
#if (sc_BlendMode_Multiply)
{
l9_649=(1.0-dot(l9_641.xyz,vec3(0.33333001)))*l9_18.w;
}
#else
{
float l9_650;
...
{
l9_650=(1.0-clamp(dot(l9_641.xyz,vec3(1.0)),0.0,1.0))*l9_18.w;
}
#else
{
float l9_651;
#if (sc_BlendMode_ColoredGlass)
{
l9_651=clamp(dot(l9_641.xyz,vec3(1.0)),0.0,1.0)*l9_18.w;
}
#else
{
float l9_652;
#if (sc_BlendMode_Add)
{
l9_652=clamp(dot(l9_641.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_653;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_653=clamp(dot(l9_641.xyz,vec3(1.0)),0.0,1.0)*l9_18.w;
}
#else
{
float l9_654;
...
{
l9_654=dot(l9_641.xyz,vec3(0.33333001))*l9_18.w;
}
#else
{
float l9_655;
#if (sc_BlendMode_Min)
{
l9_655=1.0-clamp(dot(l9_641.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_656;
#if (sc_BlendMode_Max)
{
l9_656=clamp(dot(l9_641.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_656=1.0;
...
#endif
l9_644=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_641.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_645);
}
#else
{
vec4 l9_657;
...
{
vec3 l9_659=sc_GetFramebufferColor().xyz;
vec3 l9_660=mix(l9_659,definedBlend(l9_659,l9_641.xyz).xyz,vec3(l9_18.w));
vec4 l9_661=vec4(l9_660.x,l9_660.y,l9_660.z,vec4(0.0).w);
l9_661.w=1.0;
l9_658=l9_661;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_662=vec4(mix(vec3(1.0),l9_641.xyz,vec3(l9_18.w)),l9_18.w);
}
#else
{
vec4 l9_663;
...
#endif
l9_663=vec4(l9_641.xyz*l9_664,l9_664);
}
#else
{
l9_663=l9_641;
...
{
l9_667=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_667=vec4(0.0);
...
vec4 l9_669=outputMotionVectorsIfNeeded(varPos,max(l9_668,vec4(0.0)));
