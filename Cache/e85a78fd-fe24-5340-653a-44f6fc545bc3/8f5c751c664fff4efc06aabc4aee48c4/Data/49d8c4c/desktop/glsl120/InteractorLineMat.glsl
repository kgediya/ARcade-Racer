...
ssGlobals l9_30=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_26,l9_28,normalize(sc_Camera.position-l9_28));
vec3 l9_31;
if ((l9_26.x*1.0)!=0.0)
{
vec3 l9_32;
Node63_If_else(0.0,vec3(0.0),vec3(0.0),l9_32,l9_30);
l9_31=l9_28-l9_32;
}
else
{
vec3 l9_33;
Node63_If_else(0.0,vec3(0.0),vec3(0.0),l9_33,l9_30);
l9_31=l9_28+l9_33;
}
vec3 l9_34;
vec3 l9_35;
...
vec4 param_7;
Node37_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),param_7,ssGlobals(sc_Time.x,sc_Time.y,0.0,varPackedTex.xy));
vec4 l9_0=param_7;
...
#endif
l9_16=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_20,sc_ScreenTextureLayout,l9_21).xy,0.0);
}
#endif
vec4 l9_22;
...
{
vec4 l9_23=l9_16;
l9_23.x=l9_16.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_22=l9_23;
}
#else
{
...
#endif
vec3 l9_24=mix(l9_22.xyz,definedBlend(l9_22.xyz,l9_0.xyz).xyz,vec3(l9_0.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_26=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_0.w)),l9_0.w);
}
#else
{
vec4 l9_27;
...
#endif
l9_27=vec4(l9_0.xyz*l9_28,l9_28);
}
#else
{
l9_27=l9_0;
