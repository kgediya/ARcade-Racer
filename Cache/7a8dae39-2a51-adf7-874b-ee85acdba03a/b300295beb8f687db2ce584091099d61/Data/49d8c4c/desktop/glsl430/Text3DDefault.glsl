...
//texture texture2D InnerEdgeTex 0:3:0:28
//texture texture2D backCapTex 0:4:0:29
//texture texture2D frontCapTex 0:5:0:30
//texture texture2D intensityTexture 0:6:0:31
//texture texture2D outerEdgeTex 0:7:0:32
...
//texture texture2DArray InnerEdgeTexArrSC 0:46:0:28
//texture texture2DArray backCapTexArrSC 0:47:0:29
//texture texture2DArray frontCapTexArrSC 0:48:0:30
//texture texture2DArray intensityTextureArrSC 0:49:0:31
//texture texture2DArray outerEdgeTexArrSC 0:50:0:32
...
//texture texture2DArray sc_RayTracedReflectionTextureArrSC 0:55:0:38
...
//spec_const bool sc_RayTracedReflectionTextureHasSwappedViews 94 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 95 0
...
//spec_const int DROPLIST_BACK_CAP_MODE 104 0
//spec_const int DROPLIST_FRONT_CAP_MODE 105 0
//spec_const int DROPLIST_INNER_EDGE_MODE 106 0
//spec_const int DROPLIST_OUTER_EDGE_MODE 107 0
//spec_const int InnerEdgeTexLayout 108 0
//spec_const int SC_DEVICE_CLASS 109 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_InnerEdgeTex 110 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_backCapTex 111 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_frontCapTex 112 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 113 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_outerEdgeTex 114 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_InnerEdgeTex 115 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_backCapTex 116 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_frontCapTex 117 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 118 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_outerEdgeTex 119 -1
//spec_const int backCapTexLayout 120 0
//spec_const int frontCapTexLayout 121 0
//spec_const int intensityTextureLayout 122 0
//spec_const int outerEdgeTexLayout 123 0
...
//spec_const int sc_RayTracedAoTextureLayout 140 0
//spec_const int sc_RayTracedDiffIndTextureLayout 141 0
//spec_const int sc_RayTracedReflectionTextureLayout 142 0
//spec_const int sc_RayTracedShadowTextureLayout 143 0
...
ssGlobals l9_1=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),normalize(sc_Camera.position-varPos),varPos,l9_0,varPackedTex.xy);
#if (backCapPBR)
{
vec4 l9_2;
...
sc_WriteReceiverData(varPos,l9_3,backCapRoughness);
}
#else
{
vec4 l9_4;
...
sc_WriteReceiverData(varPos,l9_6,frontCapRoughness);
}
#else
{
vec4 l9_7;
...
sc_WriteReceiverData(varPos,l9_9,outerRoughness);
}
#else
{
vec4 l9_10;
...
sc_WriteReceiverData(varPos,l9_12,InnerEdgeRoughness);
}
#else
{
vec4 l9_13;
...
ssGlobals l9_5=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_3,l9_2,l9_1,l9_0);
vec4 l9_6;
#if (backCapPBR)
{
vec4 l9_7;
...
#else
{
l9_10=ngsCalculateLighting(l9_9,Port_Opacity_N149,l9_8,l9_2,l9_3,Port_Emissive_N149,clamp(backCapMetallic,0.0,1.0),clamp(backCapRoughness,0.0,1.0),Port_AO_N149,Port_SpecularAO_N149);
}
#endif
...
#else
{
l9_16=ngsCalculateLighting(l9_15,Port_Opacity_N118,l9_14,l9_2,l9_3,Port_Emissive_N118,clamp(frontCapMetallic,0.0,1.0),clamp(frontCapRoughness,0.0,1.0),Port_AO_N118,Port_SpecularAO_N118);
}
#endif
...
#endif
vec4 l9_18=mix(l9_6,l9_12,vec4(step(l9_0.x,Port_Input1_N054)));
vec4 l9_19;
#if (outerEdgePBR)
{
vec4 l9_20;
...
#else
{
l9_23=ngsCalculateLighting(l9_22,Port_Opacity_N057,l9_21,l9_2,l9_3,Port_Emissive_N057,clamp(outerEdgeMetallic,0.0,1.0),clamp(outerRoughness,0.0,1.0),Port_AO_N057,Port_SpecularAO_N057);
}
#endif
...
#else
{
l9_29=ngsCalculateLighting(l9_28,Port_Opacity_N080,l9_27,l9_2,l9_3,Port_Emissive_N080,clamp(InnerEdgeMetallic,0.0,1.0),clamp(InnerEdgeRoughness,0.0,1.0),Port_AO_N080,Port_SpecularAO_N080);
}
#endif
...
#endif
vec4 l9_31=mix(l9_19,l9_25,vec4(step(l9_0.y,Port_Input1_N043)));
vec4 l9_32=mix(l9_18,l9_31,vec4(step(l9_0.y,Port_Input1_N014)));
if (isProxyMode)
{
vec4 l9_33;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_33,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_35;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_37=clamp(l9_32.w*2.0,0.0,1.0);
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_32.xyz,vec3(l9_32.w)),0.0,1.0);
}
#else
{
float l9_39;
...
#if (sc_BlendMode_Multiply)
{
l9_40=(1.0-dot(l9_32.xyz,vec3(0.33333001)))*l9_32.w;
}
#else
{
float l9_41;
...
{
l9_41=(1.0-clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0))*l9_32.w;
}
#else
{
float l9_42;
...
#if (sc_BlendMode_Add)
{
l9_43=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_44;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_44=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*l9_32.w;
}
#else
{
float l9_45;
...
{
l9_45=dot(l9_32.xyz,vec3(0.33333001))*l9_32.w;
}
#else
{
float l9_46;
#if (sc_BlendMode_Min)
{
l9_46=1.0-clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
#if (sc_BlendMode_Max)
{
l9_47=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_47=1.0;
...
#endif
l9_35=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_32.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_36);
}
#else
{
vec4 l9_48;
...
{
vec3 l9_50=sc_GetFramebufferColor().xyz;
vec3 l9_51=mix(l9_50,definedBlend(l9_50,l9_32.xyz).xyz,vec3(l9_32.w));
...
{
float l9_54=l9_32.w;
l9_53=vec4(mix(vec3(1.0),l9_32.xyz,vec3(l9_54)),l9_54);
}
#else
{
vec4 l9_55;
...
#endif
l9_55=vec4(l9_32.xyz*l9_57,l9_57);
}
#else
{
l9_55=l9_32;
