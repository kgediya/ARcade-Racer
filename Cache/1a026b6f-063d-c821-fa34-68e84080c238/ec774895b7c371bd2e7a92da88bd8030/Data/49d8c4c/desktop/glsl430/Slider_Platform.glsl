...
#endif
sc_writeFragData0Internal(max(l9_20,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_22;
...
{
l9_43=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_41,sc_ScreenTextureLayout,l9_42),0.0);
}
#else
{
l9_43=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_41,sc_ScreenTextureLayout,l9_42).xy,0.0);
}
#endif
l9_37=l9_43;
}
