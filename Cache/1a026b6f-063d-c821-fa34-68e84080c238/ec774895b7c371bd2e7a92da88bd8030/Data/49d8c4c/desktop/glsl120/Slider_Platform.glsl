...
#endif
l9_32=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_36,sc_ScreenTextureLayout,l9_37).xy,0.0);
}
#endif
vec4 l9_38;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_51-0.0039215689)),min(1.0,l9_51+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_53),packValue(l9_53),packValue(l9_53),packValue(l9_53)),sc_UniformConstants.x,sc_ShaderCacheConstant);
