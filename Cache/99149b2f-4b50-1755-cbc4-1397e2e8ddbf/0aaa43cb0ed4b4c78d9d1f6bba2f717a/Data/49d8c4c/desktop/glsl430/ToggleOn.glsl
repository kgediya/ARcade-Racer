...
{
vec2 l9_13;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_13,l9_5);
l9_12=l9_13;
}
#else
{
...
{
vec2 l9_15;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_15,l9_5);
l9_14=l9_15;
}
#else
{
...
{
bool l9_17=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_18=l9_10.x;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_19=l9_18;
float l9_20=l9_10.y;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_21=l9_20;
vec2 l9_22;
float l9_23;
...
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_24=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_25=l9_19;
float l9_26=1.0;
sc_ClampUV(l9_25,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_24,l9_26);
float l9_27=l9_25;
float l9_28=l9_26;
bool l9_29;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_30=l9_21;
float l9_31=l9_28;
sc_ClampUV(l9_30,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_29,l9_31);
l9_23=l9_31;
...
#endif
vec2 l9_32=sc_TransformUV(l9_22,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_33=l9_32.x;
float l9_34=l9_23;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_17,l9_34);
float l9_35=l9_32.y;
float l9_36=l9_34;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_17,l9_36);
float l9_37=l9_36;
vec3 l9_38=sc_SamplingCoordsViewToGlobal(vec2(l9_33,l9_35),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_39=texture(opacityTexArrSC,l9_38,0.0);
vec4 l9_40;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_40=mix(opacityTexBorderColor,l9_39,vec4(l9_37));
}
#else
{
l9_40=l9_39;
...
#else
{
bool l9_41=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_42=l9_10.x;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_43=l9_42;
float l9_44=l9_10.y;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_45=l9_44;
vec2 l9_46;
float l9_47;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_49=l9_43;
float l9_50=1.0;
sc_ClampUV(l9_49,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_48,l9_50);
float l9_51=l9_49;
float l9_52=l9_50;
bool l9_53;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_53=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_53=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_54=l9_45;
float l9_55=l9_52;
sc_ClampUV(l9_54,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_53,l9_55);
l9_47=l9_55;
...
#endif
vec2 l9_56=sc_TransformUV(l9_46,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_57=l9_56.x;
float l9_58=l9_47;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_41,l9_58);
float l9_59=l9_56.y;
float l9_60=l9_58;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_41,l9_60);
float l9_61=l9_60;
vec3 l9_62=sc_SamplingCoordsViewToGlobal(vec2(l9_57,l9_59),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_63=texture(opacityTex,l9_62.xy,0.0);
vec4 l9_64;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_64=mix(opacityTexBorderColor,l9_63,vec4(l9_61));
}
#else
{
l9_64=l9_63;
...
#else
{
l9_65=Port_Input2_N072;
}
#endif
float l9_66=(mix(baseColor,SecondGradient,vec4(varPackedTex.y))*l9_8).w*l9_9;
float l9_67=l9_66*l9_65;
#if (ENABLE_NORMALMAP)
{
vec2 l9_68;
...
{
vec2 l9_71;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_71,l9_5);
l9_70=l9_71;
}
#else
{
...
{
vec2 l9_73;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_73,l9_5);
l9_72=l9_73;
}
#else
{
l9_72=varPackedTex.xy;
}
#endif
l9_70=l9_72;
}
...
{
bool l9_74=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_75=l9_68.x;
...
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_74,l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_74,l9_93);
}
#else
{
bool l9_94=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_95=l9_68.x;
sc_SoftwareWrapEarly(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_96=l9_95;
float l9_97=l9_68.y;
sc_SoftwareWrapEarly(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_98=l9_97;
vec2 l9_99;
float l9_100;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_101=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_102=l9_96;
float l9_103=1.0;
sc_ClampUV(l9_102,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_101,l9_103);
float l9_104=l9_102;
float l9_105=l9_103;
bool l9_106;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_106=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_106=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_107=l9_98;
float l9_108=l9_105;
sc_ClampUV(l9_107,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_106,l9_108);
l9_100=l9_108;
...
#endif
vec2 l9_109=sc_TransformUV(l9_99,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_110=l9_109.x;
float l9_111=l9_100;
sc_SoftwareWrapLate(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_94,l9_111);
float l9_112=l9_109.y;
float l9_113=l9_111;
sc_SoftwareWrapLate(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_94,l9_113);
}
#endif
...
{
vec2 l9_117;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_117,l9_5);
l9_116=l9_117;
}
#else
{
...
{
vec2 l9_119;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_119,l9_5);
l9_118=l9_119;
}
#else
{
l9_118=varPackedTex.xy;
}
#endif
l9_116=l9_118;
}
...
{
bool l9_120=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_121=l9_114.x;
sc_SoftwareWrapEarly(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_122=l9_121;
float l9_123=l9_114.y;
sc_SoftwareWrapEarly(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_124=l9_123;
vec2 l9_125;
float l9_126;
...
{
l9_127=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_127=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_128=l9_122;
float l9_129=1.0;
sc_ClampUV(l9_128,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_127,l9_129);
float l9_130=l9_128;
float l9_131=l9_129;
bool l9_132;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_132=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_132=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_133=l9_124;
float l9_134=l9_131;
sc_ClampUV(l9_133,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_132,l9_134);
l9_126=l9_134;
...
#endif
vec2 l9_135=sc_TransformUV(l9_125,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_136=l9_135.x;
float l9_137=l9_126;
sc_SoftwareWrapLate(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_120,l9_137);
float l9_138=l9_135.y;
float l9_139=l9_137;
sc_SoftwareWrapLate(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_120,l9_139);
}
#else
{
bool l9_140=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_141=l9_114.x;
sc_SoftwareWrapEarly(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_142=l9_141;
float l9_143=l9_114.y;
sc_SoftwareWrapEarly(l9_143,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_144=l9_143;
vec2 l9_145;
float l9_146;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_147=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_147=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_148=l9_142;
float l9_149=1.0;
sc_ClampUV(l9_148,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_147,l9_149);
float l9_150=l9_148;
float l9_151=l9_149;
bool l9_152;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_152=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_152=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_153=l9_144;
float l9_154=l9_151;
sc_ClampUV(l9_153,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_152,l9_154);
l9_146=l9_154;
...
#endif
vec2 l9_155=sc_TransformUV(l9_145,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_156=l9_155.x;
float l9_157=l9_146;
sc_SoftwareWrapLate(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_140,l9_157);
float l9_158=l9_155.y;
float l9_159=l9_157;
sc_SoftwareWrapLate(l9_158,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_140,l9_159);
}
#endif
}
#else
...
#endif
float l9_160=clamp(l9_67,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_160<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_160<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
float l9_79=(mix(baseColor,SecondGradient,vec4(l9_5.y))*l9_21).w*l9_22;
...
vec4 l9_207=l9_206*vec4(colorMultiplier+1.0);
float l9_208=l9_206.w;
vec4 l9_209=vec4(l9_207.x,l9_207.y,l9_207.z,vec4(0.0).w);
l9_209.w=l9_208;
if (isProxyMode)
{
vec4 l9_210;
...
#endif
sc_writeFragData0Internal(max(l9_210,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_212;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_214=clamp(l9_208*2.0,0.0,1.0);
}
#else
{
float l9_215;
...
{
l9_215=clamp(dot(l9_209.xyz,vec3(l9_208)),0.0,1.0);
}
#else
{
float l9_216;
...
#if (sc_BlendMode_Multiply)
{
l9_217=(1.0-dot(l9_209.xyz,vec3(0.33333001)))*l9_208;
}
#else
{
float l9_218;
...
{
l9_218=(1.0-clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0))*l9_208;
}
#else
{
float l9_219;
#if (sc_BlendMode_ColoredGlass)
{
l9_219=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0)*l9_208;
}
#else
{
float l9_220;
#if (sc_BlendMode_Add)
{
l9_220=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_221;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_221=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0)*l9_208;
}
#else
{
float l9_222;
...
{
l9_222=dot(l9_209.xyz,vec3(0.33333001))*l9_208;
}
#else
{
float l9_223;
#if (sc_BlendMode_Min)
{
l9_223=1.0-clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_224;
#if (sc_BlendMode_Max)
{
l9_224=clamp(dot(l9_209.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_224=1.0;
...
#endif
l9_212=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_209.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_213);
}
#else
{
vec4 l9_225;
...
{
vec3 l9_227=sc_GetFramebufferColor().xyz;
vec3 l9_228=mix(l9_227,definedBlend(l9_227,l9_209.xyz).xyz,vec3(l9_208));
vec4 l9_229=vec4(l9_228.x,l9_228.y,l9_228.z,vec4(0.0).w);
l9_229.w=1.0;
l9_226=l9_229;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_230=vec4(mix(vec3(1.0),l9_209.xyz,vec3(l9_208)),l9_208);
}
#else
{
vec4 l9_231;
...
#endif
l9_231=vec4(l9_209.xyz*l9_232,l9_232);
}
#else
{
l9_231=l9_209;
...
#if (sc_OITCompositingPass)
{
vec2 l9_253=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
