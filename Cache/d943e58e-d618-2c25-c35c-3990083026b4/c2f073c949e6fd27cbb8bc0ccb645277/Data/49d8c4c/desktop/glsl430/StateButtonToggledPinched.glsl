...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_icon 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_icon 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 88 -1
//spec_const int additional_settings_btn_refl_texLayout 89 0
//spec_const int iconLayout 90 0
...
{
bool l9_19=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_20=l9_17.x;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_21=l9_20;
float l9_22=l9_17.y;
sc_SoftwareWrapEarly(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_23=l9_22;
vec2 l9_24;
float l9_25;
...
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_27=l9_21;
float l9_28=1.0;
sc_ClampUV(l9_27,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_26,l9_28);
float l9_29=l9_27;
float l9_30=l9_28;
bool l9_31;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_31=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_31=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_32=l9_23;
float l9_33=l9_30;
sc_ClampUV(l9_32,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_31,l9_33);
l9_25=l9_33;
...
#endif
vec2 l9_34=sc_TransformUV(l9_24,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_19,l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_19,l9_38);
float l9_39=l9_38;
vec3 l9_40=sc_SamplingCoordsViewToGlobal(vec2(l9_35,l9_37),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_41=texture(additional_settings_btn_refl_texArrSC,l9_40,0.0);
vec4 l9_42;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_42=mix(additional_settings_btn_refl_texBorderColor,l9_41,vec4(l9_39));
}
#else
{
l9_42=l9_41;
...
#else
{
bool l9_43=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_44=l9_17.x;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_45=l9_44;
float l9_46=l9_17.y;
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_47=l9_46;
vec2 l9_48;
float l9_49;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_50=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_51=l9_45;
float l9_52=1.0;
sc_ClampUV(l9_51,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_50,l9_52);
float l9_53=l9_51;
float l9_54=l9_52;
bool l9_55;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_55=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_55=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_56=l9_47;
float l9_57=l9_54;
sc_ClampUV(l9_56,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_55,l9_57);
l9_49=l9_57;
...
#endif
vec2 l9_58=sc_TransformUV(l9_48,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_59=l9_58.x;
float l9_60=l9_49;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_43,l9_60);
float l9_61=l9_58.y;
float l9_62=l9_60;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_43,l9_62);
float l9_63=l9_62;
vec3 l9_64=sc_SamplingCoordsViewToGlobal(vec2(l9_59,l9_61),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_65=texture(additional_settings_btn_refl_tex,l9_64.xy,0.0);
vec4 l9_66;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_66=mix(additional_settings_btn_refl_texBorderColor,l9_65,vec4(l9_63));
}
#else
{
l9_66=l9_65;
...
#endif
vec4 l9_67=vec4(Port_Import_N006)*l9_18;
vec3 l9_68=l9_12*Port_Import_N068;
float l9_69=dot(l9_68,l9_68);
float l9_70;
if (l9_69>0.0)
{
l9_70=1.0/sqrt(l9_69);
}
else
{
l9_70=0.0;
}
vec3 l9_71=l9_68*l9_70;
vec3 l9_72=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_71,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_73;
#if (additional_settings_btn_refl_texLayout==2)
{
bool l9_74=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_75=l9_72.x;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_76=l9_75;
float l9_77=l9_72.y;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_78=l9_77;
vec2 l9_79;
float l9_80;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_82=l9_76;
float l9_83=1.0;
sc_ClampUV(l9_82,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_81,l9_83);
float l9_84=l9_82;
float l9_85=l9_83;
bool l9_86;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_86=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_86=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_87=l9_78;
float l9_88=l9_85;
sc_ClampUV(l9_87,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_86,l9_88);
l9_80=l9_88;
l9_79=vec2(l9_84,l9_87);
}
#else
...
#endif
vec2 l9_89=sc_TransformUV(l9_79,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_74,l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_74,l9_93);
float l9_94=l9_93;
vec3 l9_95=sc_SamplingCoordsViewToGlobal(vec2(l9_90,l9_92),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_96=texture(additional_settings_btn_refl_texArrSC,l9_95,0.0);
vec4 l9_97;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_97=mix(additional_settings_btn_refl_texBorderColor,l9_96,vec4(l9_94));
}
#else
{
l9_97=l9_96;
...
#else
{
bool l9_98=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_99=l9_72.x;
sc_SoftwareWrapEarly(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_100=l9_99;
float l9_101=l9_72.y;
sc_SoftwareWrapEarly(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_102=l9_101;
vec2 l9_103;
float l9_104;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_106=l9_100;
float l9_107=1.0;
sc_ClampUV(l9_106,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_105,l9_107);
float l9_108=l9_106;
float l9_109=l9_107;
bool l9_110;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_110=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_110=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_111=l9_102;
float l9_112=l9_109;
sc_ClampUV(l9_111,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_110,l9_112);
l9_104=l9_112;
...
#endif
vec2 l9_113=sc_TransformUV(l9_103,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_114=l9_113.x;
float l9_115=l9_104;
sc_SoftwareWrapLate(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_98,l9_115);
float l9_116=l9_113.y;
float l9_117=l9_115;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_98,l9_117);
float l9_118=l9_117;
vec3 l9_119=sc_SamplingCoordsViewToGlobal(vec2(l9_114,l9_116),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_120=texture(additional_settings_btn_refl_tex,l9_119.xy,0.0);
vec4 l9_121;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_121=mix(additional_settings_btn_refl_texBorderColor,l9_120,vec4(l9_118));
}
#else
{
l9_121=l9_120;
...
#endif
vec4 l9_122=vec4(Port_Import_N062)*l9_73;
vec2 l9_123=l9_4*Port_Input1_N009;
float l9_124=clamp(length(l9_123+Port_Input2_N009),0.0,1.0);
vec4 l9_125;
if (l9_124<Port_Position1_N003)
{
l9_125=mix(Port_Value0_N003,Port_Value1_N003,vec4(clamp(l9_124/Port_Position1_N003,0.0,1.0)));
}
else
{
vec4 l9_126;
if (l9_124<Port_Position2_N003)
{
l9_126=mix(Port_Value1_N003,Port_Value2_N003,vec4(clamp((l9_124-Port_Position1_N003)/(Port_Position2_N003-Port_Position1_N003),0.0,1.0)));
}
else
{
vec4 l9_127;
if (l9_124<Port_Position3_N003)
{
l9_127=mix(Port_Value2_N003,Port_Value3_N003,vec4(clamp((l9_124-Port_Position2_N003)/(Port_Position3_N003-Port_Position2_N003),0.0,1.0)));
}
else
{
l9_127=mix(Port_Value3_N003,Port_Value4_N003,vec4(clamp((l9_124-Port_Position3_N003)/(1.0-Port_Position3_N003),0.0,1.0)));
}
l9_126=l9_127;
}
l9_125=l9_126;
}
bool l9_128=PreviewEnabled==1;
bool l9_129;
if (l9_128)
{
l9_129=!l9_0;
...
vec4 l9_133=mix(l9_67,l9_122,vec4(Port_Input2_N005))+l9_125;
vec2 l9_134=l9_5-Port_Center_N002;
vec2 l9_135=(l9_134*Port_Scale_N002)+Port_Center_N002;
vec4 l9_136;
#if (iconLayout==2)
{
bool l9_137=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_138=l9_135.x;
sc_SoftwareWrapEarly(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_139=l9_138;
float l9_140=l9_135.y;
sc_SoftwareWrapEarly(l9_140,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_141=l9_140;
vec2 l9_142;
float l9_143;
...
{
l9_144=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_145=l9_139;
float l9_146=1.0;
sc_ClampUV(l9_145,iconUvMinMax.x,iconUvMinMax.z,l9_144,l9_146);
float l9_147=l9_145;
float l9_148=l9_146;
bool l9_149;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_149=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_149=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_150=l9_141;
float l9_151=l9_148;
sc_ClampUV(l9_150,iconUvMinMax.y,iconUvMinMax.w,l9_149,l9_151);
l9_143=l9_151;
...
#endif
vec2 l9_152=sc_TransformUV(l9_142,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_153=l9_152.x;
float l9_154=l9_143;
sc_SoftwareWrapLate(l9_153,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_137,l9_154);
float l9_155=l9_152.y;
float l9_156=l9_154;
sc_SoftwareWrapLate(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_137,l9_156);
float l9_157=l9_156;
vec3 l9_158=sc_SamplingCoordsViewToGlobal(vec2(l9_153,l9_155),iconLayout,iconGetStereoViewIndex());
vec4 l9_159=texture(iconArrSC,l9_158,0.0);
vec4 l9_160;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_160=mix(iconBorderColor,l9_159,vec4(l9_157));
}
#else
{
l9_160=l9_159;
...
#else
{
bool l9_161=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_162=l9_135.x;
sc_SoftwareWrapEarly(l9_162,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_163=l9_162;
float l9_164=l9_135.y;
sc_SoftwareWrapEarly(l9_164,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_165=l9_164;
vec2 l9_166;
float l9_167;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_168=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_168=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_169=l9_163;
float l9_170=1.0;
sc_ClampUV(l9_169,iconUvMinMax.x,iconUvMinMax.z,l9_168,l9_170);
float l9_171=l9_169;
float l9_172=l9_170;
bool l9_173;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_173=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_173=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_174=l9_165;
float l9_175=l9_172;
sc_ClampUV(l9_174,iconUvMinMax.y,iconUvMinMax.w,l9_173,l9_175);
l9_167=l9_175;
...
#endif
vec2 l9_176=sc_TransformUV(l9_166,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_177=l9_176.x;
float l9_178=l9_167;
sc_SoftwareWrapLate(l9_177,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_161,l9_178);
float l9_179=l9_176.y;
float l9_180=l9_178;
sc_SoftwareWrapLate(l9_179,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_161,l9_180);
float l9_181=l9_180;
vec3 l9_182=sc_SamplingCoordsViewToGlobal(vec2(l9_177,l9_179),iconLayout,iconGetStereoViewIndex());
vec4 l9_183=texture(icon,l9_182.xy,0.0);
vec4 l9_184;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_184=mix(iconBorderColor,l9_183,vec4(l9_181));
}
#else
{
l9_184=l9_183;
...
#if (iconLayout==2)
{
bool l9_187=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_188=l9_135.x;
sc_SoftwareWrapEarly(l9_188,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_189=l9_188;
float l9_190=l9_135.y;
sc_SoftwareWrapEarly(l9_190,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_191=l9_190;
vec2 l9_192;
float l9_193;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_194=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_194=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_195=l9_189;
float l9_196=1.0;
sc_ClampUV(l9_195,iconUvMinMax.x,iconUvMinMax.z,l9_194,l9_196);
float l9_197=l9_195;
float l9_198=l9_196;
bool l9_199;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_199=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_199=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_200=l9_191;
float l9_201=l9_198;
sc_ClampUV(l9_200,iconUvMinMax.y,iconUvMinMax.w,l9_199,l9_201);
l9_193=l9_201;
...
#endif
vec2 l9_202=sc_TransformUV(l9_192,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_203=l9_202.x;
float l9_204=l9_193;
sc_SoftwareWrapLate(l9_203,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_187,l9_204);
float l9_205=l9_202.y;
float l9_206=l9_204;
sc_SoftwareWrapLate(l9_205,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_187,l9_206);
float l9_207=l9_206;
vec3 l9_208=sc_SamplingCoordsViewToGlobal(vec2(l9_203,l9_205),iconLayout,iconGetStereoViewIndex());
vec4 l9_209=texture(iconArrSC,l9_208,0.0);
vec4 l9_210;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_210=mix(iconBorderColor,l9_209,vec4(l9_207));
}
#else
{
l9_210=l9_209;
...
#else
{
bool l9_211=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_212=l9_135.x;
sc_SoftwareWrapEarly(l9_212,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_213=l9_212;
float l9_214=l9_135.y;
sc_SoftwareWrapEarly(l9_214,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_215=l9_214;
vec2 l9_216;
float l9_217;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_218=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_218=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_219=l9_213;
float l9_220=1.0;
sc_ClampUV(l9_219,iconUvMinMax.x,iconUvMinMax.z,l9_218,l9_220);
float l9_221=l9_219;
float l9_222=l9_220;
bool l9_223;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_223=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_223=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_224=l9_215;
float l9_225=l9_222;
sc_ClampUV(l9_224,iconUvMinMax.y,iconUvMinMax.w,l9_223,l9_225);
l9_217=l9_225;
...
#endif
vec2 l9_226=sc_TransformUV(l9_216,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_227=l9_226.x;
float l9_228=l9_217;
sc_SoftwareWrapLate(l9_227,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_211,l9_228);
float l9_229=l9_226.y;
float l9_230=l9_228;
sc_SoftwareWrapLate(l9_229,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_211,l9_230);
float l9_231=l9_230;
vec3 l9_232=sc_SamplingCoordsViewToGlobal(vec2(l9_227,l9_229),iconLayout,iconGetStereoViewIndex());
vec4 l9_233=texture(icon,l9_232.xy,0.0);
vec4 l9_234;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_234=mix(iconBorderColor,l9_233,vec4(l9_231));
}
#else
{
l9_234=l9_233;
...
{
l9_185=Port_Input2_N007;
}
vec4 l9_235=vec4(l9_185);
vec4 l9_236=mix(l9_133,l9_136,l9_235);
