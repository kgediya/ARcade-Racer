...
ssGlobals l9_6=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_5,varPos,varPos,l9_0,l9_1,l9_2,varPackedTex.xy,varPackedTex.zw,l9_4,varColor);
vec4 l9_7;
...
#if (ENABLE_BASE_TEX)
{
vec2 l9_13=N35_getUV(NODE_7_DROPLIST_ITEM);
vec2 l9_14;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_17=N3_getUV(NODE_10_DROPLIST_ITEM);
vec2 l9_18;
...
float l9_40=l9_39;
vec3 l9_41=sc_SamplingCoordsViewToGlobal(vec2(l9_36,l9_38),emissiveTextureLayout,l9_19);
vec4 l9_42=texture2D(emissiveTexture,l9_41.xy,0.0);
vec4 l9_43;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTexture)
{
...
#endif
l9_16=ssSRGB_to_Linear(l9_43.xyz)*ssSRGB_to_Linear(emissiveFactor);
}
#else
{
...
#endif
vec3 l9_44=tempGlobals.VertexNormal_WorldSpace;
vec3 l9_45=normalize(l9_44);
vec3 l9_46;
#if (ENABLE_NORMALMAP)
{
vec2 l9_47=N3_getUV(NODE_8_DROPLIST_ITEM);
vec2 l9_48;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_NORMAL_TEXTURE_TRANSFORM)!=0))
{
l9_48=N3_uvTransform(l9_47,normalTexture_offset,normalTexture_scale,normalTexture_rotation);
}
else
{
l9_48=l9_47;
...
#endif
bool l9_50=(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTexture)!=0));
float l9_51=l9_48.x;
sc_SoftwareWrapEarly(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).x);
float l9_52=l9_51;
float l9_53=l9_48.y;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).y);
float l9_54=l9_53;
vec2 l9_55;
float l9_56;
...
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).x==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0);
}
#endif
float l9_58=l9_52;
float l9_59=1.0;
sc_ClampUV(l9_58,normalTextureUvMinMax.x,normalTextureUvMinMax.z,l9_57,l9_59);
float l9_60=l9_58;
float l9_61=l9_59;
bool l9_62;
#if (SC_USE_CLAMP_TO_BORDER_normalTexture)
{
l9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).y==3;
}
#else
{
...
float l9_63=l9_54;
float l9_64=l9_61;
sc_ClampUV(l9_63,normalTextureUvMinMax.y,normalTextureUvMinMax.w,l9_62,l9_64);
l9_56=l9_64;
...
#endif
vec2 l9_65=sc_TransformUV(l9_55,(int(SC_USE_UV_TRANSFORM_normalTexture)!=0),normalTextureTransform);
float l9_66=l9_65.x;
float l9_67=l9_56;
sc_SoftwareWrapLate(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).x,l9_50,l9_67);
float l9_68=l9_65.y;
float l9_69=l9_67;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).y,l9_50,l9_69);
float l9_70=l9_69;
vec3 l9_71=sc_SamplingCoordsViewToGlobal(vec2(l9_66,l9_68),normalTextureLayout,l9_49);
vec4 l9_72=texture2D(normalTexture,l9_71.xy,0.0);
vec4 l9_73;
#if (SC_USE_CLAMP_TO_BORDER_normalTexture)
{
l9_73=mix(normalTextureBorderColor,l9_72,vec4(l9_70));
}
#else
{
l9_73=l9_72;
...
#endif
l9_46=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,l9_45)*mix(vec3(0.0,0.0,1.0),(l9_73.xyz*1.9921875)-vec3(1.0),vec3(normalTextureScale)));
}
#else
{
l9_46=l9_45;
...
{
vec2 l9_77=N3_getUV(NODE_11_DROPLIST_ITEM);
vec2 l9_78;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_METALLIC_ROUGHNESS_TEXTURE_TRANSFORM)!=0))
{
l9_78=N3_uvTransform(l9_77,metallicRoughnessTexture_offset,metallicRoughnessTexture_scale,metallicRoughnessTexture_rotation);
}
else
{
l9_78=l9_77;
...
#endif
bool l9_80=(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_metallicRoughnessTexture)!=0));
float l9_81=l9_78.x;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).x);
float l9_82=l9_81;
float l9_83=l9_78.y;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).y);
float l9_84=l9_83;
vec2 l9_85;
float l9_86;
...
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).x==3;
}
#else
{
l9_87=(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0);
}
#endif
float l9_88=l9_82;
float l9_89=1.0;
sc_ClampUV(l9_88,metallicRoughnessTextureUvMinMax.x,metallicRoughnessTextureUvMinMax.z,l9_87,l9_89);
float l9_90=l9_88;
float l9_91=l9_89;
bool l9_92;
#if (SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).y==3;
}
#else
{
l9_92=(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0);
}
#endif
float l9_93=l9_84;
float l9_94=l9_91;
sc_ClampUV(l9_93,metallicRoughnessTextureUvMinMax.y,metallicRoughnessTextureUvMinMax.w,l9_92,l9_94);
l9_86=l9_94;
...
#endif
vec2 l9_95=sc_TransformUV(l9_85,(int(SC_USE_UV_TRANSFORM_metallicRoughnessTexture)!=0),metallicRoughnessTextureTransform);
float l9_96=l9_95.x;
float l9_97=l9_86;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).x,l9_80,l9_97);
float l9_98=l9_95.y;
float l9_99=l9_97;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).y,l9_80,l9_99);
float l9_100=l9_99;
vec3 l9_101=sc_SamplingCoordsViewToGlobal(vec2(l9_96,l9_98),metallicRoughnessTextureLayout,l9_79);
vec4 l9_102=texture2D(metallicRoughnessTexture,l9_101.xy,0.0);
vec4 l9_103;
#if (SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)
{
l9_103=mix(metallicRoughnessTextureBorderColor,l9_102,vec4(l9_100));
}
#else
{
l9_103=l9_102;
...
#endif
vec4 l9_104=vec4(0.0);
l9_104.w=occlusionTextureStrength;
vec3 l9_105=vec3(1.0+(occlusionTextureStrength*(l9_103.z-1.0)));
l9_76=roughnessFactor*l9_103.y;
l9_75=vec4(l9_105.x,l9_105.y,l9_105.z,l9_104.w);
l9_74=metallicFactor*l9_103.x;
}
#else
{
l9_76=roughnessFactor;
l9_75=vec4(1.0,1.0,1.0,0.0);
l9_74=metallicFactor;
}
#endif
vec3 l9_106;
vec3 l9_107;
...
{
vec2 l9_109=tempGlobals.gScreenCoord;
int l9_110;
#if (screenTextureHasSwappedViews)
{
l9_110=1-sc_GetStereoViewIndex();
}
#else
{
l9_110=sc_GetStereoViewIndex();
}
#endif
bool l9_111=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0));
float l9_112=l9_109.x;
sc_SoftwareWrapEarly(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_113=l9_112;
float l9_114=l9_109.y;
sc_SoftwareWrapEarly(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_115=l9_114;
vec2 l9_116;
float l9_117;
...
{
l9_118=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
l9_118=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_119=l9_113;
float l9_120=1.0;
sc_ClampUV(l9_119,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_118,l9_120);
float l9_121=l9_119;
float l9_122=l9_120;
bool l9_123;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_123=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
l9_123=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_124=l9_115;
float l9_125=l9_122;
sc_ClampUV(l9_124,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_123,l9_125);
l9_117=l9_125;
...
#endif
vec2 l9_126=sc_TransformUV(l9_116,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_127=l9_126.x;
float l9_128=l9_117;
sc_SoftwareWrapLate(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,l9_111,l9_128);
float l9_129=l9_126.y;
float l9_130=l9_128;
sc_SoftwareWrapLate(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,l9_111,l9_130);
float l9_131=l9_130;
vec3 l9_132=sc_SamplingCoordsViewToGlobal(vec2(l9_127,l9_129),screenTextureLayout,l9_110);
vec4 l9_133=texture2D(screenTexture,l9_132.xy,0.0);
vec4 l9_134;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_134=mix(screenTextureBorderColor,l9_133,vec4(l9_131));
}
#else
{
l9_134=l9_133;
...
#endif
vec3 l9_135=ssSRGB_to_Linear(l9_134.xyz);
float l9_136;
#if (ENABLE_TRANSMISSION_TEX)
{
vec2 l9_137=N3_getUV(Tweak_N30);
vec2 l9_138;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_TRANSMISSION_TEXTURE_TRANSFORM)!=0))
{
l9_138=N3_uvTransform(l9_137,transmissionTexture_offset,transmissionTexture_scale,transmissionTexture_rotation);
}
else
{
l9_138=l9_137;
...
{
l9_139=1-sc_GetStereoViewIndex();
}
#else
{
l9_139=sc_GetStereoViewIndex();
}
#endif
bool l9_140=(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_transmissionTexture)!=0));
float l9_141=l9_138.x;
sc_SoftwareWrapEarly(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).x);
float l9_142=l9_141;
float l9_143=l9_138.y;
sc_SoftwareWrapEarly(l9_143,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).y);
float l9_144=l9_143;
vec2 l9_145;
float l9_146;
...
{
l9_147=ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).x==3;
}
#else
{
l9_147=(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0);
}
#endif
float l9_148=l9_142;
float l9_149=1.0;
sc_ClampUV(l9_148,transmissionTextureUvMinMax.x,transmissionTextureUvMinMax.z,l9_147,l9_149);
float l9_150=l9_148;
float l9_151=l9_149;
bool l9_152;
#if (SC_USE_CLAMP_TO_BORDER_transmissionTexture)
{
l9_152=ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).y==3;
}
#else
{
l9_152=(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0);
}
#endif
float l9_153=l9_144;
float l9_154=l9_151;
sc_ClampUV(l9_153,transmissionTextureUvMinMax.y,transmissionTextureUvMinMax.w,l9_152,l9_154);
l9_146=l9_154;
...
#endif
vec2 l9_155=sc_TransformUV(l9_145,(int(SC_USE_UV_TRANSFORM_transmissionTexture)!=0),transmissionTextureTransform);
float l9_156=l9_155.x;
float l9_157=l9_146;
sc_SoftwareWrapLate(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).x,l9_140,l9_157);
float l9_158=l9_155.y;
float l9_159=l9_157;
sc_SoftwareWrapLate(l9_158,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).y,l9_140,l9_159);
float l9_160=l9_159;
vec3 l9_161=sc_SamplingCoordsViewToGlobal(vec2(l9_156,l9_158),transmissionTextureLayout,l9_139);
vec4 l9_162=texture2D(transmissionTexture,l9_161.xy,0.0);
vec4 l9_163;
#if (SC_USE_CLAMP_TO_BORDER_transmissionTexture)
{
l9_163=mix(transmissionTextureBorderColor,l9_162,vec4(l9_160));
}
#else
{
l9_163=l9_162;
...
#endif
vec3 l9_164=vec3(l9_136*transmissionFactor);
vec3 l9_165=vec3(l9_74);
l9_108=l9_135;
l9_107=mix(mix(vec3(0.0),l9_15.xyz,l9_164)*l9_135,vec3(0.0),l9_165)+l9_16;
l9_106=mix(mix(l9_15.xyz,vec3(0.0),l9_164),l9_15.xyz,l9_165);
}
#else
{
l9_108=vec3(0.0);
...
#endif
vec3 l9_166=ssLinear_to_SRGB(l9_106);
float l9_167;
#if (SC_DEVICE_CLASS>=2)
{
l9_167=pow(l9_15.w,0.45454544);
}
#else
{
l9_167=sqrt(l9_15.w);
...
#endif
vec3 l9_168=ssLinear_to_SRGB(l9_107);
vec4 l9_169;
#if (ENABLE_SHEEN)
{
vec3 l9_170;
...
{
vec2 l9_171=N3_getUV(Tweak_N32);
vec2 l9_172;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_SHEEN_COLOR_TEXTURE_TRANSFORM)!=0))
{
l9_172=N3_uvTransform(l9_171,sheenColorTexture_offset,sheenColorTexture_scale,sheenColorTexture_rotation);
}
else
{
l9_172=l9_171;
...
{
l9_173=1-sc_GetStereoViewIndex();
}
#else
{
l9_173=sc_GetStereoViewIndex();
}
#endif
bool l9_174=(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sheenColorTexture)!=0));
float l9_175=l9_172.x;
sc_SoftwareWrapEarly(l9_175,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).x);
float l9_176=l9_175;
float l9_177=l9_172.y;
sc_SoftwareWrapEarly(l9_177,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).y);
float l9_178=l9_177;
vec2 l9_179;
float l9_180;
...
{
l9_181=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).x==3;
}
#else
{
l9_181=(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0);
}
#endif
float l9_182=l9_176;
float l9_183=1.0;
sc_ClampUV(l9_182,sheenColorTextureUvMinMax.x,sheenColorTextureUvMinMax.z,l9_181,l9_183);
float l9_184=l9_182;
float l9_185=l9_183;
bool l9_186;
#if (SC_USE_CLAMP_TO_BORDER_sheenColorTexture)
{
l9_186=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).y==3;
}
#else
{
l9_186=(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0);
}
#endif
float l9_187=l9_178;
float l9_188=l9_185;
sc_ClampUV(l9_187,sheenColorTextureUvMinMax.y,sheenColorTextureUvMinMax.w,l9_186,l9_188);
l9_180=l9_188;
...
#endif
vec2 l9_189=sc_TransformUV(l9_179,(int(SC_USE_UV_TRANSFORM_sheenColorTexture)!=0),sheenColorTextureTransform);
float l9_190=l9_189.x;
float l9_191=l9_180;
sc_SoftwareWrapLate(l9_190,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).x,l9_174,l9_191);
float l9_192=l9_189.y;
float l9_193=l9_191;
sc_SoftwareWrapLate(l9_192,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).y,l9_174,l9_193);
float l9_194=l9_193;
vec3 l9_195=sc_SamplingCoordsViewToGlobal(vec2(l9_190,l9_192),sheenColorTextureLayout,l9_173);
vec4 l9_196=texture2D(sheenColorTexture,l9_195.xy,0.0);
vec4 l9_197;
#if (SC_USE_CLAMP_TO_BORDER_sheenColorTexture)
{
l9_197=mix(sheenColorTextureBorderColor,l9_196,vec4(l9_194));
}
#else
{
l9_197=l9_196;
...
#endif
l9_170=sheenColorFactor*ssSRGB_to_Linear(l9_197.xyz);
}
#else
{
l9_170=sheenColorFactor;
}
#endif
float l9_198;
#if (ENABLE_SHEEN_ROUGHNESS_TEX)
{
vec2 l9_199=N3_getUV(Tweak_N37);
vec2 l9_200;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_SHEEN_ROUGHNESS_TEXTURE_TRANSFORM)!=0))
{
l9_200=N3_uvTransform(l9_199,sheenRoughnessTexture_offset,sheenRoughnessTexture_scale,sheenRoughnessTexture_rotation);
}
else
{
l9_200=l9_199;
...
{
l9_201=1-sc_GetStereoViewIndex();
}
#else
{
l9_201=sc_GetStereoViewIndex();
}
#endif
bool l9_202=(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sheenRoughnessTexture)!=0));
float l9_203=l9_200.x;
sc_SoftwareWrapEarly(l9_203,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).x);
float l9_204=l9_203;
float l9_205=l9_200.y;
sc_SoftwareWrapEarly(l9_205,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).y);
float l9_206=l9_205;
vec2 l9_207;
float l9_208;
...
{
l9_209=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).x==3;
}
#else
{
l9_209=(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0);
}
#endif
float l9_210=l9_204;
float l9_211=1.0;
sc_ClampUV(l9_210,sheenRoughnessTextureUvMinMax.x,sheenRoughnessTextureUvMinMax.z,l9_209,l9_211);
float l9_212=l9_210;
float l9_213=l9_211;
bool l9_214;
#if (SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)
{
l9_214=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).y==3;
}
#else
{
l9_214=(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0);
}
#endif
float l9_215=l9_206;
float l9_216=l9_213;
sc_ClampUV(l9_215,sheenRoughnessTextureUvMinMax.y,sheenRoughnessTextureUvMinMax.w,l9_214,l9_216);
l9_208=l9_216;
...
#endif
vec2 l9_217=sc_TransformUV(l9_207,(int(SC_USE_UV_TRANSFORM_sheenRoughnessTexture)!=0),sheenRoughnessTextureTransform);
float l9_218=l9_217.x;
float l9_219=l9_208;
sc_SoftwareWrapLate(l9_218,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).x,l9_202,l9_219);
float l9_220=l9_217.y;
float l9_221=l9_219;
sc_SoftwareWrapLate(l9_220,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).y,l9_202,l9_221);
float l9_222=l9_221;
vec3 l9_223=sc_SamplingCoordsViewToGlobal(vec2(l9_218,l9_220),sheenRoughnessTextureLayout,l9_201);
vec4 l9_224=texture2D(sheenRoughnessTexture,l9_223.xy,0.0);
vec4 l9_225;
#if (SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)
{
l9_225=mix(sheenRoughnessTextureBorderColor,l9_224,vec4(l9_222));
}
#else
{
l9_225=l9_224;
...
#endif
l9_198=sheenRoughnessFactor*ssSRGB_to_Linear(l9_225.w);
}
#else
{
l9_198=sheenRoughnessFactor;
}
#endif
float l9_226=max(l9_198,9.9999997e-05);
vec3 l9_227=tempGlobals.ViewDirWS;
float l9_228=dot(l9_46,l9_227);
float l9_229=max(clamp(l9_228,0.0,1.0),9.9999997e-05);
float l9_230=l9_226*l9_226;
vec3 l9_231=reflect(-l9_227,l9_46);
bool l9_232=l9_226<0.25;
float l9_233;
if (l9_232)
{
l9_233=(((-339.20001)*l9_230)+(161.39999*l9_226))-25.9;
}
else
{
l9_233=(((-8.4799995)*l9_230)+(14.3*l9_226))-9.9499998;
}
float l9_234;
if (l9_232)
{
l9_234=((44.0*l9_230)-(23.700001*l9_226))+3.26;
}
else
{
l9_234=((1.97*l9_230)-(3.27*l9_226))+0.72000003;
}
float l9_235=l9_233*l9_229;
float l9_236=l9_235+l9_234;
float l9_237;
if (l9_232)
{
l9_237=0.0;
...
{
l9_237=0.1*(l9_226-0.25);
}
float l9_238=exp(l9_236)+l9_237;
vec3 l9_239=sampleSpecularEnvTextureLod(normalize(l9_231),3.0+((((l9_226*4.0)-0.0)*2.0)/5.000001));
vec3 l9_240=((l9_239*sc_EnvmapExposure)+vec3(1e-06))*l9_170;
vec3 l9_241=(vec3(0.0)+(l9_240*clamp(l9_238*3.1415927,0.0,1.0))).xyz;
vec3 l9_242;
if (sc_DirectionalLightsCount>0)
{
vec3 l9_243;
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_246=l9_245<sc_DirectionalLightsCount;
if (l9_246)
{
vec3 l9_247;
if (l9_246)
{
l9_247=sc_DirectionalLights[l9_245].color.xyz;
}
else
{
l9_247=vec3(0.0);
...
if (l9_246)
{
l9_248=sc_DirectionalLights[l9_245].color.w;
}
else
{
l9_248=0.0;
}
vec3 l9_249=l9_247*l9_248;
vec3 l9_250;
if (l9_246)
{
l9_250=-sc_DirectionalLights[l9_245].direction;
}
else
{
l9_250=vec3(0.0);
}
vec3 l9_251=normalize(-l9_250);
float l9_252=clamp(dot(l9_46,l9_251),0.0,1.0);
l9_244=l9_243+(((((l9_249*3.1415901)*l9_170)*N3_charlieD(l9_230,clamp(dot(l9_46,normalize(l9_251+l9_227)),0.0,1.0)))*(1.0/(4.0*((l9_252+l9_229)-(l9_252*l9_229)))))*l9_252);
l9_243=l9_244;
l9_245++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_257=l9_256<sc_PointLightsCount;
if (l9_257)
{
vec3 l9_258;
if (l9_257)
{
l9_258=sc_PointLights[l9_256].color.xyz;
}
else
{
l9_258=vec3(0.0);
...
if (l9_257)
{
l9_259=sc_PointLights[l9_256].color.w;
}
else
{
l9_259=0.0;
}
vec3 l9_260=l9_258*l9_259;
vec3 l9_261;
if (l9_257)
{
l9_261=sc_PointLights[l9_256].position;
}
else
{
l9_261=vec3(0.0);
}
vec3 l9_262=normalize(l9_261-tempGlobals.SurfacePosition_WorldSpace);
float l9_263=clamp(dot(l9_46,l9_262),0.0,1.0);
l9_255=l9_254+(((((l9_260*3.1415901)*l9_170)*N3_charlieD(l9_230,clamp(dot(l9_46,normalize(l9_262+l9_227)),0.0,1.0)))*(1.0/(4.0*((l9_263+l9_229)-(l9_263*l9_229)))))*l9_263);
l9_254=l9_255;
l9_256++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_268=l9_267<sc_AmbientLightsCount;
if (l9_268)
{
vec3 l9_269;
if (l9_268)
{
l9_269=sc_AmbientLights[l9_267].color;
}
else
{
l9_269=vec3(0.0);
...
if (l9_268)
{
l9_270=sc_AmbientLights[l9_267].intensity;
}
else
{
l9_270=0.0;
}
l9_266=l9_265+(((l9_269*l9_270)/vec3(3.1415901))*l9_170);
l9_265=l9_266;
l9_267++;
continue;
}
...
vec3 l9_271=mix(l9_241,l9_241*l9_75.xyz,vec3(l9_75.w)).xyz+l9_264;
vec4 l9_272=vec4(l9_271.x,l9_271.y,l9_271.z,vec4(0.0).w);
l9_272.w=1.0-(max(max(l9_170.x,l9_170.y),l9_170.z)*0.15700001);
l9_169=l9_272;
}
#else
{
...
{
vec2 l9_277=N3_getUV(Tweak_N44);
vec2 l9_278;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_CLEARCOAT_TEXTURE_TRANSFORM)!=0))
{
l9_278=N3_uvTransform(l9_277,clearcoatTexture_offset,clearcoatTexture_scale,clearcoatTexture_rotation);
}
else
{
l9_278=l9_277;
...
{
l9_279=1-sc_GetStereoViewIndex();
}
#else
{
l9_279=sc_GetStereoViewIndex();
}
#endif
bool l9_280=(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatTexture)!=0));
float l9_281=l9_278.x;
sc_SoftwareWrapEarly(l9_281,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).x);
float l9_282=l9_281;
float l9_283=l9_278.y;
sc_SoftwareWrapEarly(l9_283,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).y);
float l9_284=l9_283;
vec2 l9_285;
float l9_286;
...
{
l9_287=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).x==3;
}
#else
{
l9_287=(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0);
}
#endif
float l9_288=l9_282;
float l9_289=1.0;
sc_ClampUV(l9_288,clearcoatTextureUvMinMax.x,clearcoatTextureUvMinMax.z,l9_287,l9_289);
float l9_290=l9_288;
float l9_291=l9_289;
bool l9_292;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatTexture)
{
l9_292=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).y==3;
}
#else
{
l9_292=(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0);
}
#endif
float l9_293=l9_284;
float l9_294=l9_291;
sc_ClampUV(l9_293,clearcoatTextureUvMinMax.y,clearcoatTextureUvMinMax.w,l9_292,l9_294);
l9_286=l9_294;
...
#endif
vec2 l9_295=sc_TransformUV(l9_285,(int(SC_USE_UV_TRANSFORM_clearcoatTexture)!=0),clearcoatTextureTransform);
float l9_296=l9_295.x;
float l9_297=l9_286;
sc_SoftwareWrapLate(l9_296,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).x,l9_280,l9_297);
float l9_298=l9_295.y;
float l9_299=l9_297;
sc_SoftwareWrapLate(l9_298,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).y,l9_280,l9_299);
float l9_300=l9_299;
vec3 l9_301=sc_SamplingCoordsViewToGlobal(vec2(l9_296,l9_298),clearcoatTextureLayout,l9_279);
vec4 l9_302=texture2D(clearcoatTexture,l9_301.xy,0.0);
vec4 l9_303;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatTexture)
{
l9_303=mix(clearcoatTextureBorderColor,l9_302,vec4(l9_300));
}
#else
{
l9_303=l9_302;
...
#endif
l9_276=ssSRGB_to_Linear(l9_303.x);
}
#else
{
l9_276=1.0;
...
#endif
float l9_304=l9_276*clearcoatFactor;
float l9_305;
#if (ENABLE_CLEARCOAT_ROUGHNESS_TEX)
{
vec2 l9_306=N3_getUV(Tweak_N60);
vec2 l9_307;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_CLEARCOAT_ROUGHNESS_TEXTURE_TRANSFORM)!=0))
{
l9_307=N3_uvTransform(l9_306,clearcoatRoughnessTexture_offset,clearcoatRoughnessTexture_scale,clearcoatRoughnessTexture_rotation);
}
else
{
l9_307=l9_306;
...
{
l9_308=1-sc_GetStereoViewIndex();
}
#else
{
l9_308=sc_GetStereoViewIndex();
}
#endif
bool l9_309=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0));
float l9_310=l9_307.x;
sc_SoftwareWrapEarly(l9_310,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).x);
float l9_311=l9_310;
float l9_312=l9_307.y;
sc_SoftwareWrapEarly(l9_312,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).y);
float l9_313=l9_312;
vec2 l9_314;
float l9_315;
...
{
l9_316=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).x==3;
}
#else
{
l9_316=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0);
}
#endif
float l9_317=l9_311;
float l9_318=1.0;
sc_ClampUV(l9_317,clearcoatRoughnessTextureUvMinMax.x,clearcoatRoughnessTextureUvMinMax.z,l9_316,l9_318);
float l9_319=l9_317;
float l9_320=l9_318;
bool l9_321;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)
{
l9_321=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).y==3;
}
#else
{
l9_321=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0);
}
#endif
float l9_322=l9_313;
float l9_323=l9_320;
sc_ClampUV(l9_322,clearcoatRoughnessTextureUvMinMax.y,clearcoatRoughnessTextureUvMinMax.w,l9_321,l9_323);
l9_315=l9_323;
...
#endif
vec2 l9_324=sc_TransformUV(l9_314,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform);
float l9_325=l9_324.x;
float l9_326=l9_315;
sc_SoftwareWrapLate(l9_325,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).x,l9_309,l9_326);
float l9_327=l9_324.y;
float l9_328=l9_326;
sc_SoftwareWrapLate(l9_327,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).y,l9_309,l9_328);
float l9_329=l9_328;
vec3 l9_330=sc_SamplingCoordsViewToGlobal(vec2(l9_325,l9_327),clearcoatRoughnessTextureLayout,l9_308);
vec4 l9_331=texture2D(clearcoatRoughnessTexture,l9_330.xy,0.0);
vec4 l9_332;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)
{
l9_332=mix(clearcoatRoughnessTextureBorderColor,l9_331,vec4(l9_329));
}
#else
{
l9_332=l9_331;
...
#endif
l9_305=ssSRGB_to_Linear(l9_332.y);
}
#else
{
l9_305=1.0;
...
#endif
float l9_333=l9_305*clearcoatRoughnessFactor;
vec3 l9_334;
#if (ENABLE_CLEARCOAT_NORMAL_TEX)
{
vec2 l9_335=N3_getUV(Tweak_N47);
vec2 l9_336;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_CLEARCOAT_NORMAL_TEXTURE_TRANSFORM)!=0))
{
l9_336=N3_uvTransform(l9_335,clearcoatNormalTexture_offset,clearcoatNormalTexture_scale,clearcoatNormalTexture_rotation);
}
else
{
l9_336=l9_335;
...
{
l9_337=1-sc_GetStereoViewIndex();
}
#else
{
l9_337=sc_GetStereoViewIndex();
}
#endif
bool l9_338=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture)!=0));
float l9_339=l9_336.x;
sc_SoftwareWrapEarly(l9_339,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).x);
float l9_340=l9_339;
float l9_341=l9_336.y;
sc_SoftwareWrapEarly(l9_341,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).y);
float l9_342=l9_341;
vec2 l9_343;
float l9_344;
...
{
l9_345=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).x==3;
}
#else
{
l9_345=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0);
}
#endif
float l9_346=l9_340;
float l9_347=1.0;
sc_ClampUV(l9_346,clearcoatNormalTextureUvMinMax.x,clearcoatNormalTextureUvMinMax.z,l9_345,l9_347);
float l9_348=l9_346;
float l9_349=l9_347;
bool l9_350;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)
{
l9_350=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).y==3;
}
#else
{
l9_350=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0);
}
#endif
float l9_351=l9_342;
float l9_352=l9_349;
sc_ClampUV(l9_351,clearcoatNormalTextureUvMinMax.y,clearcoatNormalTextureUvMinMax.w,l9_350,l9_352);
l9_344=l9_352;
...
#endif
vec2 l9_353=sc_TransformUV(l9_343,(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture)!=0),clearcoatNormalTextureTransform);
float l9_354=l9_353.x;
float l9_355=l9_344;
sc_SoftwareWrapLate(l9_354,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).x,l9_338,l9_355);
float l9_356=l9_353.y;
float l9_357=l9_355;
sc_SoftwareWrapLate(l9_356,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).y,l9_338,l9_357);
float l9_358=l9_357;
vec3 l9_359=sc_SamplingCoordsViewToGlobal(vec2(l9_354,l9_356),clearcoatNormalTextureLayout,l9_337);
vec4 l9_360=texture2D(clearcoatNormalTexture,l9_359.xy,0.0);
vec4 l9_361;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)
{
l9_361=mix(clearcoatNormalTextureBorderColor,l9_360,vec4(l9_358));
}
#else
{
l9_361=l9_360;
...
#endif
l9_334=l9_361.xyz*0.9921875;
}
#else
{
l9_334=vec3(0.0,0.0,1.0);
}
#endif
l9_275=l9_333;
l9_274=l9_334;
...
#endif
float l9_363=clamp(l9_167,0.0,1.0);
ngsAlphaTest(l9_363);
vec3 l9_364=max(l9_166,vec3(0.0));
vec4 l9_365;
#if (sc_ProjectiveShadowsCaster)
{
l9_365=vec4(l9_364,l9_363);
}
#else
{
l9_365=ngsCalculateLighting(l9_364,l9_363,l9_362,varPos,l9_5,max(l9_168,vec3(0.0)),clamp(l9_74,0.0,1.0),clamp(l9_76,0.0,1.0),clamp(l9_75.xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N036);
}
#endif
vec4 l9_366=max(l9_365,vec4(0.0));
vec3 l9_367;
#if (!sc_ProjectiveShadowsCaster)
{
l9_367=mat3(l9_1,l9_2,l9_0)*l9_274;
}
#else
{
l9_367=vec3(0.0);
...
#if (sc_ProjectiveShadowsCaster)
{
l9_368=vec4(Port_Albedo_N405,Port_Opacity_N405);
}
#else
{
l9_368=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_367,varPos,l9_5,Port_Emissive_N405,Port_Metallic_N405,clamp(l9_275,0.0,1.0),vec3(1.0),Port_SpecularAO_N405);
}
#endif
...
{
vec4 l9_371=ssSRGB_to_Linear(l9_366);
vec4 l9_372;
#if (ENABLE_SHEEN)
{
vec3 l9_373=(l9_371.xyz*l9_169.w)+l9_169.xyz;
l9_372=vec4(l9_373.x,l9_373.y,l9_373.z,l9_371.w);
}
#else
{
l9_372=l9_371;
...
#if (ENABLE_TRANSMISSION)
{
vec4 l9_375=mix(vec4(l9_108,1.0),l9_372,vec4(ssSRGB_to_Linear(l9_167)));
l9_375.w=1.0;
l9_374=l9_375;
}
#else
...
#if (ENABLE_CLEARCOAT)
{
vec3 l9_377=l9_374.xyz+(ssSRGB_to_Linear(l9_369)*l9_273).xyz;
l9_376=vec4(l9_377.x,l9_377.y,l9_377.z,l9_374.w);
}
#else
{
l9_376=l9_374;
...
#endif
l9_370=ssLinear_to_SRGB(l9_376);
}
else
{
l9_370=l9_366;
...
{
float l9_378;
Node40_Bool_Parameter(l9_378,l9_6);
float l9_379;
Node121_Bool_Parameter(l9_379,l9_6);
float l9_380;
Node48_Bool_Parameter(l9_380,l9_6);
float l9_381;
Node88_Bool_Parameter(l9_381,l9_6);
tempGlobals=l9_6;
vec4 l9_382;
#if (ENABLE_BASE_TEX)
{
vec2 l9_383=N35_getUV(NODE_7_DROPLIST_ITEM);
vec2 l9_384;
if ((int(ENABLE_TEXTURE_TRANSFORM)!=0)&&(int(ENABLE_BASE_TEXTURE_TRANSFORM)!=0))
{
l9_384=N35_uvTransform(l9_383,baseColorTexture_offset,baseColorTexture_scale,baseColorTexture_rotation);
}
else
{
l9_384=l9_383;
}
l9_382=baseColorFactor*ssSRGB_to_Linear(N35_BaseTexture_sample(l9_384));
}
#else
{
l9_382=baseColorFactor;
}
#endif
vec4 l9_385;
#if (ENABLE_VERTEX_COLOR_BASE)
{
l9_385=l9_382*tempGlobals.VertexColor;
}
#else
{
l9_385=l9_382;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_388=clamp(l9_7.w*2.0,0.0,1.0);
}
#else
{
float l9_389;
...
{
l9_389=clamp(dot(l9_7.xyz,vec3(l9_7.w)),0.0,1.0);
}
#else
{
float l9_390;
...
#if (sc_BlendMode_Multiply)
{
l9_391=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_7.w;
}
#else
{
float l9_392;
...
{
l9_392=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_7.w;
}
#else
{
float l9_393;
#if (sc_BlendMode_ColoredGlass)
{
l9_393=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_7.w;
}
#else
{
float l9_394;
#if (sc_BlendMode_Add)
{
l9_394=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_395;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_395=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_7.w;
}
#else
{
float l9_396;
...
{
l9_396=dot(l9_7.xyz,vec3(0.33333001))*l9_7.w;
}
#else
{
float l9_397;
#if (sc_BlendMode_Min)
{
l9_397=1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_398;
#if (sc_BlendMode_Max)
{
l9_398=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_398=1.0;
...
#endif
l9_386=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_7.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_387);
}
#else
{
vec4 l9_399;
...
{
vec3 l9_401=sc_GetFramebufferColor().xyz;
vec3 l9_402=mix(l9_401,definedBlend(l9_401,l9_7.xyz).xyz,vec3(l9_7.w));
vec4 l9_403=vec4(l9_402.x,l9_402.y,l9_402.z,vec4(0.0).w);
l9_403.w=1.0;
l9_400=l9_403;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_404=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_7.w)),l9_7.w);
}
#else
{
vec4 l9_405;
...
#endif
l9_405=vec4(l9_7.xyz*l9_406,l9_406);
}
#else
{
l9_405=l9_7;
...
{
l9_409=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_409=vec4(0.0);
...
vec4 l9_411=outputMotionVectorsIfNeeded(varPos,max(l9_410,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_414=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_414).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_415=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_414).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_427=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_427).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_432==0)
{
l9_435=texture2D(sc_OITAlpha0,l9_427);
l9_434=texture2D(sc_OITDepthLow0,l9_427);
l9_433=texture2D(sc_OITDepthHigh0,l9_427);
}
else
{
l9_435=vec4(0.0);
...
if (l9_432==1)
{
l9_438=texture2D(sc_OITAlpha1,l9_427);
l9_437=texture2D(sc_OITDepthLow1,l9_427);
l9_436=texture2D(sc_OITDepthHigh1,l9_427);
}
else
{
l9_438=l9_435;
...
vec4 l9_453=texture2D(sc_OITFilteredDepthBoundsTexture,l9_427);
