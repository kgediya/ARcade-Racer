...
//sampler sampler glow_mapSmpSC 0:21
...
//texture texture2D glow_map 0:3:0:21
...
//texture texture2DArray glow_mapArrSC 0:32:0:21
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glow_map 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glow_map 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int glow_mapLayout 83 0
...
#if (glow_mapLayout==2)
{
bool l9_5=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0));
float l9_6=l9_3.x;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_7=l9_6;
float l9_8=l9_3.y;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_9=l9_8;
vec2 l9_10;
float l9_11;
#if (SC_USE_UV_MIN_MAX_glow_map)
{
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_13=l9_7;
float l9_14=1.0;
sc_ClampUV(l9_13,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_12,l9_14);
float l9_15=l9_13;
float l9_16=l9_14;
bool l9_17;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_18=l9_9;
float l9_19=l9_16;
sc_ClampUV(l9_18,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_17,l9_19);
l9_11=l9_19;
...
#endif
vec2 l9_20=sc_TransformUV(l9_10,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_21=l9_20.x;
float l9_22=l9_11;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,l9_5,l9_22);
float l9_23=l9_20.y;
float l9_24=l9_22;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,l9_5,l9_24);
float l9_25=l9_24;
vec3 l9_26=sc_SamplingCoordsViewToGlobal(vec2(l9_21,l9_23),glow_mapLayout,glow_mapGetStereoViewIndex());
vec4 l9_27=texture(glow_mapArrSC,l9_26,0.0);
vec4 l9_28;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_28=mix(glow_mapBorderColor,l9_27,vec4(l9_25));
}
#else
{
l9_28=l9_27;
...
#else
{
bool l9_29=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0));
float l9_30=l9_3.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_31=l9_30;
float l9_32=l9_3.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
#if (SC_USE_UV_MIN_MAX_glow_map)
...
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_36=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,l9_29,l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,l9_29,l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),glow_mapLayout,glow_mapGetStereoViewIndex());
vec4 l9_51=texture(glow_map,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_52=mix(glow_mapBorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
#endif
float l9_53=clamp(l9_4.x,0.0,1.0);
vec4 l9_54;
if (l9_53<Port_Position1_N007)
{
l9_54=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_53/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_55;
if (l9_53<Port_Position2_N007)
{
l9_55=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_53-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_55=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_53-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_54=l9_55;
}
bool l9_56=PreviewEnabled==1;
bool l9_57;
if (l9_56)
{
l9_57=!l9_0;
...
if (l9_54.x<float(l9_54.x<Port_Input1_N003))
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_54.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_54.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_61,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_63;
...
{
l9_65=clamp(l9_54.w*2.0,0.0,1.0);
}
#else
{
float l9_66;
...
{
l9_66=clamp(dot(l9_54.xyz,vec3(l9_54.w)),0.0,1.0);
}
#else
{
float l9_67;
...
{
l9_68=(1.0-dot(l9_54.xyz,vec3(0.33333001)))*l9_54.w;
}
#else
{
float l9_69;
...
{
l9_69=(1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0))*l9_54.w;
}
#else
{
float l9_70;
...
{
l9_70=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_54.w;
}
#else
{
float l9_71;
#if (sc_BlendMode_Add)
{
l9_71=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_72;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_72=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_54.w;
}
#else
{
float l9_73;
...
{
l9_73=dot(l9_54.xyz,vec3(0.33333001))*l9_54.w;
}
#else
{
float l9_74;
#if (sc_BlendMode_Min)
{
l9_74=1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_75;
#if (sc_BlendMode_Max)
{
l9_75=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_75=1.0;
...
#endif
l9_63=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_54.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_64);
}
#else
{
vec4 l9_76;
...
{
l9_84=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_82,sc_ScreenTextureLayout,l9_83),0.0);
}
#else
{
l9_84=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_82,sc_ScreenTextureLayout,l9_83).xy,0.0);
}
#endif
l9_78=l9_84;
}
...
#endif
vec3 l9_87=mix(l9_85.xyz,definedBlend(l9_85.xyz,l9_54.xyz).xyz,vec3(l9_54.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_89=vec4(mix(vec3(1.0),l9_54.xyz,vec3(l9_54.w)),l9_54.w);
}
#else
{
vec4 l9_90;
...
#endif
l9_90=vec4(l9_54.xyz*l9_91,l9_91);
}
#else
{
l9_90=l9_54;
