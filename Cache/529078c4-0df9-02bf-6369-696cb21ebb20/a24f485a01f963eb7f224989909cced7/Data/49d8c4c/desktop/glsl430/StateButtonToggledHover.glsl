...
vec2 l9_124=l9_4*Port_Input1_N009;
...
vec3 l9_134=-l9_6;
vec4 l9_135=mix(l9_126,Port_Input1_N024,vec4(max(pow(1.0-abs(dot(l9_134,l9_13*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
vec2 l9_136=l9_5-Port_Center_N002;
vec2 l9_137=(l9_136*Port_Scale_N002)+Port_Center_N002;
vec4 l9_138;
#if (iconLayout==2)
{
bool l9_139=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_140=l9_137.x;
sc_SoftwareWrapEarly(l9_140,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_141=l9_140;
float l9_142=l9_137.y;
sc_SoftwareWrapEarly(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_143=l9_142;
vec2 l9_144;
float l9_145;
...
{
l9_146=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_146=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_147=l9_141;
float l9_148=1.0;
sc_ClampUV(l9_147,iconUvMinMax.x,iconUvMinMax.z,l9_146,l9_148);
float l9_149=l9_147;
float l9_150=l9_148;
bool l9_151;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_151=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_151=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_152=l9_143;
float l9_153=l9_150;
sc_ClampUV(l9_152,iconUvMinMax.y,iconUvMinMax.w,l9_151,l9_153);
l9_145=l9_153;
...
#endif
vec2 l9_154=sc_TransformUV(l9_144,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_155=l9_154.x;
float l9_156=l9_145;
sc_SoftwareWrapLate(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_139,l9_156);
float l9_157=l9_154.y;
float l9_158=l9_156;
sc_SoftwareWrapLate(l9_157,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_139,l9_158);
float l9_159=l9_158;
vec3 l9_160=sc_SamplingCoordsViewToGlobal(vec2(l9_155,l9_157),iconLayout,iconGetStereoViewIndex());
vec4 l9_161=texture(iconArrSC,l9_160,0.0);
vec4 l9_162;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_162=mix(iconBorderColor,l9_161,vec4(l9_159));
}
#else
{
l9_162=l9_161;
...
#else
{
bool l9_163=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_164=l9_137.x;
sc_SoftwareWrapEarly(l9_164,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_165=l9_164;
float l9_166=l9_137.y;
sc_SoftwareWrapEarly(l9_166,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_167=l9_166;
vec2 l9_168;
float l9_169;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_170=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_170=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_171=l9_165;
float l9_172=1.0;
sc_ClampUV(l9_171,iconUvMinMax.x,iconUvMinMax.z,l9_170,l9_172);
float l9_173=l9_171;
float l9_174=l9_172;
bool l9_175;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_175=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_175=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_176=l9_167;
float l9_177=l9_174;
sc_ClampUV(l9_176,iconUvMinMax.y,iconUvMinMax.w,l9_175,l9_177);
l9_169=l9_177;
...
#endif
vec2 l9_178=sc_TransformUV(l9_168,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_179=l9_178.x;
float l9_180=l9_169;
sc_SoftwareWrapLate(l9_179,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_163,l9_180);
float l9_181=l9_178.y;
float l9_182=l9_180;
sc_SoftwareWrapLate(l9_181,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_163,l9_182);
float l9_183=l9_182;
vec3 l9_184=sc_SamplingCoordsViewToGlobal(vec2(l9_179,l9_181),iconLayout,iconGetStereoViewIndex());
vec4 l9_185=texture(icon,l9_184.xy,0.0);
vec4 l9_186;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_186=mix(iconBorderColor,l9_185,vec4(l9_183));
}
#else
{
l9_186=l9_185;
...
#if (iconLayout==2)
{
bool l9_189=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_190=l9_137.x;
sc_SoftwareWrapEarly(l9_190,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_191=l9_190;
float l9_192=l9_137.y;
sc_SoftwareWrapEarly(l9_192,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_193=l9_192;
vec2 l9_194;
float l9_195;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_196=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_196=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_197=l9_191;
float l9_198=1.0;
sc_ClampUV(l9_197,iconUvMinMax.x,iconUvMinMax.z,l9_196,l9_198);
float l9_199=l9_197;
float l9_200=l9_198;
bool l9_201;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_201=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_201=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_202=l9_193;
float l9_203=l9_200;
sc_ClampUV(l9_202,iconUvMinMax.y,iconUvMinMax.w,l9_201,l9_203);
l9_195=l9_203;
...
#endif
vec2 l9_204=sc_TransformUV(l9_194,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_205=l9_204.x;
float l9_206=l9_195;
sc_SoftwareWrapLate(l9_205,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_189,l9_206);
float l9_207=l9_204.y;
float l9_208=l9_206;
sc_SoftwareWrapLate(l9_207,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_189,l9_208);
float l9_209=l9_208;
vec3 l9_210=sc_SamplingCoordsViewToGlobal(vec2(l9_205,l9_207),iconLayout,iconGetStereoViewIndex());
vec4 l9_211=texture(iconArrSC,l9_210,0.0);
vec4 l9_212;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_212=mix(iconBorderColor,l9_211,vec4(l9_209));
}
#else
{
l9_212=l9_211;
...
#else
{
bool l9_213=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_214=l9_137.x;
sc_SoftwareWrapEarly(l9_214,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_215=l9_214;
float l9_216=l9_137.y;
sc_SoftwareWrapEarly(l9_216,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_217=l9_216;
vec2 l9_218;
float l9_219;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_220=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_220=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_221=l9_215;
float l9_222=1.0;
sc_ClampUV(l9_221,iconUvMinMax.x,iconUvMinMax.z,l9_220,l9_222);
float l9_223=l9_221;
float l9_224=l9_222;
bool l9_225;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_225=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_225=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_226=l9_217;
float l9_227=l9_224;
sc_ClampUV(l9_226,iconUvMinMax.y,iconUvMinMax.w,l9_225,l9_227);
l9_219=l9_227;
...
#endif
vec2 l9_228=sc_TransformUV(l9_218,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_229=l9_228.x;
float l9_230=l9_219;
sc_SoftwareWrapLate(l9_229,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_213,l9_230);
float l9_231=l9_228.y;
float l9_232=l9_230;
sc_SoftwareWrapLate(l9_231,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_213,l9_232);
float l9_233=l9_232;
vec3 l9_234=sc_SamplingCoordsViewToGlobal(vec2(l9_229,l9_231),iconLayout,iconGetStereoViewIndex());
vec4 l9_235=texture(icon,l9_234.xy,0.0);
vec4 l9_236;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_236=mix(iconBorderColor,l9_235,vec4(l9_233));
}
#else
{
l9_236=l9_235;
...
{
l9_187=Port_Input2_N007;
}
vec4 l9_237=vec4(l9_187);
vec4 l9_238=mix(mix(l9_68,l9_123,vec4(Port_Input2_N005))+l9_135,l9_138,l9_237);
float l9_239=l9_238.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_239<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_239<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_240,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_242;
...
{
l9_244=clamp(l9_239*2.0,0.0,1.0);
}
#else
{
float l9_245;
...
{
l9_245=clamp(dot(l9_238.xyz,vec3(l9_239)),0.0,1.0);
}
#else
{
float l9_246;
...
{
l9_247=(1.0-dot(l9_238.xyz,vec3(0.33333001)))*l9_239;
}
#else
{
float l9_248;
...
{
l9_248=(1.0-clamp(dot(l9_238.xyz,vec3(1.0)),0.0,1.0))*l9_239;
}
#else
{
float l9_249;
...
{
l9_249=clamp(dot(l9_238.xyz,vec3(1.0)),0.0,1.0)*l9_239;
}
#else
{
float l9_250;
#if (sc_BlendMode_Add)
{
l9_250=clamp(dot(l9_238.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_251;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_251=clamp(dot(l9_238.xyz,vec3(1.0)),0.0,1.0)*l9_239;
}
#else
{
float l9_252;
...
{
l9_252=dot(l9_238.xyz,vec3(0.33333001))*l9_239;
}
#else
{
float l9_253;
#if (sc_BlendMode_Min)
{
l9_253=1.0-clamp(dot(l9_238.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_254;
#if (sc_BlendMode_Max)
{
l9_254=clamp(dot(l9_238.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_254=1.0;
...
#endif
l9_242=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_238.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_243);
}
#else
{
vec4 l9_255;
...
#if (sc_FramebufferFetch)
{
vec4 l9_258=sc_readFragData0_Platform();
vec4 l9_259;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_260=l9_258;
l9_260.x=l9_258.x+_sc_framebufferFetchMarker;
l9_259=l9_260;
}
#else
{
...
{
l9_262=1-sc_GetStereoViewIndex();
}
#else
{
l9_262=sc_GetStereoViewIndex();
}
#endif
vec4 l9_263;
#if (sc_ScreenTextureLayout==2)
{
l9_263=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_261,sc_ScreenTextureLayout,l9_262),0.0);
}
#else
{
l9_263=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_261,sc_ScreenTextureLayout,l9_262).xy,0.0);
}
#endif
l9_257=l9_263;
}
...
{
vec4 l9_265=l9_257;
l9_265.x=l9_257.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_264=l9_265;
}
#else
{
...
#endif
vec3 l9_266=mix(l9_264.xyz,definedBlend(l9_264.xyz,l9_238.xyz).xyz,vec3(l9_239));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_268=vec4(mix(vec3(1.0),l9_238.xyz,vec3(l9_239)),l9_239);
}
#else
{
vec4 l9_269;
...
#endif
l9_269=vec4(l9_238.xyz*l9_270,l9_270);
}
#else
{
l9_269=l9_238;
...
{
l9_273=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_273=vec4(0.0);
...
vec4 l9_275=outputMotionVectorsIfNeeded(varPos,max(l9_274,vec4(0.0)));
vec4 l9_276=clamp(l9_275,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_277=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_277-0.0039215689)),min(1.0,l9_277+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_278=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_278).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_279=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_278).xy);
float l9_280=packValue(l9_279);
int l9_287=int(l9_276.w*255.0);
float l9_288=packValue(l9_287);
sc_writeFragData0Internal(vec4(packValue(l9_279),packValue(l9_279),packValue(l9_279),packValue(l9_279)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_280,packValue(l9_279),packValue(l9_279),packValue(l9_279)));
sc_writeFragData2(vec4(l9_288,packValue(l9_287),packValue(l9_287),packValue(l9_287)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_291=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_291).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_296==0)
{
l9_299=texture(sc_OITAlpha0,l9_291);
l9_298=texture(sc_OITDepthLow0,l9_291);
l9_297=texture(sc_OITDepthHigh0,l9_291);
}
else
{
l9_299=vec4(0.0);
...
if (l9_296==1)
{
l9_302=texture(sc_OITAlpha1,l9_291);
l9_301=texture(sc_OITDepthLow1,l9_291);
l9_300=texture(sc_OITDepthHigh1,l9_291);
}
else
{
l9_302=l9_299;
...
if (any(notEqual(l9_300,vec4(0.0)))||any(notEqual(l9_301,vec4(0.0))))
{
int l9_303[8]=l9_292;
unpackValues(l9_300.w,l9_296,l9_303);
unpackValues(l9_300.z,l9_296,l9_303);
unpackValues(l9_300.y,l9_296,l9_303);
unpackValues(l9_300.x,l9_296,l9_303);
unpackValues(l9_301.w,l9_296,l9_303);
unpackValues(l9_301.z,l9_296,l9_303);
unpackValues(l9_301.y,l9_296,l9_303);
unpackValues(l9_301.x,l9_296,l9_303);
int l9_312[8]=l9_293;
unpackValues(l9_302.w,l9_296,l9_312);
unpackValues(l9_302.z,l9_296,l9_312);
unpackValues(l9_302.y,l9_296,l9_312);
unpackValues(l9_302.x,l9_296,l9_312);
}
l9_296++;
continue;
}
...
vec4 l9_317=texture(sc_OITFilteredDepthBoundsTexture,l9_291);
vec2 l9_318=l9_317.xy;
int l9_319;
#if (sc_SkinBonesCount>0)
{
l9_319=encodeDepth(((1.0-l9_317.x)*1000.0)+getDepthOrderingEpsilon(),l9_318);
}
#else
{
l9_319=0;
...
#endif
int l9_320=encodeDepth(viewSpaceDepth(),l9_318);
vec4 l9_321;
l9_321=l9_276*l9_276.w;
vec4 l9_322;
int l9_323=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_323<8)
{
int l9_324=l9_292[l9_323];
int l9_325=l9_320-l9_319;
bool l9_326=l9_324<l9_325;
bool l9_327;
if (l9_326)
{
l9_327=l9_292[l9_323]>0;
}
else
{
l9_327=l9_326;
...
if (l9_327)
{
vec3 l9_328=l9_321.xyz*(1.0-(float(l9_293[l9_323])/255.0));
l9_322=vec4(l9_328.x,l9_328.y,l9_328.z,l9_321.w);
}
else
{
l9_322=l9_321;
...
sc_writeFragData0Internal(l9_321,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_276,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
