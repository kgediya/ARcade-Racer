...
vec4 l9_173;
if (l9_172<Port_Position1_N067)
{
l9_173=mix(Port_Value0_N067,Port_Value1_N067,vec4(clamp(l9_172/Port_Position1_N067,0.0,1.0)));
}
else
{
vec4 l9_174;
if (l9_172<Port_Position2_N067)
{
l9_174=mix(Port_Value1_N067,Port_Value2_N067,vec4(clamp((l9_172-Port_Position1_N067)/(Port_Position2_N067-Port_Position1_N067),0.0,1.0)));
}
else
{
vec4 l9_175;
if (l9_172<Port_Position3_N067)
{
l9_175=mix(Port_Value2_N067,Port_Value3_N067,vec4(clamp((l9_172-Port_Position2_N067)/(Port_Position3_N067-Port_Position2_N067),0.0,1.0)));
}
else
{
l9_175=mix(Port_Value3_N067,Port_Value4_N067,vec4(clamp((l9_172-Port_Position3_N067)/(1.0-Port_Position3_N067),0.0,1.0)));
}
l9_174=l9_175;
}
l9_173=l9_174;
...
vec3 l9_176=-l9_4;
vec4 l9_177=mix(l9_173,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_176,l9_11*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
vec4 l9_178=l9_116+l9_177;
float l9_179=l9_178.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_179<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_179<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_184=clamp(l9_179*2.0,0.0,1.0);
}
#else
{
float l9_185;
...
{
l9_185=clamp(dot(l9_178.xyz,vec3(l9_179)),0.0,1.0);
}
#else
{
float l9_186;
...
{
l9_187=(1.0-dot(l9_178.xyz,vec3(0.33333001)))*l9_179;
}
#else
{
float l9_188;
...
{
l9_188=(1.0-clamp(dot(l9_178.xyz,vec3(1.0)),0.0,1.0))*l9_179;
}
#else
{
float l9_189;
...
{
l9_189=clamp(dot(l9_178.xyz,vec3(1.0)),0.0,1.0)*l9_179;
}
#else
{
float l9_190;
#if (sc_BlendMode_Add)
{
l9_190=clamp(dot(l9_178.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_191;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_191=clamp(dot(l9_178.xyz,vec3(1.0)),0.0,1.0)*l9_179;
}
#else
{
float l9_192;
...
{
l9_192=dot(l9_178.xyz,vec3(0.33333001))*l9_179;
}
#else
{
float l9_193;
#if (sc_BlendMode_Min)
{
l9_193=1.0-clamp(dot(l9_178.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_194;
#if (sc_BlendMode_Max)
{
l9_194=clamp(dot(l9_178.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_194=1.0;
...
#endif
l9_182=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_178.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_183);
}
#else
{
vec4 l9_195;
...
#endif
vec3 l9_206=mix(l9_204.xyz,definedBlend(l9_204.xyz,l9_178.xyz).xyz,vec3(l9_179));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_208=vec4(mix(vec3(1.0),l9_178.xyz,vec3(l9_179)),l9_179);
}
#else
{
vec4 l9_209;
...
#endif
l9_209=vec4(l9_178.xyz*l9_210,l9_210);
}
#else
{
l9_209=l9_178;
