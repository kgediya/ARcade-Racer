...
//spec_const int opacityTexLayout 92 0
...
void Node29_If_else(float Bool1,vec2 Value1,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (Tweak_N67)
{
vec2 param_3;
...
{
vec2 param_3;
Node29_If_else(0.0,vec2(0.0),vec2(0.0),param_3,Globals);
Value3=param_3;
Result=Value3;
}
#else
...
{
vec2 l9_12;
Node29_If_else(0.0,vec2(0.0),vec2(0.0),l9_12,l9_5);
l9_11=l9_12;
}
#else
{
...
l9_15=((l9_16*Tweak_N50)+Tweak_N51)+(Tweak_N51*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_17;
...
#endif
l9_6=mix(Port_Input0_N006,l9_8,vec3(l9_18.x));
}
#else
{
vec3 l9_67;
Node0_Shadow_Sample(l9_67,l9_5);
l9_6=l9_67;
}
#endif
vec4 l9_68=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_68.w=Port_Value2_N001;
...
{
l9_73=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_74;
...
{
l9_74=clamp(dot(l9_68.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_75;
...
{
l9_76=(1.0-dot(l9_68.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_77;
...
{
l9_77=(1.0-clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_78;
...
{
l9_78=clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_79;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_80=clamp(dot(l9_68.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_81;
...
{
l9_81=dot(l9_68.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_82;
...
{
l9_92=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_90,sc_ScreenTextureLayout,l9_91),0.0);
}
#else
{
l9_92=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_90,sc_ScreenTextureLayout,l9_91).xy,0.0);
}
#endif
l9_86=l9_92;
}
...
{
vec4 l9_94=l9_86;
l9_94.x=l9_86.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_93=l9_94;
}
#else
{
...
#endif
vec3 l9_95=mix(l9_93.xyz,definedBlend(l9_93.xyz,l9_68.xyz).xyz,vec3(Port_Value2_N001));
vec4 l9_96=vec4(l9_95.x,l9_95.y,l9_95.z,vec4(0.0).w);
l9_96.w=1.0;
l9_85=l9_96;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_97=vec4(mix(vec3(1.0),l9_68.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_98;
...
{
l9_99=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_99=Port_Value2_N001;
}
#endif
l9_98=vec4(l9_68.xyz*l9_99,l9_99);
}
#else
{
l9_98=l9_68;
...
{
l9_102=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_102=vec4(0.0);
...
vec4 l9_104=outputMotionVectorsIfNeeded(varPos,max(l9_103,vec4(0.0)));
