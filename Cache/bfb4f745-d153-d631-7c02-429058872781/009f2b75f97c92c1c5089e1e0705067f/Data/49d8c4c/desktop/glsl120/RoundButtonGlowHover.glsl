...
//sampler sampler glow_mapSmpSC 0:16
...
//texture texture2D glow_map 0:0:0:16
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glow_map 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glow_map 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int glow_mapLayout 82 0
...
vec2 l9_1=varPackedTex.xy+Port_Offset_N009;
int l9_2;
...
#endif
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0));
float l9_4=l9_1.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_5=l9_4;
float l9_6=l9_1.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),glow_mapLayout,l9_2);
vec4 l9_25=texture2D(glow_map,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_26=mix(glow_mapBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
vec4 l9_28;
if (l9_27<Port_Position1_N005)
{
l9_28=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_27/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_29;
if (l9_27<Port_Position2_N005)
{
l9_29=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_27-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_29=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_27-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_28=l9_29;
}
bool l9_30=PreviewEnabled==1;
bool l9_31;
if (l9_30)
{
l9_31=!l9_0;
...
if (l9_28.x<float(l9_28.x<Port_Input1_N003))
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_28.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_28.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_37=clamp(l9_28.w*2.0,0.0,1.0);
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_28.xyz,vec3(l9_28.w)),0.0,1.0);
}
#else
{
float l9_39;
...
{
l9_40=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*l9_28.w;
}
#else
{
float l9_41;
...
{
l9_41=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*l9_28.w;
}
#else
{
float l9_42;
...
{
l9_42=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_28.w;
}
#else
{
float l9_43;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_44=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_28.w;
}
#else
{
float l9_45;
...
{
l9_45=dot(l9_28.xyz,vec3(0.33333001))*l9_28.w;
}
#else
{
float l9_46;
#if (sc_BlendMode_Min)
{
l9_46=1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
#if (sc_BlendMode_Max)
{
l9_47=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_47=1.0;
...
#endif
l9_35=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_28.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_36);
}
#else
{
vec4 l9_48;
...
#endif
l9_50=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_54,sc_ScreenTextureLayout,l9_55).xy,0.0);
}
#endif
vec4 l9_56;
...
#endif
vec3 l9_58=mix(l9_56.xyz,definedBlend(l9_56.xyz,l9_28.xyz).xyz,vec3(l9_28.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_60=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_28.w)),l9_28.w);
}
#else
{
vec4 l9_61;
...
#endif
l9_61=vec4(l9_28.xyz*l9_62,l9_62);
}
#else
{
l9_61=l9_28;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_69-0.0039215689)),min(1.0,l9_69+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_71),packValue(l9_71),packValue(l9_71),packValue(l9_71)),sc_UniformConstants.x,sc_ShaderCacheConstant);
