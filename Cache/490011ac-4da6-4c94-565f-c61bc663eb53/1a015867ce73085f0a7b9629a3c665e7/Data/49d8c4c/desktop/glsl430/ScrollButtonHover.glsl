...
float l9_172=clamp(((l9_171.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_173;
if (l9_172<Port_Position1_N005)
{
l9_173=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_172/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_174;
if (l9_172<Port_Position2_N005)
{
l9_174=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_172-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_174=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_172-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_173=l9_174;
}
vec3 l9_175=-l9_4;
vec4 l9_176=mix(l9_173,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_175,l9_11*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec2 l9_177=l9_3*Port_Input1_N067;
float l9_178=clamp(length(l9_177+Port_Input2_N067),0.0,1.0);
vec4 l9_179;
if (l9_178<Port_Position1_N069)
{
l9_179=mix(Port_Value0_N069,Port_Value1_N069,vec4(clamp(l9_178/Port_Position1_N069,0.0,1.0)));
}
else
{
vec4 l9_180;
if (l9_178<Port_Position2_N069)
{
l9_180=mix(Port_Value1_N069,Port_Value2_N069,vec4(clamp((l9_178-Port_Position1_N069)/(Port_Position2_N069-Port_Position1_N069),0.0,1.0)));
}
else
{
vec4 l9_181;
if (l9_178<Port_Position3_N069)
{
l9_181=mix(Port_Value2_N069,Port_Value3_N069,vec4(clamp((l9_178-Port_Position2_N069)/(Port_Position3_N069-Port_Position2_N069),0.0,1.0)));
}
else
{
l9_181=mix(Port_Value3_N069,Port_Value4_N069,vec4(clamp((l9_178-Port_Position3_N069)/(1.0-Port_Position3_N069),0.0,1.0)));
}
l9_180=l9_181;
}
l9_179=l9_180;
}
vec4 l9_182=l9_176+l9_179;
vec2 l9_183=l9_3-vec2(Port_RangeMinA_N076);
float l9_184=radians(Port_Rotation_N090);
float l9_185=sin(l9_184);
float l9_186=cos(l9_184);
vec2 l9_187=Port_CoordsIn_N090-Port_Center_N090;
vec2 l9_188=Port_Import_N081-Port_Import_N079;
vec4 l9_189=l9_182+mix(mix(Port_Input0_N092,Port_Input1_N092,vec4(max(pow(1.0-abs(dot(l9_175,l9_11*Port_Normal_N091)),Port_Exponent_N091),0.0)*Port_Intensity_N091)),Port_Input1_N093,mix(Port_Import_N074,Port_Import_N075,vec4(smoothstep(Port_Input0_N087,Port_Input1_N087,clamp((dot(((((((l9_183/vec2((Port_RangeMaxA_N076-Port_RangeMinA_N076)+1e-06))*(Port_RangeMaxB_N076-Port_RangeMinB_N076))+vec2(Port_RangeMinB_N076))-Port_Center_N078)*(vec2(dot(vec2(l9_186,l9_185),l9_187),dot(vec2(-l9_185,l9_186),l9_187))+Port_Center_N090))+Port_Center_N078)-Port_Import_N079,l9_188)/dot(l9_188,l9_188))+0.001,Port_Input1_N086+0.001,Port_Input2_N086+0.001)-0.001))));
vec2 l9_190=l9_3*Port_Input1_N028;
float l9_191=clamp(length(l9_190+Port_Input2_N028),0.0,1.0);
float l9_192;
if (l9_191<Port_Position1_N016)
{
l9_192=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_191/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_193;
if (l9_191<Port_Position2_N016)
{
l9_193=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_191-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_194;
if (l9_191<Port_Position3_N016)
{
l9_194=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_191-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_194=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_191-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_193=l9_194;
}
l9_192=l9_193;
}
vec4 l9_195=vec4(l9_189.x,l9_189.y,l9_189.z,vec4(0.0).w);
l9_195.w=l9_192;
vec4 l9_196=l9_116+l9_195;
float l9_197=l9_196.w;
...
#endif
sc_writeFragData0Internal(max(l9_198,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_200;
...
{
l9_202=clamp(l9_197*2.0,0.0,1.0);
}
#else
{
float l9_203;
...
{
l9_203=clamp(dot(l9_196.xyz,vec3(l9_197)),0.0,1.0);
}
#else
{
float l9_204;
...
{
l9_205=(1.0-dot(l9_196.xyz,vec3(0.33333001)))*l9_197;
}
#else
{
float l9_206;
...
{
l9_206=(1.0-clamp(dot(l9_196.xyz,vec3(1.0)),0.0,1.0))*l9_197;
}
#else
{
float l9_207;
...
{
l9_207=clamp(dot(l9_196.xyz,vec3(1.0)),0.0,1.0)*l9_197;
}
#else
{
float l9_208;
#if (sc_BlendMode_Add)
{
l9_208=clamp(dot(l9_196.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_209;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_209=clamp(dot(l9_196.xyz,vec3(1.0)),0.0,1.0)*l9_197;
}
#else
{
float l9_210;
...
{
l9_210=dot(l9_196.xyz,vec3(0.33333001))*l9_197;
}
#else
{
float l9_211;
#if (sc_BlendMode_Min)
{
l9_211=1.0-clamp(dot(l9_196.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_212;
#if (sc_BlendMode_Max)
{
l9_212=clamp(dot(l9_196.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_212=1.0;
...
#endif
l9_200=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_196.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_201);
}
#else
{
vec4 l9_213;
...
#if (sc_FramebufferFetch)
{
vec4 l9_216=sc_readFragData0_Platform();
vec4 l9_217;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_218=l9_216;
l9_218.x=l9_216.x+_sc_framebufferFetchMarker;
l9_217=l9_218;
}
#else
{
...
{
l9_220=1-sc_GetStereoViewIndex();
}
#else
{
l9_220=sc_GetStereoViewIndex();
}
#endif
vec4 l9_221;
#if (sc_ScreenTextureLayout==2)
{
l9_221=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_219,sc_ScreenTextureLayout,l9_220),0.0);
}
#else
{
l9_221=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_219,sc_ScreenTextureLayout,l9_220).xy,0.0);
}
#endif
l9_215=l9_221;
}
...
{
vec4 l9_223=l9_215;
l9_223.x=l9_215.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_222=l9_223;
}
#else
{
...
#endif
vec3 l9_224=mix(l9_222.xyz,definedBlend(l9_222.xyz,l9_196.xyz).xyz,vec3(l9_197));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_226=vec4(mix(vec3(1.0),l9_196.xyz,vec3(l9_197)),l9_197);
}
#else
{
vec4 l9_227;
...
#endif
l9_227=vec4(l9_196.xyz*l9_228,l9_228);
}
#else
{
l9_227=l9_196;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_235-0.0039215689)),min(1.0,l9_235+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_237),packValue(l9_237),packValue(l9_237),packValue(l9_237)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#else
{
sc_writeFragData0Internal(l9_233,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
