...
vec4 l9_126;
if (l9_125<Port_Position1_N007)
{
l9_126=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_125/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_127;
if (l9_125<Port_Position2_N007)
{
l9_127=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_125-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_127=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_125-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_126=l9_127;
}
...
float l9_133=clamp(l9_126.x,0.0,1.0);
float l9_134;
if (l9_133<Port_Position1_N018)
{
l9_134=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_133/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_135;
if (l9_133<Port_Position2_N018)
{
l9_135=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_133-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_136;
if (l9_133<Port_Position3_N018)
{
l9_136=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_133-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_136=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_133-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_135=l9_136;
}
l9_134=l9_135;
}
vec4 l9_137=vec4(l9_126.x,l9_126.y,l9_126.z,vec4(0.0).w);
l9_137.w=l9_134;
vec3 l9_138=-l9_6;
vec2 l9_139=l9_5-Port_Center_N002;
vec2 l9_140=(l9_139*Port_Scale_N002)+Port_Center_N002;
vec4 l9_141;
#if (iconLayout==2)
{
bool l9_142=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_143=l9_140.x;
sc_SoftwareWrapEarly(l9_143,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_144=l9_143;
float l9_145=l9_140.y;
sc_SoftwareWrapEarly(l9_145,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_146=l9_145;
vec2 l9_147;
float l9_148;
...
{
l9_149=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_150=l9_144;
float l9_151=1.0;
sc_ClampUV(l9_150,iconUvMinMax.x,iconUvMinMax.z,l9_149,l9_151);
float l9_152=l9_150;
float l9_153=l9_151;
bool l9_154;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_154=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_154=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_155=l9_146;
float l9_156=l9_153;
sc_ClampUV(l9_155,iconUvMinMax.y,iconUvMinMax.w,l9_154,l9_156);
l9_148=l9_156;
...
#endif
vec2 l9_157=sc_TransformUV(l9_147,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_158=l9_157.x;
float l9_159=l9_148;
sc_SoftwareWrapLate(l9_158,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_142,l9_159);
float l9_160=l9_157.y;
float l9_161=l9_159;
sc_SoftwareWrapLate(l9_160,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_142,l9_161);
float l9_162=l9_161;
vec3 l9_163=sc_SamplingCoordsViewToGlobal(vec2(l9_158,l9_160),iconLayout,iconGetStereoViewIndex());
vec4 l9_164=texture(iconArrSC,l9_163,0.0);
vec4 l9_165;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_165=mix(iconBorderColor,l9_164,vec4(l9_162));
}
#else
{
l9_165=l9_164;
...
#else
{
bool l9_166=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_167=l9_140.x;
sc_SoftwareWrapEarly(l9_167,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_168=l9_167;
float l9_169=l9_140.y;
sc_SoftwareWrapEarly(l9_169,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_170=l9_169;
vec2 l9_171;
float l9_172;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_173=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_174=l9_168;
float l9_175=1.0;
sc_ClampUV(l9_174,iconUvMinMax.x,iconUvMinMax.z,l9_173,l9_175);
float l9_176=l9_174;
float l9_177=l9_175;
bool l9_178;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_178=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_178=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_179=l9_170;
float l9_180=l9_177;
sc_ClampUV(l9_179,iconUvMinMax.y,iconUvMinMax.w,l9_178,l9_180);
l9_172=l9_180;
...
#endif
vec2 l9_181=sc_TransformUV(l9_171,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_182=l9_181.x;
float l9_183=l9_172;
sc_SoftwareWrapLate(l9_182,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_166,l9_183);
float l9_184=l9_181.y;
float l9_185=l9_183;
sc_SoftwareWrapLate(l9_184,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_166,l9_185);
float l9_186=l9_185;
vec3 l9_187=sc_SamplingCoordsViewToGlobal(vec2(l9_182,l9_184),iconLayout,iconGetStereoViewIndex());
vec4 l9_188=texture(icon,l9_187.xy,0.0);
vec4 l9_189;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_189=mix(iconBorderColor,l9_188,vec4(l9_186));
}
#else
{
l9_189=l9_188;
...
#if (iconLayout==2)
{
bool l9_192=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_193=l9_140.x;
sc_SoftwareWrapEarly(l9_193,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_194=l9_193;
float l9_195=l9_140.y;
sc_SoftwareWrapEarly(l9_195,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_196=l9_195;
vec2 l9_197;
float l9_198;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_199=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_200=l9_194;
float l9_201=1.0;
sc_ClampUV(l9_200,iconUvMinMax.x,iconUvMinMax.z,l9_199,l9_201);
float l9_202=l9_200;
float l9_203=l9_201;
bool l9_204;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_204=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_204=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_205=l9_196;
float l9_206=l9_203;
sc_ClampUV(l9_205,iconUvMinMax.y,iconUvMinMax.w,l9_204,l9_206);
l9_198=l9_206;
...
#endif
vec2 l9_207=sc_TransformUV(l9_197,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_208=l9_207.x;
float l9_209=l9_198;
sc_SoftwareWrapLate(l9_208,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_192,l9_209);
float l9_210=l9_207.y;
float l9_211=l9_209;
sc_SoftwareWrapLate(l9_210,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_192,l9_211);
float l9_212=l9_211;
vec3 l9_213=sc_SamplingCoordsViewToGlobal(vec2(l9_208,l9_210),iconLayout,iconGetStereoViewIndex());
vec4 l9_214=texture(iconArrSC,l9_213,0.0);
vec4 l9_215;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_215=mix(iconBorderColor,l9_214,vec4(l9_212));
}
#else
{
l9_215=l9_214;
...
#else
{
bool l9_216=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_217=l9_140.x;
sc_SoftwareWrapEarly(l9_217,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_218=l9_217;
float l9_219=l9_140.y;
sc_SoftwareWrapEarly(l9_219,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_220=l9_219;
vec2 l9_221;
float l9_222;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_223=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_224=l9_218;
float l9_225=1.0;
sc_ClampUV(l9_224,iconUvMinMax.x,iconUvMinMax.z,l9_223,l9_225);
float l9_226=l9_224;
float l9_227=l9_225;
bool l9_228;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_228=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_228=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_229=l9_220;
float l9_230=l9_227;
sc_ClampUV(l9_229,iconUvMinMax.y,iconUvMinMax.w,l9_228,l9_230);
l9_222=l9_230;
...
#endif
vec2 l9_231=sc_TransformUV(l9_221,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_232=l9_231.x;
float l9_233=l9_222;
sc_SoftwareWrapLate(l9_232,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_216,l9_233);
float l9_234=l9_231.y;
float l9_235=l9_233;
sc_SoftwareWrapLate(l9_234,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_216,l9_235);
float l9_236=l9_235;
vec3 l9_237=sc_SamplingCoordsViewToGlobal(vec2(l9_232,l9_234),iconLayout,iconGetStereoViewIndex());
vec4 l9_238=texture(icon,l9_237.xy,0.0);
vec4 l9_239;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_239=mix(iconBorderColor,l9_238,vec4(l9_236));
}
#else
{
l9_239=l9_238;
...
{
l9_190=Port_Input2_N003;
}
vec4 l9_240=vec4(l9_190);
vec4 l9_241=mix(mix(l9_68,l9_123,vec4(Port_Input2_N005))+mix(l9_137,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_138,l9_13*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031)),l9_141,l9_240);
float l9_242=l9_241.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_242<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_242<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_243,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_245;
...
{
l9_247=clamp(l9_242*2.0,0.0,1.0);
}
#else
{
float l9_248;
...
{
l9_248=clamp(dot(l9_241.xyz,vec3(l9_242)),0.0,1.0);
}
#else
{
float l9_249;
...
{
l9_250=(1.0-dot(l9_241.xyz,vec3(0.33333001)))*l9_242;
}
#else
{
float l9_251;
...
{
l9_251=(1.0-clamp(dot(l9_241.xyz,vec3(1.0)),0.0,1.0))*l9_242;
}
#else
{
float l9_252;
...
{
l9_252=clamp(dot(l9_241.xyz,vec3(1.0)),0.0,1.0)*l9_242;
}
#else
{
float l9_253;
#if (sc_BlendMode_Add)
{
l9_253=clamp(dot(l9_241.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_254;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_254=clamp(dot(l9_241.xyz,vec3(1.0)),0.0,1.0)*l9_242;
}
#else
{
float l9_255;
...
{
l9_255=dot(l9_241.xyz,vec3(0.33333001))*l9_242;
}
#else
{
float l9_256;
#if (sc_BlendMode_Min)
{
l9_256=1.0-clamp(dot(l9_241.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_257;
#if (sc_BlendMode_Max)
{
l9_257=clamp(dot(l9_241.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_257=1.0;
...
#endif
l9_245=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_241.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_246);
}
#else
{
vec4 l9_258;
...
#if (sc_FramebufferFetch)
{
vec4 l9_261=sc_readFragData0_Platform();
vec4 l9_262;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_263=l9_261;
l9_263.x=l9_261.x+_sc_framebufferFetchMarker;
l9_262=l9_263;
}
#else
{
...
{
l9_265=1-sc_GetStereoViewIndex();
}
#else
{
l9_265=sc_GetStereoViewIndex();
}
#endif
vec4 l9_266;
#if (sc_ScreenTextureLayout==2)
{
l9_266=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_264,sc_ScreenTextureLayout,l9_265),0.0);
}
#else
{
l9_266=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_264,sc_ScreenTextureLayout,l9_265).xy,0.0);
}
#endif
l9_260=l9_266;
}
...
{
vec4 l9_268=l9_260;
l9_268.x=l9_260.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_267=l9_268;
}
#else
{
...
#endif
vec3 l9_269=mix(l9_267.xyz,definedBlend(l9_267.xyz,l9_241.xyz).xyz,vec3(l9_242));
vec4 l9_270=vec4(l9_269.x,l9_269.y,l9_269.z,vec4(0.0).w);
l9_270.w=1.0;
l9_259=l9_270;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_271=vec4(mix(vec3(1.0),l9_241.xyz,vec3(l9_242)),l9_242);
}
#else
{
vec4 l9_272;
...
#endif
l9_272=vec4(l9_241.xyz*l9_273,l9_273);
}
#else
{
l9_272=l9_241;
...
{
l9_276=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_276=vec4(0.0);
...
vec4 l9_278=outputMotionVectorsIfNeeded(varPos,max(l9_277,vec4(0.0)));
...
#endif
int l9_282=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_281).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_294=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_294).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_299==0)
{
l9_302=texture(sc_OITAlpha0,l9_294);
l9_301=texture(sc_OITDepthLow0,l9_294);
l9_300=texture(sc_OITDepthHigh0,l9_294);
}
else
{
l9_302=vec4(0.0);
...
if (l9_299==1)
{
l9_305=texture(sc_OITAlpha1,l9_294);
l9_304=texture(sc_OITDepthLow1,l9_294);
l9_303=texture(sc_OITDepthHigh1,l9_294);
}
else
{
l9_305=l9_302;
...
vec4 l9_320=texture(sc_OITFilteredDepthBoundsTexture,l9_294);
