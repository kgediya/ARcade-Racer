...
//sampler sampler fingertipSmpSC 0:22
//sampler sampler handGlowTexSmpSC 0:23
...
//texture texture2D fingertip 0:3:0:22
//texture texture2D handGlowTex 0:4:0:23
...
//texture texture2DArray fingertipArrSC 0:34:0:22
//texture texture2DArray handGlowTexArrSC 0:35:0:23
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_fingertip 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_handGlowTex 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_fingertip 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_handGlowTex 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 88 -1
//spec_const int fingertipLayout 89 0
//spec_const int handGlowTexLayout 90 0
...
#endif
#ifndef fingertipHasSwappedViews
#define fingertipHasSwappedViews 0
#elif fingertipHasSwappedViews==1
#undef fingertipHasSwappedViews
#define fingertipHasSwappedViews 1
#endif
#ifndef fingertipLayout
#define fingertipLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_fingertip
#define SC_USE_UV_TRANSFORM_fingertip 0
#elif SC_USE_UV_TRANSFORM_fingertip==1
#undef SC_USE_UV_TRANSFORM_fingertip
#define SC_USE_UV_TRANSFORM_fingertip 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_fingertip
#define SC_SOFTWARE_WRAP_MODE_U_fingertip -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_fingertip
#define SC_SOFTWARE_WRAP_MODE_V_fingertip -1
#endif
#ifndef SC_USE_UV_MIN_MAX_fingertip
#define SC_USE_UV_MIN_MAX_fingertip 0
#elif SC_USE_UV_MIN_MAX_fingertip==1
#undef SC_USE_UV_MIN_MAX_fingertip
#define SC_USE_UV_MIN_MAX_fingertip 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_fingertip
#define SC_USE_CLAMP_TO_BORDER_fingertip 0
#elif SC_USE_CLAMP_TO_BORDER_fingertip==1
#undef SC_USE_CLAMP_TO_BORDER_fingertip
#define SC_USE_CLAMP_TO_BORDER_fingertip 1
#endif
...
uniform mat3 fingertipTransform;
uniform vec4 fingertipUvMinMax;
uniform vec4 fingertipBorderColor;
...
uniform sampler2D fingertip;
uniform sampler2DArray fingertipArrSC;
...
int fingertipGetStereoViewIndex()
{
int l9_0;
#if (fingertipHasSwappedViews)
{
...
vec4 l9_2;
#if (fingertipLayout==2)
{
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0)&&(!(int(SC_USE_UV_MIN_MAX_fingertip)!=0));
float l9_4=l9_0.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x);
float l9_5=l9_4;
float l9_6=l9_0.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
#if (SC_USE_UV_MIN_MAX_fingertip)
{
bool l9_10;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,fingertipUvMinMax.x,fingertipUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,fingertipUvMinMax.y,fingertipUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_fingertip)!=0),fingertipTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),fingertipLayout,fingertipGetStereoViewIndex());
vec4 l9_25=texture(fingertipArrSC,l9_24,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_26=mix(fingertipBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#else
{
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0)&&(!(int(SC_USE_UV_MIN_MAX_fingertip)!=0));
float l9_28=l9_0.x;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x);
float l9_29=l9_28;
float l9_30=l9_0.y;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
#if (SC_USE_UV_MIN_MAX_fingertip)
...
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,fingertipUvMinMax.x,fingertipUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,fingertipUvMinMax.y,fingertipUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_fingertip)!=0),fingertipTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x,l9_27,l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y,l9_27,l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),fingertipLayout,fingertipGetStereoViewIndex());
vec4 l9_49=texture(fingertip,l9_48.xy,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_50=mix(fingertipBorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
{
bool l9_52=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0));
float l9_53=l9_0.x;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_54=l9_53;
float l9_55=l9_0.y;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_56=l9_55;
vec2 l9_57;
float l9_58;
...
{
l9_59=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_59=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_60=l9_54;
float l9_61=1.0;
sc_ClampUV(l9_60,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_59,l9_61);
float l9_62=l9_60;
float l9_63=l9_61;
bool l9_64;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_64=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_64=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_65=l9_56;
float l9_66=l9_63;
sc_ClampUV(l9_65,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_64,l9_66);
l9_58=l9_66;
...
#endif
vec2 l9_67=sc_TransformUV(l9_57,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_68=l9_67.x;
float l9_69=l9_58;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,l9_52,l9_69);
float l9_70=l9_67.y;
float l9_71=l9_69;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,l9_52,l9_71);
float l9_72=l9_71;
vec3 l9_73=sc_SamplingCoordsViewToGlobal(vec2(l9_68,l9_70),handGlowTexLayout,handGlowTexGetStereoViewIndex());
vec4 l9_74=texture(handGlowTexArrSC,l9_73,0.0);
vec4 l9_75;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_75=mix(handGlowTexBorderColor,l9_74,vec4(l9_72));
}
#else
{
l9_75=l9_74;
...
#else
{
bool l9_76=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0));
float l9_77=l9_0.x;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_78=l9_77;
float l9_79=l9_0.y;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_80=l9_79;
vec2 l9_81;
float l9_82;
#if (SC_USE_UV_MIN_MAX_handGlowTex)
...
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_83=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_83=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_84=l9_78;
float l9_85=1.0;
sc_ClampUV(l9_84,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_83,l9_85);
float l9_86=l9_84;
float l9_87=l9_85;
bool l9_88;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_88=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_88=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_89=l9_80;
float l9_90=l9_87;
sc_ClampUV(l9_89,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_88,l9_90);
l9_82=l9_90;
...
#endif
vec2 l9_91=sc_TransformUV(l9_81,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_92=l9_91.x;
float l9_93=l9_82;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,l9_76,l9_93);
float l9_94=l9_91.y;
float l9_95=l9_93;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,l9_76,l9_95);
float l9_96=l9_95;
vec3 l9_97=sc_SamplingCoordsViewToGlobal(vec2(l9_92,l9_94),handGlowTexLayout,handGlowTexGetStereoViewIndex());
vec4 l9_98=texture(handGlowTex,l9_97.xy,0.0);
vec4 l9_99;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_99=mix(handGlowTexBorderColor,l9_98,vec4(l9_96));
}
#else
{
l9_99=l9_98;
...
#endif
vec4 l9_100=mix(l9_2,l9_51,vec4(blend_coef));
float l9_101=mix(Port_Input0_N003,indexBrightness,l9_100.y);
vec4 l9_102=vec4(indexGlowColor.xyz,l9_101);
vec3 l9_103=l9_102.xyz*l9_101;
vec4 l9_104=vec4(l9_103.x,l9_103.y,l9_103.z,l9_102.w)+(vec4(thumbGlowColor.xyz,mix(Port_Input0_N011,thumbBrightness,l9_100.x))*(1.0-l9_101));
...
#endif
vec3 l9_132=mix(l9_130.xyz,definedBlend(l9_130.xyz,l9_104.xyz).xyz,vec3(l9_105));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_134=vec4(mix(vec3(1.0),l9_104.xyz,vec3(l9_105)),l9_105);
}
#else
{
vec4 l9_135;
...
#endif
l9_135=vec4(l9_104.xyz*l9_136,l9_136);
}
#else
{
l9_135=l9_104;
