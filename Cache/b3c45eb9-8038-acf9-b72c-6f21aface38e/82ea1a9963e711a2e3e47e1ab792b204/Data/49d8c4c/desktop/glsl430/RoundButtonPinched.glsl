...
vec2 l9_67=l9_3*Port_Input1_N010;
float l9_68=clamp(length(l9_67+Port_Input2_N010),0.0,1.0);
vec4 l9_69;
if (l9_68<Port_Position1_N030)
{
l9_69=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_68/Port_Position1_N030,0.0,1.0)));
}
else
{
l9_69=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_68-Port_Position1_N030)/(1.0-Port_Position1_N030),0.0,1.0)));
}
vec3 l9_70=-l9_4;
vec4 l9_71=mix(l9_69,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_70,l9_11*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_72=l9_71.w;
vec3 l9_73=(l9_66.xyz+Port_Input1_N002)+l9_71.xyz;
...
#endif
sc_writeFragData0Internal(max(l9_75,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_77;
...
{
l9_80=clamp(dot(l9_74.xyz,vec3(l9_72)),0.0,1.0);
}
#else
{
float l9_81;
...
{
l9_82=(1.0-dot(l9_74.xyz,vec3(0.33333001)))*l9_72;
}
#else
{
float l9_83;
...
{
l9_83=(1.0-clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0))*l9_72;
}
#else
{
float l9_84;
...
#if (sc_BlendMode_Add)
{
l9_85=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_86;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_86=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0)*l9_72;
}
#else
{
float l9_87;
...
{
l9_87=dot(l9_74.xyz,vec3(0.33333001))*l9_72;
}
#else
{
float l9_88;
#if (sc_BlendMode_Min)
{
l9_88=1.0-clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_89;
#if (sc_BlendMode_Max)
{
l9_89=clamp(dot(l9_74.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_89=1.0;
...
#endif
l9_77=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_74.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_78);
}
#else
{
vec4 l9_90;
...
{
l9_98=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_96,sc_ScreenTextureLayout,l9_97),0.0);
}
#else
{
l9_98=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_96,sc_ScreenTextureLayout,l9_97).xy,0.0);
}
#endif
l9_92=l9_98;
}
...
{
vec4 l9_100=l9_92;
l9_100.x=l9_92.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_99=l9_100;
}
#else
{
...
#endif
vec3 l9_101=mix(l9_99.xyz,definedBlend(l9_99.xyz,l9_74.xyz).xyz,vec3(l9_72));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_103=vec4(mix(vec3(1.0),l9_74.xyz,vec3(l9_72)),l9_72);
}
#else
{
vec4 l9_104;
...
#endif
l9_104=vec4(l9_74.xyz*l9_105,l9_105);
}
#else
{
l9_104=l9_74;
...
{
l9_108=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_108=vec4(0.0);
...
vec4 l9_110=outputMotionVectorsIfNeeded(varPos,max(l9_109,vec4(0.0)));
vec4 l9_111=clamp(l9_110,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_112=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_112-0.0039215689)),min(1.0,l9_112+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_114=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_113).xy);
float l9_115=packValue(l9_114);
int l9_122=int(l9_111.w*255.0);
float l9_123=packValue(l9_122);
sc_writeFragData0Internal(vec4(packValue(l9_114),packValue(l9_114),packValue(l9_114),packValue(l9_114)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_115,packValue(l9_114),packValue(l9_114),packValue(l9_114)));
sc_writeFragData2(vec4(l9_123,packValue(l9_122),packValue(l9_122),packValue(l9_122)));
...
if (l9_131==0)
{
l9_134=texture(sc_OITAlpha0,l9_126);
l9_133=texture(sc_OITDepthLow0,l9_126);
l9_132=texture(sc_OITDepthHigh0,l9_126);
}
else
{
l9_134=vec4(0.0);
...
if (l9_131==1)
{
l9_137=texture(sc_OITAlpha1,l9_126);
l9_136=texture(sc_OITDepthLow1,l9_126);
l9_135=texture(sc_OITDepthHigh1,l9_126);
}
else
{
l9_137=l9_134;
...
if (any(notEqual(l9_135,vec4(0.0)))||any(notEqual(l9_136,vec4(0.0))))
{
int l9_138[8]=l9_127;
unpackValues(l9_135.w,l9_131,l9_138);
unpackValues(l9_135.z,l9_131,l9_138);
unpackValues(l9_135.y,l9_131,l9_138);
unpackValues(l9_135.x,l9_131,l9_138);
unpackValues(l9_136.w,l9_131,l9_138);
unpackValues(l9_136.z,l9_131,l9_138);
unpackValues(l9_136.y,l9_131,l9_138);
unpackValues(l9_136.x,l9_131,l9_138);
int l9_147[8]=l9_128;
unpackValues(l9_137.w,l9_131,l9_147);
unpackValues(l9_137.z,l9_131,l9_147);
unpackValues(l9_137.y,l9_131,l9_147);
unpackValues(l9_137.x,l9_131,l9_147);
}
l9_131++;
continue;
}
...
vec4 l9_152=texture(sc_OITFilteredDepthBoundsTexture,l9_126);
vec2 l9_153=l9_152.xy;
int l9_154;
#if (sc_SkinBonesCount>0)
{
l9_154=encodeDepth(((1.0-l9_152.x)*1000.0)+getDepthOrderingEpsilon(),l9_153);
}
#else
{
l9_154=0;
...
#endif
int l9_155=encodeDepth(viewSpaceDepth(),l9_153);
vec4 l9_156;
l9_156=l9_111*l9_111.w;
vec4 l9_157;
int l9_158=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_158<8)
{
int l9_159=l9_127[l9_158];
int l9_160=l9_155-l9_154;
bool l9_161=l9_159<l9_160;
bool l9_162;
if (l9_161)
{
l9_162=l9_127[l9_158]>0;
}
else
{
l9_162=l9_161;
...
if (l9_162)
{
vec3 l9_163=l9_156.xyz*(1.0-(float(l9_128[l9_158])/255.0));
l9_157=vec4(l9_163.x,l9_163.y,l9_163.z,l9_156.w);
}
else
{
l9_157=l9_156;
...
sc_writeFragData0Internal(l9_111,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
