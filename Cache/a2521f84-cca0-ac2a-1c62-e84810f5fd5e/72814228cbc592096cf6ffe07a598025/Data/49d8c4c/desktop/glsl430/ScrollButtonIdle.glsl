...
vec2 l9_117=l9_3*Port_Input1_N028;
float l9_118=clamp(length(l9_117+Port_Input2_N028),0.0,1.0);
vec4 l9_119;
if (l9_118<Port_Position1_N031)
{
l9_119=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_118/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_120;
if (l9_118<Port_Position2_N031)
{
l9_120=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_118-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_121;
if (l9_118<Port_Position3_N031)
{
l9_121=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_118-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_121=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_118-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_120=l9_121;
}
l9_119=l9_120;
}
vec3 l9_122=l9_11*Port_Import_N041;
float l9_123=dot(l9_122,l9_122);
float l9_124;
if (l9_123>0.0)
{
l9_124=1.0/sqrt(l9_123);
}
else
{
l9_124=0.0;
}
vec3 l9_125=l9_122*l9_124;
vec3 l9_126=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_125,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
vec4 l9_127;
#if (capsule_btn_refl_tex_1Layout==2)
{
bool l9_128=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0));
float l9_129=l9_126.x;
sc_SoftwareWrapEarly(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_130=l9_129;
float l9_131=l9_126.y;
sc_SoftwareWrapEarly(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_132=l9_131;
vec2 l9_133;
float l9_134;
...
{
l9_135=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
...
float l9_136=l9_130;
float l9_137=1.0;
sc_ClampUV(l9_136,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_135,l9_137);
float l9_138=l9_136;
float l9_139=l9_137;
bool l9_140;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_140=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_140=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_141=l9_132;
float l9_142=l9_139;
sc_ClampUV(l9_141,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_140,l9_142);
l9_134=l9_142;
...
#endif
vec2 l9_143=sc_TransformUV(l9_133,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_144=l9_143.x;
float l9_145=l9_134;
sc_SoftwareWrapLate(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,l9_128,l9_145);
float l9_146=l9_143.y;
float l9_147=l9_145;
sc_SoftwareWrapLate(l9_146,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,l9_128,l9_147);
float l9_148=l9_147;
vec3 l9_149=sc_SamplingCoordsViewToGlobal(vec2(l9_144,l9_146),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_150=texture(capsule_btn_refl_tex_1ArrSC,l9_149,0.0);
vec4 l9_151;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_151=mix(capsule_btn_refl_tex_1BorderColor,l9_150,vec4(l9_148));
}
#else
{
l9_151=l9_150;
...
#else
{
bool l9_152=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0));
float l9_153=l9_126.x;
sc_SoftwareWrapEarly(l9_153,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_154=l9_153;
float l9_155=l9_126.y;
sc_SoftwareWrapEarly(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_156=l9_155;
vec2 l9_157;
float l9_158;
#if (SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)
...
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_159=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
...
float l9_160=l9_154;
float l9_161=1.0;
sc_ClampUV(l9_160,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_159,l9_161);
float l9_162=l9_160;
float l9_163=l9_161;
bool l9_164;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_164=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_164=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_165=l9_156;
float l9_166=l9_163;
sc_ClampUV(l9_165,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_164,l9_166);
l9_158=l9_166;
...
#endif
vec2 l9_167=sc_TransformUV(l9_157,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_168=l9_167.x;
float l9_169=l9_158;
sc_SoftwareWrapLate(l9_168,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,l9_152,l9_169);
float l9_170=l9_167.y;
float l9_171=l9_169;
sc_SoftwareWrapLate(l9_170,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,l9_152,l9_171);
float l9_172=l9_171;
vec3 l9_173=sc_SamplingCoordsViewToGlobal(vec2(l9_168,l9_170),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_174=texture(capsule_btn_refl_tex_1,l9_173.xy,0.0);
vec4 l9_175;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_175=mix(capsule_btn_refl_tex_1BorderColor,l9_174,vec4(l9_172));
}
#else
{
l9_175=l9_174;
...
#endif
vec4 l9_176=vec4(Port_Import_N027)*l9_127;
float l9_177=clamp(((l9_176.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_178;
if (l9_177<Port_Position1_N005)
{
l9_178=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_177/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_179;
if (l9_177<Port_Position2_N005)
{
l9_179=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_177-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_179=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_177-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_178=l9_179;
}
vec3 l9_180=-l9_4;
vec4 l9_181=mix(l9_178,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_180,l9_11*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec4 l9_182=l9_119+l9_181;
float l9_183;
if (l9_118<Port_Position1_N016)
{
l9_183=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_118/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_184;
if (l9_118<Port_Position2_N016)
{
l9_184=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_118-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_185;
if (l9_118<Port_Position3_N016)
{
l9_185=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_118-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_185=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_118-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_184=l9_185;
}
l9_183=l9_184;
}
vec4 l9_186=vec4(l9_182.x,l9_182.y,l9_182.z,vec4(0.0).w);
l9_186.w=l9_183;
vec4 l9_187=l9_116+l9_186;
float l9_188=l9_187.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_188<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_188<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_189,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_191;
...
{
l9_193=clamp(l9_188*2.0,0.0,1.0);
}
#else
{
float l9_194;
...
{
l9_194=clamp(dot(l9_187.xyz,vec3(l9_188)),0.0,1.0);
}
#else
{
float l9_195;
...
{
l9_196=(1.0-dot(l9_187.xyz,vec3(0.33333001)))*l9_188;
}
#else
{
float l9_197;
...
{
l9_197=(1.0-clamp(dot(l9_187.xyz,vec3(1.0)),0.0,1.0))*l9_188;
}
#else
{
float l9_198;
...
{
l9_198=clamp(dot(l9_187.xyz,vec3(1.0)),0.0,1.0)*l9_188;
}
#else
{
float l9_199;
#if (sc_BlendMode_Add)
{
l9_199=clamp(dot(l9_187.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_200;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_200=clamp(dot(l9_187.xyz,vec3(1.0)),0.0,1.0)*l9_188;
}
#else
{
float l9_201;
...
{
l9_201=dot(l9_187.xyz,vec3(0.33333001))*l9_188;
}
#else
{
float l9_202;
#if (sc_BlendMode_Min)
{
l9_202=1.0-clamp(dot(l9_187.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_203;
#if (sc_BlendMode_Max)
{
l9_203=clamp(dot(l9_187.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_203=1.0;
...
#endif
l9_191=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_187.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_192);
}
#else
{
vec4 l9_204;
...
#if (sc_FramebufferFetch)
{
vec4 l9_207=sc_readFragData0_Platform();
vec4 l9_208;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_209=l9_207;
l9_209.x=l9_207.x+_sc_framebufferFetchMarker;
l9_208=l9_209;
}
#else
{
...
#else
{
vec2 l9_210=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_211;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_211=1-sc_GetStereoViewIndex();
}
#else
{
l9_211=sc_GetStereoViewIndex();
}
#endif
vec4 l9_212;
#if (sc_ScreenTextureLayout==2)
{
l9_212=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_210,sc_ScreenTextureLayout,l9_211),0.0);
}
#else
{
l9_212=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_210,sc_ScreenTextureLayout,l9_211).xy,0.0);
}
#endif
l9_206=l9_212;
}
...
{
vec4 l9_214=l9_206;
l9_214.x=l9_206.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_213=l9_214;
}
#else
{
...
#endif
vec3 l9_215=mix(l9_213.xyz,definedBlend(l9_213.xyz,l9_187.xyz).xyz,vec3(l9_188));
vec4 l9_216=vec4(l9_215.x,l9_215.y,l9_215.z,vec4(0.0).w);
l9_216.w=1.0;
l9_205=l9_216;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_217=vec4(mix(vec3(1.0),l9_187.xyz,vec3(l9_188)),l9_188);
}
#else
{
vec4 l9_218;
...
#endif
l9_218=vec4(l9_187.xyz*l9_219,l9_219);
}
#else
{
l9_218=l9_187;
...
{
l9_222=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_222=vec4(0.0);
...
vec4 l9_224=outputMotionVectorsIfNeeded(varPos,max(l9_223,vec4(0.0)));
vec4 l9_225=clamp(l9_224,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_226=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_226-0.0039215689)),min(1.0,l9_226+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_228=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_227).xy);
float l9_229=packValue(l9_228);
int l9_236=int(l9_225.w*255.0);
float l9_237=packValue(l9_236);
sc_writeFragData0Internal(vec4(packValue(l9_228),packValue(l9_228),packValue(l9_228),packValue(l9_228)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_229,packValue(l9_228),packValue(l9_228),packValue(l9_228)));
sc_writeFragData2(vec4(l9_237,packValue(l9_236),packValue(l9_236),packValue(l9_236)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_240=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_245==0)
{
l9_248=texture(sc_OITAlpha0,l9_240);
l9_247=texture(sc_OITDepthLow0,l9_240);
l9_246=texture(sc_OITDepthHigh0,l9_240);
}
else
{
l9_248=vec4(0.0);
...
if (l9_245==1)
{
l9_251=texture(sc_OITAlpha1,l9_240);
l9_250=texture(sc_OITDepthLow1,l9_240);
l9_249=texture(sc_OITDepthHigh1,l9_240);
}
else
{
l9_251=l9_248;
...
if (any(notEqual(l9_249,vec4(0.0)))||any(notEqual(l9_250,vec4(0.0))))
{
int l9_252[8]=l9_241;
unpackValues(l9_249.w,l9_245,l9_252);
unpackValues(l9_249.z,l9_245,l9_252);
unpackValues(l9_249.y,l9_245,l9_252);
unpackValues(l9_249.x,l9_245,l9_252);
unpackValues(l9_250.w,l9_245,l9_252);
unpackValues(l9_250.z,l9_245,l9_252);
unpackValues(l9_250.y,l9_245,l9_252);
unpackValues(l9_250.x,l9_245,l9_252);
int l9_261[8]=l9_242;
unpackValues(l9_251.w,l9_245,l9_261);
unpackValues(l9_251.z,l9_245,l9_261);
unpackValues(l9_251.y,l9_245,l9_261);
unpackValues(l9_251.x,l9_245,l9_261);
}
l9_245++;
continue;
}
...
vec4 l9_266=texture(sc_OITFilteredDepthBoundsTexture,l9_240);
vec2 l9_267=l9_266.xy;
int l9_268;
#if (sc_SkinBonesCount>0)
{
l9_268=encodeDepth(((1.0-l9_266.x)*1000.0)+getDepthOrderingEpsilon(),l9_267);
}
#else
{
l9_268=0;
...
#endif
int l9_269=encodeDepth(viewSpaceDepth(),l9_267);
vec4 l9_270;
l9_270=l9_225*l9_225.w;
vec4 l9_271;
int l9_272=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_272<8)
{
int l9_273=l9_241[l9_272];
int l9_274=l9_269-l9_268;
bool l9_275=l9_273<l9_274;
bool l9_276;
if (l9_275)
{
l9_276=l9_241[l9_272]>0;
}
else
{
l9_276=l9_275;
...
if (l9_276)
{
vec3 l9_277=l9_270.xyz*(1.0-(float(l9_242[l9_272])/255.0));
l9_271=vec4(l9_277.x,l9_277.y,l9_277.z,l9_270.w);
}
else
{
l9_271=l9_270;
