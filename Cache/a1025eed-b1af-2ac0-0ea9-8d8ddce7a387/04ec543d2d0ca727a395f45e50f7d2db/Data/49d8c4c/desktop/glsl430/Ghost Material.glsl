...
//spec_const bool uv2EnableAnimation 87 0
//spec_const bool uv3EnableAnimation 88 0
//spec_const int NODE_13_DROPLIST_ITEM 89 0
//spec_const int NODE_27_DROPLIST_ITEM 90 0
//spec_const int NODE_49_DROPLIST_ITEM 91 0
//spec_const int NODE_69_DROPLIST_ITEM 92 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 95 -1
...
//spec_const int opacityTexLayout 101 0
...
vec2 l9_124=l9_2-Port_Input1_N085;
float l9_125=l9_123*max(smoothstep(blur,blur*Port_Input1_N098,length(max(abs(l9_124)-(boxSize-vec2(cornerRadius)),Port_Input1_N089))-cornerRadius),Port_Input1_N094);
vec4 l9_126=vec4(l9_64.x,l9_64.y,l9_64.z,vec4(0.0).w);
l9_126.w=l9_125;
vec2 l9_127=l9_2-Port_Input1_N046;
vec3 l9_128=smoothstep(Port_Input0_N073,Port_Input1_N073,vec3(distance(Port_Input0_N042,l9_127*vec2(Port_Input1_N047))));
float l9_129=sin(sc_Time.x*Port_Multiplier_N054);
float l9_130=(max(((l9_129*Port_Input1_N078)*l9_129)*Port_Input1_N080,Port_Input1_N079)*Port_Input1_N057)+Port_Input1_N070;
...
{
l9_134=pow(l9_133,l9_130);
}
float l9_135=l9_128.z;
float l9_136;
if (l9_135<=0.0)
{
l9_136=0.0;
...
{
l9_136=pow(l9_135,l9_130);
}
vec3 l9_137=mix(vec3(l9_132,l9_134,l9_136),vec3(floor(fract(sin(floor(dot(floor((floor(l9_2*10000.0)*9.9999997e-05)*Port_Scale_N081),vec2(0.98000002,0.72000003))*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05),vec3(Port_Input2_N082));
vec4 l9_138=vec4(l9_137.x,l9_137.y,l9_137.z,vec4(0.0).w);
l9_138.w=l9_125;
vec4 l9_139=mix(l9_126,l9_138,vec4(Port_Input2_N045));
if ((step(l9_125,Port_Input1_N099)*1.0)!=0.0)
{
discard;
}
float l9_140=l9_139.w;
...
#endif
sc_writeFragData0Internal(max(l9_141,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_143;
...
{
l9_145=clamp(l9_140*2.0,0.0,1.0);
}
#else
{
float l9_146;
...
{
l9_146=clamp(dot(l9_139.xyz,vec3(l9_140)),0.0,1.0);
}
#else
{
float l9_147;
...
{
l9_148=(1.0-dot(l9_139.xyz,vec3(0.33333001)))*l9_140;
}
#else
{
float l9_149;
...
{
l9_149=(1.0-clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0))*l9_140;
}
#else
{
float l9_150;
...
{
l9_150=clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0)*l9_140;
}
#else
{
float l9_151;
#if (sc_BlendMode_Add)
{
l9_151=clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_152;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_152=clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0)*l9_140;
}
#else
{
float l9_153;
...
{
l9_153=dot(l9_139.xyz,vec3(0.33333001))*l9_140;
}
#else
{
float l9_154;
#if (sc_BlendMode_Min)
{
l9_154=1.0-clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_155;
#if (sc_BlendMode_Max)
{
l9_155=clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_155=1.0;
...
#endif
l9_143=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_139.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_144);
}
#else
{
vec4 l9_156;
...
#if (sc_FramebufferFetch)
{
vec4 l9_159=sc_readFragData0_Platform();
vec4 l9_160;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_161=l9_159;
l9_161.x=l9_159.x+_sc_framebufferFetchMarker;
l9_160=l9_161;
}
#else
{
...
{
l9_163=1-sc_GetStereoViewIndex();
}
#else
{
l9_163=sc_GetStereoViewIndex();
}
#endif
vec4 l9_164;
#if (sc_ScreenTextureLayout==2)
{
l9_164=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_162,sc_ScreenTextureLayout,l9_163),0.0);
}
#else
{
l9_164=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_162,sc_ScreenTextureLayout,l9_163).xy,0.0);
}
#endif
l9_158=l9_164;
}
...
{
vec4 l9_166=l9_158;
l9_166.x=l9_158.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_165=l9_166;
}
#else
{
...
#endif
vec3 l9_167=mix(l9_165.xyz,definedBlend(l9_165.xyz,l9_139.xyz).xyz,vec3(l9_140));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_169=vec4(mix(vec3(1.0),l9_139.xyz,vec3(l9_140)),l9_140);
}
#else
{
vec4 l9_170;
...
#endif
l9_170=vec4(l9_139.xyz*l9_171,l9_171);
}
#else
{
l9_170=l9_139;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_178-0.0039215689)),min(1.0,l9_178+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_180=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_179).xy);
float l9_181=packValue(l9_180);
int l9_188=int(l9_177.w*255.0);
float l9_189=packValue(l9_188);
sc_writeFragData0Internal(vec4(packValue(l9_180),packValue(l9_180),packValue(l9_180),packValue(l9_180)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
if (l9_197==0)
{
l9_200=texture(sc_OITAlpha0,l9_192);
l9_199=texture(sc_OITDepthLow0,l9_192);
l9_198=texture(sc_OITDepthHigh0,l9_192);
}
else
{
l9_200=vec4(0.0);
...
if (l9_197==1)
{
l9_203=texture(sc_OITAlpha1,l9_192);
l9_202=texture(sc_OITDepthLow1,l9_192);
l9_201=texture(sc_OITDepthHigh1,l9_192);
}
else
{
l9_203=l9_200;
...
vec4 l9_218=texture(sc_OITFilteredDepthBoundsTexture,l9_192);
