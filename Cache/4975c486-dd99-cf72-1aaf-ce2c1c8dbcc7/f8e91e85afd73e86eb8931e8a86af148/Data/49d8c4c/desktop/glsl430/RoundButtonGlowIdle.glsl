...
#endif
sc_writeFragData0Internal(max(l9_4,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_6;
...
{
l9_27=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_25,sc_ScreenTextureLayout,l9_26),0.0);
}
#else
{
l9_27=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_25,sc_ScreenTextureLayout,l9_26).xy,0.0);
}
#endif
l9_21=l9_27;
}
