...
vec3 l9_72=-l9_4;
vec4 l9_73=mix(l9_69,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(l9_72,l9_11*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_74=l9_73.w;
vec3 l9_75=(l9_66.xyz+Port_Input1_N002)+l9_73.xyz;
vec4 l9_76=vec4(l9_75.x,l9_75.y,l9_75.z,vec4(0.0).w);
l9_76.w=l9_74;
#if (sc_BlendMode_AlphaTest)
{
if (l9_74<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_74<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_77,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_79;
...
{
l9_82=clamp(dot(l9_76.xyz,vec3(l9_74)),0.0,1.0);
}
#else
{
float l9_83;
...
{
l9_84=(1.0-dot(l9_76.xyz,vec3(0.33333001)))*l9_74;
}
#else
{
float l9_85;
...
{
l9_85=(1.0-clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0))*l9_74;
}
#else
{
float l9_86;
...
{
l9_86=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0)*l9_74;
}
#else
{
float l9_87;
#if (sc_BlendMode_Add)
{
l9_87=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_88;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_88=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0)*l9_74;
}
#else
{
float l9_89;
...
{
l9_89=dot(l9_76.xyz,vec3(0.33333001))*l9_74;
}
#else
{
float l9_90;
#if (sc_BlendMode_Min)
{
l9_90=1.0-clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_91;
#if (sc_BlendMode_Max)
{
l9_91=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_91=1.0;
...
#endif
l9_79=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_76.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_80);
}
#else
{
vec4 l9_92;
...
#if (sc_FramebufferFetch)
{
vec4 l9_95=sc_readFragData0_Platform();
vec4 l9_96;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_97=l9_95;
l9_97.x=l9_95.x+_sc_framebufferFetchMarker;
l9_96=l9_97;
}
#else
{
...
{
l9_99=1-sc_GetStereoViewIndex();
}
#else
{
l9_99=sc_GetStereoViewIndex();
}
#endif
vec4 l9_100;
#if (sc_ScreenTextureLayout==2)
{
l9_100=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_98,sc_ScreenTextureLayout,l9_99),0.0);
}
#else
{
l9_100=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_98,sc_ScreenTextureLayout,l9_99).xy,0.0);
}
#endif
l9_94=l9_100;
}
...
{
vec4 l9_102=l9_94;
l9_102.x=l9_94.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_101=l9_102;
}
#else
{
...
#endif
vec3 l9_103=mix(l9_101.xyz,definedBlend(l9_101.xyz,l9_76.xyz).xyz,vec3(l9_74));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_105=vec4(mix(vec3(1.0),l9_76.xyz,vec3(l9_74)),l9_74);
}
#else
{
vec4 l9_106;
...
#endif
l9_106=vec4(l9_76.xyz*l9_107,l9_107);
}
#else
{
l9_106=l9_76;
