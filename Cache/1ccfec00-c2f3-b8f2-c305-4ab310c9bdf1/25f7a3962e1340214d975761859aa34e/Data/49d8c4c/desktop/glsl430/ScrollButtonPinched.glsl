...
vec4 l9_173;
if (l9_172<Port_Position1_N030)
{
l9_173=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_172/Port_Position1_N030,0.0,1.0)));
}
else
{
vec4 l9_174;
if (l9_172<Port_Position2_N030)
{
l9_174=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_172-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0)));
}
else
{
vec4 l9_175;
if (l9_172<Port_Position3_N030)
{
l9_175=mix(Port_Value2_N030,Port_Value3_N030,vec4(clamp((l9_172-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0)));
}
else
{
vec4 l9_176;
if (l9_172<Port_Position4_N030)
{
l9_176=mix(Port_Value3_N030,Port_Value4_N030,vec4(clamp((l9_172-Port_Position3_N030)/(Port_Position4_N030-Port_Position3_N030),0.0,1.0)));
}
else
{
l9_176=mix(Port_Value4_N030,Port_Value5_N030,vec4(clamp((l9_172-Port_Position4_N030)/(1.0-Port_Position4_N030),0.0,1.0)));
}
l9_175=l9_176;
}
l9_174=l9_175;
...
vec3 l9_177=-l9_4;
vec4 l9_178=mix(l9_173,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(l9_177,l9_11*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
vec4 l9_179=l9_116+l9_178;
float l9_180=l9_179.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_180<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_180<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_181,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_183;
...
{
l9_185=clamp(l9_180*2.0,0.0,1.0);
}
#else
{
float l9_186;
...
{
l9_186=clamp(dot(l9_179.xyz,vec3(l9_180)),0.0,1.0);
}
#else
{
float l9_187;
...
{
l9_188=(1.0-dot(l9_179.xyz,vec3(0.33333001)))*l9_180;
}
#else
{
float l9_189;
...
{
l9_189=(1.0-clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0))*l9_180;
}
#else
{
float l9_190;
...
{
l9_190=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0)*l9_180;
}
#else
{
float l9_191;
#if (sc_BlendMode_Add)
{
l9_191=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_192;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_192=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0)*l9_180;
}
#else
{
float l9_193;
...
{
l9_193=dot(l9_179.xyz,vec3(0.33333001))*l9_180;
}
#else
{
float l9_194;
#if (sc_BlendMode_Min)
{
l9_194=1.0-clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_195;
#if (sc_BlendMode_Max)
{
l9_195=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_195=1.0;
...
#endif
l9_183=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_179.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_184);
}
#else
{
vec4 l9_196;
...
{
l9_204=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_202,sc_ScreenTextureLayout,l9_203),0.0);
}
#else
{
l9_204=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_202,sc_ScreenTextureLayout,l9_203).xy,0.0);
}
#endif
l9_198=l9_204;
}
...
{
vec4 l9_206=l9_198;
l9_206.x=l9_198.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_205=l9_206;
}
#else
{
...
#endif
vec3 l9_207=mix(l9_205.xyz,definedBlend(l9_205.xyz,l9_179.xyz).xyz,vec3(l9_180));
vec4 l9_208=vec4(l9_207.x,l9_207.y,l9_207.z,vec4(0.0).w);
l9_208.w=1.0;
l9_197=l9_208;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_209=vec4(mix(vec3(1.0),l9_179.xyz,vec3(l9_180)),l9_180);
}
#else
{
vec4 l9_210;
...
#endif
l9_210=vec4(l9_179.xyz*l9_211,l9_211);
}
#else
{
l9_210=l9_179;
...
{
l9_214=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_214=vec4(0.0);
...
vec4 l9_216=outputMotionVectorsIfNeeded(varPos,max(l9_215,vec4(0.0)));
vec4 l9_217=clamp(l9_216,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_218=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_218-0.0039215689)),min(1.0,l9_218+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_219=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_219).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_220=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_219).xy);
float l9_221=packValue(l9_220);
int l9_228=int(l9_217.w*255.0);
float l9_229=packValue(l9_228);
sc_writeFragData0Internal(vec4(packValue(l9_220),packValue(l9_220),packValue(l9_220),packValue(l9_220)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_221,packValue(l9_220),packValue(l9_220),packValue(l9_220)));
sc_writeFragData2(vec4(l9_229,packValue(l9_228),packValue(l9_228),packValue(l9_228)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_232).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_237==0)
{
l9_240=texture(sc_OITAlpha0,l9_232);
l9_239=texture(sc_OITDepthLow0,l9_232);
l9_238=texture(sc_OITDepthHigh0,l9_232);
}
else
{
l9_240=vec4(0.0);
...
if (l9_237==1)
{
l9_243=texture(sc_OITAlpha1,l9_232);
l9_242=texture(sc_OITDepthLow1,l9_232);
l9_241=texture(sc_OITDepthHigh1,l9_232);
}
else
{
l9_243=l9_240;
...
if (any(notEqual(l9_241,vec4(0.0)))||any(notEqual(l9_242,vec4(0.0))))
{
int l9_244[8]=l9_233;
unpackValues(l9_241.w,l9_237,l9_244);
unpackValues(l9_241.z,l9_237,l9_244);
unpackValues(l9_241.y,l9_237,l9_244);
unpackValues(l9_241.x,l9_237,l9_244);
unpackValues(l9_242.w,l9_237,l9_244);
unpackValues(l9_242.z,l9_237,l9_244);
unpackValues(l9_242.y,l9_237,l9_244);
unpackValues(l9_242.x,l9_237,l9_244);
int l9_253[8]=l9_234;
unpackValues(l9_243.w,l9_237,l9_253);
unpackValues(l9_243.z,l9_237,l9_253);
unpackValues(l9_243.y,l9_237,l9_253);
unpackValues(l9_243.x,l9_237,l9_253);
}
l9_237++;
continue;
}
...
vec4 l9_258=texture(sc_OITFilteredDepthBoundsTexture,l9_232);
vec2 l9_259=l9_258.xy;
int l9_260;
#if (sc_SkinBonesCount>0)
{
l9_260=encodeDepth(((1.0-l9_258.x)*1000.0)+getDepthOrderingEpsilon(),l9_259);
}
#else
{
l9_260=0;
...
#endif
int l9_261=encodeDepth(viewSpaceDepth(),l9_259);
vec4 l9_262;
l9_262=l9_217*l9_217.w;
vec4 l9_263;
int l9_264=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_264<8)
{
int l9_265=l9_233[l9_264];
int l9_266=l9_261-l9_260;
bool l9_267=l9_265<l9_266;
bool l9_268;
if (l9_267)
{
l9_268=l9_233[l9_264]>0;
}
else
{
l9_268=l9_267;
...
if (l9_268)
{
vec3 l9_269=l9_262.xyz*(1.0-(float(l9_234[l9_264])/255.0));
l9_263=vec4(l9_269.x,l9_269.y,l9_269.z,l9_262.w);
}
else
{
l9_263=l9_262;
...
sc_writeFragData0Internal(l9_262,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
