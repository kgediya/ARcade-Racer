...
#endif
bool l9_6=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_7=l9_4.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_8=l9_7;
float l9_9=l9_4.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_6,l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_6,l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),additional_settings_btn_refl_texLayout,l9_5);
vec4 l9_28=texture2D(additional_settings_btn_refl_tex,l9_27.xy,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_29=mix(additional_settings_btn_refl_texBorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
#endif
float l9_30=length((vec4(normalize((sc_ModelMatrixInverse*l9_1).xyz).xy,0.0,0.0).xy*Port_Input1_N009)+Port_Input2_N009);
vec4 l9_31=mix(Port_Value_N026,Port_Value_N027,vec4(triggered));
vec4 l9_32=max(l9_31,Port_Input1_N019);
float l9_33=clamp(l9_30,0.0,1.0);
vec4 l9_34;
if (l9_33<Port_Position1_N007)
{
l9_34=mix(l9_31,l9_32,vec4(clamp(l9_33/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_35;
if (l9_33<Port_Position2_N007)
{
l9_35=mix(l9_32,Port_Value2_N007,vec4(clamp((l9_33-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_35=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_33-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_34=l9_35;
}
...
vec4 l9_41=l9_29+l9_34;
vec4 l9_42=baseColor*l9_34;
float l9_43=clamp((l9_30*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_44;
if (l9_43<=0.0)
{
l9_44=0.0;
...
{
l9_44=pow(l9_43,Port_Input1_N022);
}
float l9_45;
if (l9_44<=0.0)
{
...
{
l9_45=pow(l9_44,Port_Input1_N034);
}
float l9_46=l9_45*Port_Input1_N041;
vec2 l9_47=((varPackedTex.xy-Port_Center_N002)*iconScale)+Port_Center_N002;
int l9_48;
...
#endif
bool l9_49=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_50=l9_47.x;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_51=l9_50;
float l9_52=l9_47.y;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_53=l9_52;
vec2 l9_54;
float l9_55;
...
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_57=l9_51;
float l9_58=1.0;
sc_ClampUV(l9_57,iconUvMinMax.x,iconUvMinMax.z,l9_56,l9_58);
float l9_59=l9_57;
float l9_60=l9_58;
bool l9_61;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_62=l9_53;
float l9_63=l9_60;
sc_ClampUV(l9_62,iconUvMinMax.y,iconUvMinMax.w,l9_61,l9_63);
l9_55=l9_63;
l9_54=vec2(l9_59,l9_62);
}
#else
...
#endif
vec2 l9_64=sc_TransformUV(l9_54,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_65=l9_64.x;
float l9_66=l9_55;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_49,l9_66);
float l9_67=l9_64.y;
float l9_68=l9_66;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_49,l9_68);
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),iconLayout,l9_48);
vec4 l9_71=texture2D(icon,l9_70.xy,0.0);
vec4 l9_72;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_72=mix(iconBorderColor,l9_71,vec4(l9_69));
}
#else
{
l9_72=l9_71;
...
#endif
vec4 l9_73=mix(mix(mix(baseColor*(l9_41*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_42)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_46)),vec4(l9_72.xyz,0.0),vec4(l9_72.w));
float l9_74=max(l9_44,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_75=max(l9_72.w,l9_74)*alpha;
vec4 l9_76=vec4(l9_73.x,l9_73.y,l9_73.z,vec4(0.0).w);
l9_76.w=l9_75;
...
{
l9_80=clamp(dot(l9_76.xyz,vec3(l9_75)),0.0,1.0);
}
#else
{
float l9_81;
...
{
l9_82=(1.0-dot(l9_76.xyz,vec3(0.33333001)))*l9_75;
}
#else
{
float l9_83;
...
{
l9_83=(1.0-clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0))*l9_75;
}
#else
{
float l9_84;
...
{
l9_84=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0)*l9_75;
}
#else
{
float l9_85;
#if (sc_BlendMode_Add)
{
l9_85=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_86;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_86=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0)*l9_75;
}
#else
{
float l9_87;
...
{
l9_87=dot(l9_76.xyz,vec3(0.33333001))*l9_75;
}
#else
{
float l9_88;
#if (sc_BlendMode_Min)
{
l9_88=1.0-clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_89;
#if (sc_BlendMode_Max)
{
l9_89=clamp(dot(l9_76.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_89=1.0;
...
#endif
l9_77=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_76.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_78);
}
#else
{
vec4 l9_90;
...
#if (sc_FramebufferFetch)
{
vec4 l9_93=sc_readFragData0_Platform();
vec4 l9_94;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_95=l9_93;
l9_95.x=l9_93.x+_sc_framebufferFetchMarker;
l9_94=l9_95;
}
#else
{
...
#endif
l9_92=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_96,sc_ScreenTextureLayout,l9_97).xy,0.0);
}
#endif
vec4 l9_98;
...
{
vec4 l9_99=l9_92;
l9_99.x=l9_92.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_98=l9_99;
}
#else
{
...
#endif
vec3 l9_100=mix(l9_98.xyz,definedBlend(l9_98.xyz,l9_76.xyz).xyz,vec3(l9_75));
vec4 l9_101=vec4(l9_100.x,l9_100.y,l9_100.z,vec4(0.0).w);
l9_101.w=1.0;
l9_91=l9_101;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_102=vec4(mix(vec3(1.0),l9_76.xyz,vec3(l9_75)),l9_75);
}
#else
{
vec4 l9_103;
...
#endif
l9_103=vec4(l9_76.xyz*l9_104,l9_104);
}
#else
{
l9_103=l9_76;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_111-0.0039215689)),min(1.0,l9_111+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_112).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_113=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_112).xy);
float l9_114=packValue(l9_113);
int l9_121=int(l9_110.w*255.0);
float l9_122=packValue(l9_121);
sc_writeFragData0Internal(vec4(packValue(l9_113),packValue(l9_113),packValue(l9_113),packValue(l9_113)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_125).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_130==0)
{
l9_133=texture2D(sc_OITAlpha0,l9_125);
l9_132=texture2D(sc_OITDepthLow0,l9_125);
l9_131=texture2D(sc_OITDepthHigh0,l9_125);
}
else
{
l9_133=vec4(0.0);
...
if (l9_130==1)
{
l9_136=texture2D(sc_OITAlpha1,l9_125);
l9_135=texture2D(sc_OITDepthLow1,l9_125);
l9_134=texture2D(sc_OITDepthHigh1,l9_125);
}
else
{
l9_136=l9_133;
...
vec4 l9_151=texture2D(sc_OITFilteredDepthBoundsTexture,l9_125);
...
sc_writeFragData0Internal(l9_110,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
