...
{
bool l9_12=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_13=l9_10.x;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_14=l9_13;
float l9_15=l9_10.y;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_16=l9_15;
vec2 l9_17;
float l9_18;
...
{
l9_19=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
...
float l9_20=l9_14;
float l9_21=1.0;
sc_ClampUV(l9_20,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_19,l9_21);
float l9_22=l9_20;
float l9_23=l9_21;
bool l9_24;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_24=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_25=l9_16;
float l9_26=l9_23;
sc_ClampUV(l9_25,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_24,l9_26);
l9_18=l9_26;
...
#endif
vec2 l9_27=sc_TransformUV(l9_17,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_28=l9_27.x;
float l9_29=l9_18;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_12,l9_29);
float l9_30=l9_27.y;
float l9_31=l9_29;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_12,l9_31);
float l9_32=l9_31;
vec3 l9_33=sc_SamplingCoordsViewToGlobal(vec2(l9_28,l9_30),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_34=texture(additional_settings_btn_refl_texArrSC,l9_33,0.0);
vec4 l9_35;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_35=mix(additional_settings_btn_refl_texBorderColor,l9_34,vec4(l9_32));
}
#else
{
l9_35=l9_34;
...
#else
{
bool l9_36=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_37=l9_10.x;
...
float l9_52=l9_51.x;
float l9_53=l9_42;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_36,l9_53);
float l9_54=l9_51.y;
float l9_55=l9_53;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_36,l9_55);
float l9_56=l9_55;
...
vec4 l9_58=texture(additional_settings_btn_refl_tex,l9_57.xy,0.0);
vec4 l9_59;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
...
#endif
float l9_60=length((vec4(l9_3.xy,0.0,0.0).xy*Port_Input1_N009)+Port_Input2_N009);
vec4 l9_61=mix(Port_Value_N026,Port_Value_N027,vec4(triggered));
vec4 l9_62=max(l9_61,Port_Input1_N019);
float l9_63=clamp(l9_60,0.0,1.0);
vec4 l9_64;
if (l9_63<Port_Position1_N007)
{
l9_64=mix(l9_61,l9_62,vec4(clamp(l9_63/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_65;
if (l9_63<Port_Position2_N007)
{
l9_65=mix(l9_62,Port_Value2_N007,vec4(clamp((l9_63-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_65=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_63-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_64=l9_65;
}
bool l9_66=PreviewEnabled==1;
bool l9_67;
if (l9_66)
{
l9_67=!l9_0;
...
vec4 l9_71=l9_11+l9_64;
vec4 l9_72=baseColor*l9_64;
float l9_73=clamp((l9_60*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_74;
if (l9_73<=0.0)
{
l9_74=0.0;
...
{
l9_74=pow(l9_73,Port_Input1_N022);
}
float l9_75;
if (l9_74<=0.0)
{
...
{
l9_75=pow(l9_74,Port_Input1_N034);
}
float l9_76=l9_75*Port_Input1_N041;
vec2 l9_77=l9_2-Port_Center_N002;
vec2 l9_78=(l9_77*iconScale)+Port_Center_N002;
vec4 l9_79;
#if (iconLayout==2)
{
bool l9_80=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_81=l9_78.x;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_82=l9_81;
float l9_83=l9_78.y;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_84=l9_83;
vec2 l9_85;
float l9_86;
...
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_88=l9_82;
float l9_89=1.0;
sc_ClampUV(l9_88,iconUvMinMax.x,iconUvMinMax.z,l9_87,l9_89);
float l9_90=l9_88;
float l9_91=l9_89;
bool l9_92;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_93=l9_84;
float l9_94=l9_91;
sc_ClampUV(l9_93,iconUvMinMax.y,iconUvMinMax.w,l9_92,l9_94);
l9_86=l9_94;
...
#endif
vec2 l9_95=sc_TransformUV(l9_85,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_96=l9_95.x;
float l9_97=l9_86;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_80,l9_97);
float l9_98=l9_95.y;
float l9_99=l9_97;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_80,l9_99);
float l9_100=l9_99;
vec3 l9_101=sc_SamplingCoordsViewToGlobal(vec2(l9_96,l9_98),iconLayout,iconGetStereoViewIndex());
vec4 l9_102=texture(iconArrSC,l9_101,0.0);
vec4 l9_103;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_103=mix(iconBorderColor,l9_102,vec4(l9_100));
}
#else
{
l9_103=l9_102;
...
#else
{
bool l9_104=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_105=l9_78.x;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_106=l9_105;
float l9_107=l9_78.y;
sc_SoftwareWrapEarly(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_108=l9_107;
vec2 l9_109;
float l9_110;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_111=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_112=l9_106;
float l9_113=1.0;
sc_ClampUV(l9_112,iconUvMinMax.x,iconUvMinMax.z,l9_111,l9_113);
float l9_114=l9_112;
float l9_115=l9_113;
bool l9_116;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_116=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_117=l9_108;
float l9_118=l9_115;
sc_ClampUV(l9_117,iconUvMinMax.y,iconUvMinMax.w,l9_116,l9_118);
l9_110=l9_118;
...
#endif
vec2 l9_119=sc_TransformUV(l9_109,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_120=l9_119.x;
float l9_121=l9_110;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_104,l9_121);
float l9_122=l9_119.y;
float l9_123=l9_121;
sc_SoftwareWrapLate(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_104,l9_123);
float l9_124=l9_123;
vec3 l9_125=sc_SamplingCoordsViewToGlobal(vec2(l9_120,l9_122),iconLayout,iconGetStereoViewIndex());
vec4 l9_126=texture(icon,l9_125.xy,0.0);
vec4 l9_127;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_127=mix(iconBorderColor,l9_126,vec4(l9_124));
}
#else
{
l9_127=l9_126;
...
#endif
vec4 l9_128=mix(mix(mix(baseColor*(l9_71*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_72)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_76)),vec4(l9_79.xyz,0.0),vec4(l9_79.w));
float l9_129=max(l9_74,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_130=max(l9_79.w,l9_129)*alpha;
vec4 l9_131=vec4(l9_128.x,l9_128.y,l9_128.z,vec4(0.0).w);
l9_131.w=l9_130;
