...
#endif
vec4 param_3;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_3,l9_5);
vec4 l9_8=param_3;
vec4 param_8;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_8,l9_5);
vec4 l9_9=param_8;
float l9_10;
...
#endif
vec4 param_3;
Node70_Conditional(1.0,vec4(1.0),vec4(0.0),param_3,l9_17);
vec4 l9_21=param_3;
vec4 param_8;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_8,l9_17);
vec4 l9_22=param_8;
float l9_23;
#if (ENABLE_OPACITY_TEX)
{
...
float l9_208;
if ((float(l9_5.x<Level)*1.0)!=0.0)
{
l9_208=innerColorMultiplier;
}
else
{
l9_208=outerColorMultiplier;
}
vec4 l9_209=l9_207*vec4(l9_208+1.0);
float l9_210=l9_207.w;
vec4 l9_211=vec4(l9_209.x,l9_209.y,l9_209.z,vec4(0.0).w);
l9_211.w=l9_210;
if (isProxyMode)
{
vec4 l9_212;
...
#endif
sc_writeFragData0Internal(max(l9_212,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_214;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_216=clamp(l9_210*2.0,0.0,1.0);
}
#else
{
float l9_217;
...
{
l9_217=clamp(dot(l9_211.xyz,vec3(l9_210)),0.0,1.0);
}
#else
{
float l9_218;
...
#if (sc_BlendMode_Multiply)
{
l9_219=(1.0-dot(l9_211.xyz,vec3(0.33333001)))*l9_210;
}
#else
{
float l9_220;
...
{
l9_220=(1.0-clamp(dot(l9_211.xyz,vec3(1.0)),0.0,1.0))*l9_210;
}
#else
{
float l9_221;
#if (sc_BlendMode_ColoredGlass)
{
l9_221=clamp(dot(l9_211.xyz,vec3(1.0)),0.0,1.0)*l9_210;
}
#else
{
float l9_222;
#if (sc_BlendMode_Add)
{
l9_222=clamp(dot(l9_211.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_223;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_223=clamp(dot(l9_211.xyz,vec3(1.0)),0.0,1.0)*l9_210;
}
#else
{
float l9_224;
...
{
l9_224=dot(l9_211.xyz,vec3(0.33333001))*l9_210;
}
#else
{
float l9_225;
#if (sc_BlendMode_Min)
{
l9_225=1.0-clamp(dot(l9_211.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_226;
#if (sc_BlendMode_Max)
{
l9_226=clamp(dot(l9_211.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_226=1.0;
...
#endif
l9_214=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_211.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_215);
}
#else
{
vec4 l9_227;
...
{
vec3 l9_229=sc_GetFramebufferColor().xyz;
vec3 l9_230=mix(l9_229,definedBlend(l9_229,l9_211.xyz).xyz,vec3(l9_210));
vec4 l9_231=vec4(l9_230.x,l9_230.y,l9_230.z,vec4(0.0).w);
l9_231.w=1.0;
l9_228=l9_231;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_232=vec4(mix(vec3(1.0),l9_211.xyz,vec3(l9_210)),l9_210);
}
#else
{
vec4 l9_233;
...
#endif
l9_233=vec4(l9_211.xyz*l9_234,l9_234);
}
#else
{
l9_233=l9_211;
...
{
l9_237=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_237=vec4(0.0);
...
vec4 l9_239=outputMotionVectorsIfNeeded(varPos,max(l9_238,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_241-0.0039215689)),min(1.0,l9_241+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_243),packValue(l9_243),packValue(l9_243),packValue(l9_243)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_244,packValue(l9_243),packValue(l9_243),packValue(l9_243)));
sc_writeFragData2(vec4(l9_252,packValue(l9_251),packValue(l9_251),packValue(l9_251)));
...
sc_writeFragData0Internal(l9_285,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_240,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
