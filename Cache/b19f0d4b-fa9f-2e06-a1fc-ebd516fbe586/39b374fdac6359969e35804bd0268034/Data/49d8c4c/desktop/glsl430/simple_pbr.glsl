...
//sampler sampler baseTexSmpSC 0:25
...
//texture texture2D baseTex 0:3:0:25
...
//texture texture2DArray baseTexArrSC 0:40:0:25
...
//spec_const bool sc_RayTracedAoTextureHasSwappedViews 76 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 77 0
//spec_const bool sc_RayTracedReflectionTextureHasSwappedViews 78 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 79 0
...
//spec_const int sc_RayTracedAoTextureLayout 111 0
//spec_const int sc_RayTracedDiffIndTextureLayout 112 0
//spec_const int sc_RayTracedReflectionTextureLayout 113 0
//spec_const int sc_RayTracedShadowTextureLayout 114 0
//spec_const int sc_RenderingSpace 115 -1
//spec_const int sc_ScreenTextureLayout 116 0
//spec_const int sc_ShaderCacheConstant 117 0
//spec_const int sc_SkinBonesCount 118 0
//spec_const int sc_StereoRenderingMode 119 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 120 0
//spec_const int sc_StereoViewID 121 0
//SG_REFLECTION_END
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_50)>=(-0.050000001))
{
uvec3 l9_52=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_52.x,l9_52.y,l9_52.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_53=abs(l9_50);
vec3 l9_54=l9_50/vec3(dot(l9_53,vec3(1.0)));
float l9_55=clamp(-l9_54.z,0.0,1.0);
float l9_56=l9_54.x;
float l9_57;
if (l9_56>=0.0)
{
...
uvec2 l9_61=uvec2(packHalf2x16(vec2(l9_58,0.0)),packHalf2x16(vec2(l9_59+l9_60,0.0)));
normal_and_more=uvec4(l9_61.x,l9_61.y,normal_and_more.z,normal_and_more.w);
...
{
l9_62=uint(clamp(roughness,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_62|uint((receiverId%32)<<int(10u));
}
else
{
...
#endif
float l9_56=clamp(l9_54.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_57=max(l9_54.xyz,vec3(0.0));
vec4 l9_58;
#if (sc_ProjectiveShadowsCaster)
{
l9_58=vec4(l9_57,l9_56);
}
#else
{
l9_58=ngsCalculateLighting(l9_57,l9_56,l9_55,l9_2,l9_3,Port_Emissive_N006,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N006,Port_SpecularAO_N006);
}
#endif
vec4 l9_59=max(l9_58,vec4(0.0));
if (isProxyMode)
{
vec4 l9_60;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_60,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_62;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_64=clamp(l9_59.w*2.0,0.0,1.0);
}
#else
{
float l9_65;
...
{
l9_65=clamp(dot(l9_59.xyz,vec3(l9_59.w)),0.0,1.0);
}
#else
{
float l9_66;
...
#if (sc_BlendMode_Multiply)
{
l9_67=(1.0-dot(l9_59.xyz,vec3(0.33333001)))*l9_59.w;
}
#else
{
float l9_68;
...
{
l9_68=(1.0-clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0))*l9_59.w;
}
#else
{
float l9_69;
#if (sc_BlendMode_ColoredGlass)
{
l9_69=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0)*l9_59.w;
}
#else
{
float l9_70;
#if (sc_BlendMode_Add)
{
l9_70=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_71;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_71=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0)*l9_59.w;
}
#else
{
float l9_72;
...
{
l9_72=dot(l9_59.xyz,vec3(0.33333001))*l9_59.w;
}
#else
{
float l9_73;
#if (sc_BlendMode_Min)
{
l9_73=1.0-clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_74;
#if (sc_BlendMode_Max)
{
l9_74=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_74=1.0;
...
#endif
l9_62=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_59.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_63);
}
#else
{
vec4 l9_75;
...
{
vec3 l9_77=sc_GetFramebufferColor().xyz;
vec3 l9_78=mix(l9_77,definedBlend(l9_77,l9_59.xyz).xyz,vec3(l9_59.w));
...
{
float l9_81=l9_59.w;
l9_80=vec4(mix(vec3(1.0),l9_59.xyz,vec3(l9_81)),l9_81);
}
#else
{
vec4 l9_82;
...
#endif
l9_82=vec4(l9_59.xyz*l9_84,l9_84);
}
#else
{
l9_82=l9_59;
