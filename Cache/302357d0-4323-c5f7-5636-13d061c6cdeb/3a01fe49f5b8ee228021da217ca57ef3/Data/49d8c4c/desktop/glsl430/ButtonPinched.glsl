...
{
bool l9_18=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_19=l9_16.x;
...
float l9_34=l9_33.x;
float l9_35=l9_24;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_18,l9_35);
float l9_36=l9_33.y;
float l9_37=l9_35;
sc_SoftwareWrapLate(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_18,l9_37);
float l9_38=l9_37;
...
#else
{
bool l9_42=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_43=l9_16.x;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_44=l9_43;
float l9_45=l9_16.y;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_46=l9_45;
vec2 l9_47;
float l9_48;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_50=l9_44;
float l9_51=1.0;
sc_ClampUV(l9_50,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_49,l9_51);
float l9_52=l9_50;
float l9_53=l9_51;
bool l9_54;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_54=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_54=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_55=l9_46;
float l9_56=l9_53;
sc_ClampUV(l9_55,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_54,l9_56);
l9_48=l9_56;
...
#endif
vec2 l9_57=sc_TransformUV(l9_47,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_42,l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_42,l9_61);
float l9_62=l9_61;
vec3 l9_63=sc_SamplingCoordsViewToGlobal(vec2(l9_58,l9_60),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_64=texture(additional_settings_btn_refl_tex,l9_63.xy,0.0);
vec4 l9_65;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_65=mix(additional_settings_btn_refl_texBorderColor,l9_64,vec4(l9_62));
}
#else
{
l9_65=l9_64;
...
#endif
vec4 l9_66=vec4(Port_Import_N062)*l9_17;
vec2 l9_67=l9_3*Port_Input1_N009;
float l9_68=clamp(length(l9_67+Port_Input2_N009),0.0,1.0);
vec4 l9_69;
if (l9_68<Port_Position1_N014)
{
l9_69=mix(Port_Value0_N014,Port_Value1_N014,vec4(clamp(l9_68/Port_Position1_N014,0.0,1.0)));
}
else
{
vec4 l9_70;
if (l9_68<Port_Position2_N014)
{
l9_70=mix(Port_Value1_N014,Port_Value2_N014,vec4(clamp((l9_68-Port_Position1_N014)/(Port_Position2_N014-Port_Position1_N014),0.0,1.0)));
}
else
{
l9_70=mix(Port_Value2_N014,Port_Value3_N014,vec4(clamp((l9_68-Port_Position2_N014)/(1.0-Port_Position2_N014),0.0,1.0)));
}
l9_69=l9_70;
}
vec4 l9_71=l9_66+l9_69;
vec2 l9_72=l9_4-Port_Center_N002;
vec2 l9_73=(l9_72*Port_Scale_N002)+Port_Center_N002;
vec4 l9_74;
#if (iconLayout==2)
{
bool l9_75=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_76=l9_73.x;
sc_SoftwareWrapEarly(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_77=l9_76;
float l9_78=l9_73.y;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_79=l9_78;
vec2 l9_80;
float l9_81;
...
{
l9_82=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_82=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_83=l9_77;
float l9_84=1.0;
sc_ClampUV(l9_83,iconUvMinMax.x,iconUvMinMax.z,l9_82,l9_84);
float l9_85=l9_83;
float l9_86=l9_84;
bool l9_87;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_87=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_88=l9_79;
float l9_89=l9_86;
sc_ClampUV(l9_88,iconUvMinMax.y,iconUvMinMax.w,l9_87,l9_89);
l9_81=l9_89;
...
#endif
vec2 l9_90=sc_TransformUV(l9_80,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_91=l9_90.x;
float l9_92=l9_81;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_75,l9_92);
float l9_93=l9_90.y;
float l9_94=l9_92;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_75,l9_94);
float l9_95=l9_94;
vec3 l9_96=sc_SamplingCoordsViewToGlobal(vec2(l9_91,l9_93),iconLayout,iconGetStereoViewIndex());
vec4 l9_97=texture(iconArrSC,l9_96,0.0);
vec4 l9_98;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_98=mix(iconBorderColor,l9_97,vec4(l9_95));
}
#else
{
l9_98=l9_97;
...
#else
{
bool l9_99=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_100=l9_73.x;
sc_SoftwareWrapEarly(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_101=l9_100;
float l9_102=l9_73.y;
sc_SoftwareWrapEarly(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_103=l9_102;
vec2 l9_104;
float l9_105;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_106=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_106=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_107=l9_101;
float l9_108=1.0;
sc_ClampUV(l9_107,iconUvMinMax.x,iconUvMinMax.z,l9_106,l9_108);
float l9_109=l9_107;
float l9_110=l9_108;
bool l9_111;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_111=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_111=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_112=l9_103;
float l9_113=l9_110;
sc_ClampUV(l9_112,iconUvMinMax.y,iconUvMinMax.w,l9_111,l9_113);
l9_105=l9_113;
...
#endif
vec2 l9_114=sc_TransformUV(l9_104,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_115=l9_114.x;
float l9_116=l9_105;
sc_SoftwareWrapLate(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_99,l9_116);
float l9_117=l9_114.y;
float l9_118=l9_116;
sc_SoftwareWrapLate(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_99,l9_118);
float l9_119=l9_118;
vec3 l9_120=sc_SamplingCoordsViewToGlobal(vec2(l9_115,l9_117),iconLayout,iconGetStereoViewIndex());
vec4 l9_121=texture(icon,l9_120.xy,0.0);
vec4 l9_122;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_122=mix(iconBorderColor,l9_121,vec4(l9_119));
}
#else
{
l9_122=l9_121;
...
#if (iconLayout==2)
{
bool l9_125=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_126=l9_73.x;
sc_SoftwareWrapEarly(l9_126,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_127=l9_126;
float l9_128=l9_73.y;
sc_SoftwareWrapEarly(l9_128,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_129=l9_128;
vec2 l9_130;
float l9_131;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_132=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_132=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_133=l9_127;
float l9_134=1.0;
sc_ClampUV(l9_133,iconUvMinMax.x,iconUvMinMax.z,l9_132,l9_134);
float l9_135=l9_133;
float l9_136=l9_134;
bool l9_137;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_137=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_137=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_138=l9_129;
float l9_139=l9_136;
sc_ClampUV(l9_138,iconUvMinMax.y,iconUvMinMax.w,l9_137,l9_139);
l9_131=l9_139;
...
#endif
vec2 l9_140=sc_TransformUV(l9_130,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_141=l9_140.x;
float l9_142=l9_131;
sc_SoftwareWrapLate(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_125,l9_142);
float l9_143=l9_140.y;
float l9_144=l9_142;
sc_SoftwareWrapLate(l9_143,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_125,l9_144);
float l9_145=l9_144;
vec3 l9_146=sc_SamplingCoordsViewToGlobal(vec2(l9_141,l9_143),iconLayout,iconGetStereoViewIndex());
vec4 l9_147=texture(iconArrSC,l9_146,0.0);
vec4 l9_148;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_148=mix(iconBorderColor,l9_147,vec4(l9_145));
}
#else
{
l9_148=l9_147;
...
#else
{
bool l9_149=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_150=l9_73.x;
sc_SoftwareWrapEarly(l9_150,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_151=l9_150;
float l9_152=l9_73.y;
sc_SoftwareWrapEarly(l9_152,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_153=l9_152;
vec2 l9_154;
float l9_155;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_156=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_156=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_157=l9_151;
float l9_158=1.0;
sc_ClampUV(l9_157,iconUvMinMax.x,iconUvMinMax.z,l9_156,l9_158);
float l9_159=l9_157;
float l9_160=l9_158;
bool l9_161;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_161=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_161=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_162=l9_153;
float l9_163=l9_160;
sc_ClampUV(l9_162,iconUvMinMax.y,iconUvMinMax.w,l9_161,l9_163);
l9_155=l9_163;
...
#endif
vec2 l9_164=sc_TransformUV(l9_154,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_165=l9_164.x;
float l9_166=l9_155;
sc_SoftwareWrapLate(l9_165,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_149,l9_166);
float l9_167=l9_164.y;
float l9_168=l9_166;
sc_SoftwareWrapLate(l9_167,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_149,l9_168);
float l9_169=l9_168;
vec3 l9_170=sc_SamplingCoordsViewToGlobal(vec2(l9_165,l9_167),iconLayout,iconGetStereoViewIndex());
vec4 l9_171=texture(icon,l9_170.xy,0.0);
vec4 l9_172;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_172=mix(iconBorderColor,l9_171,vec4(l9_169));
}
#else
{
l9_172=l9_171;
...
{
l9_123=Port_Input2_N003;
}
vec4 l9_173=vec4(l9_123);
vec4 l9_174=mix(l9_71,l9_74,l9_173);
float l9_175=l9_174.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_175<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_175<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_176,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_178;
...
{
l9_180=clamp(l9_175*2.0,0.0,1.0);
}
#else
{
float l9_181;
...
{
l9_181=clamp(dot(l9_174.xyz,vec3(l9_175)),0.0,1.0);
}
#else
{
float l9_182;
...
{
l9_183=(1.0-dot(l9_174.xyz,vec3(0.33333001)))*l9_175;
}
#else
{
float l9_184;
...
{
l9_184=(1.0-clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0))*l9_175;
}
#else
{
float l9_185;
...
{
l9_185=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0)*l9_175;
}
#else
{
float l9_186;
#if (sc_BlendMode_Add)
{
l9_186=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_187;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_187=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0)*l9_175;
}
#else
{
float l9_188;
...
{
l9_188=dot(l9_174.xyz,vec3(0.33333001))*l9_175;
}
#else
{
float l9_189;
#if (sc_BlendMode_Min)
{
l9_189=1.0-clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_190;
#if (sc_BlendMode_Max)
{
l9_190=clamp(dot(l9_174.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_190=1.0;
...
#endif
l9_178=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_174.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_179);
}
#else
{
vec4 l9_191;
...
#if (sc_FramebufferFetch)
{
vec4 l9_194=sc_readFragData0_Platform();
vec4 l9_195;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_196=l9_194;
l9_196.x=l9_194.x+_sc_framebufferFetchMarker;
l9_195=l9_196;
}
#else
{
...
#else
{
vec2 l9_197=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_198;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_198=1-sc_GetStereoViewIndex();
}
#else
{
l9_198=sc_GetStereoViewIndex();
}
#endif
vec4 l9_199;
#if (sc_ScreenTextureLayout==2)
{
l9_199=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_197,sc_ScreenTextureLayout,l9_198),0.0);
}
#else
{
l9_199=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_197,sc_ScreenTextureLayout,l9_198).xy,0.0);
}
#endif
l9_193=l9_199;
}
...
{
vec4 l9_201=l9_193;
l9_201.x=l9_193.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_200=l9_201;
}
#else
{
...
#endif
vec3 l9_202=mix(l9_200.xyz,definedBlend(l9_200.xyz,l9_174.xyz).xyz,vec3(l9_175));
vec4 l9_203=vec4(l9_202.x,l9_202.y,l9_202.z,vec4(0.0).w);
l9_203.w=1.0;
l9_192=l9_203;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_204=vec4(mix(vec3(1.0),l9_174.xyz,vec3(l9_175)),l9_175);
}
#else
{
vec4 l9_205;
...
#endif
l9_205=vec4(l9_174.xyz*l9_206,l9_206);
}
#else
{
l9_205=l9_174;
