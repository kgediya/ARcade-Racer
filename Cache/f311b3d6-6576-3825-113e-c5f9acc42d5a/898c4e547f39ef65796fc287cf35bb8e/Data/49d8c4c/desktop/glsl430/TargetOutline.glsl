...
ssGlobals l9_32=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_28,l9_29,normalize((sc_ModelMatrixInverse*vec4(l9_29,0.0)).xyz),l9_31);
vec3 param_3;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_3,l9_32);
vec3 l9_33=param_3;
...
vec3 l9_36=l9_33*l9_35;
float l9_37;
if ((float(float(sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID))>Port_Input1_N013)*1.0)!=0.0)
{
l9_37=abs(lineWeight)*Port_Input1_N017;
}
else
{
l9_37=abs(lineWeight);
}
vec3 l9_38=vec3(l9_37);
vec3 param_8;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_8,l9_32);
vec3 l9_39=param_8;
vec3 l9_40;
vec3 l9_41;
vec3 l9_42;
...
l9_42=varTangent.xyz;
l9_41=l9_39;
l9_40=(sc_ModelMatrix*vec4(l9_28+(l9_36*l9_38),1.0)).xyz;
}
varPos=l9_40;
...
#if (sc_RenderingSpace==3)
{
l9_44=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_45;
#if (sc_RenderingSpace==2)
{
l9_45=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_46;
#if (sc_RenderingSpace==1)
{
l9_46=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
l9_46=l9_15;
...
#if (sc_RenderingSpace==4)
{
l9_48=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_49;
...
#endif
gl_Position=l9_58;
Interpolator_gInstanceID=l9_31;
}
...
vec4 l9_1;
if ((float(round(Interpolator_gInstanceID)>Port_Input1_N013)*1.0)!=0.0)
{
