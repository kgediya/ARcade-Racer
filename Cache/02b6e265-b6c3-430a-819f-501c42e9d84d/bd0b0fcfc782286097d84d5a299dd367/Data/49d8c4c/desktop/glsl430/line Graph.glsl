...
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 124 0
...
//spec_const bool sc_ShaderComplexityAnalyzer 128 0
//spec_const bool sc_TAAEnabled 129 0
//spec_const bool sc_UseFramebufferFetchMarker 130 0
//spec_const bool sc_VertexBlending 131 0
//spec_const bool sc_VertexBlendingUseNormals 132 0
//spec_const bool uv2EnableAnimation 133 0
//spec_const bool uv3EnableAnimation 134 0
...
//spec_const int sc_RayTracedAoTextureLayout 193 0
//spec_const int sc_RayTracedDiffIndTextureLayout 194 0
//spec_const int sc_RayTracedShadowTextureLayout 195 0
//spec_const int sc_RenderingSpace 196 -1
//spec_const int sc_ScreenTextureLayout 197 0
//spec_const int sc_ShaderCacheConstant 198 0
//spec_const int sc_SkinBonesCount 199 0
//spec_const int sc_StereoRenderingMode 200 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 201 0
//spec_const int sc_StereoViewID 202 0
//SG_REFLECTION_END
...
#endif
float l9_477=clamp(l9_109,0.0,1.0);
...
{
l9_535=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_535=vec4(0.0);
...
vec4 l9_537=outputMotionVectorsIfNeeded(varPos,max(l9_536,vec4(0.0)));
vec4 l9_538=clamp(l9_537,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_539=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_539-0.0039215689)),min(1.0,l9_539+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_541=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_540).xy);
float l9_542=packValue(l9_541);
int l9_549=int(l9_538.w*255.0);
float l9_550=packValue(l9_549);
sc_writeFragData0Internal(vec4(packValue(l9_541),packValue(l9_541),packValue(l9_541),packValue(l9_541)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_542,packValue(l9_541),packValue(l9_541),packValue(l9_541)));
sc_writeFragData2(vec4(l9_550,packValue(l9_549),packValue(l9_549),packValue(l9_549)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_553=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_553).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_558==0)
{
l9_561=texture(sc_OITAlpha0,l9_553);
l9_560=texture(sc_OITDepthLow0,l9_553);
l9_559=texture(sc_OITDepthHigh0,l9_553);
}
else
{
l9_561=vec4(0.0);
...
if (l9_558==1)
{
l9_564=texture(sc_OITAlpha1,l9_553);
l9_563=texture(sc_OITDepthLow1,l9_553);
l9_562=texture(sc_OITDepthHigh1,l9_553);
}
else
{
l9_564=l9_561;
...
if (any(notEqual(l9_562,vec4(0.0)))||any(notEqual(l9_563,vec4(0.0))))
{
int l9_565[8]=l9_554;
unpackValues(l9_562.w,l9_558,l9_565);
unpackValues(l9_562.z,l9_558,l9_565);
unpackValues(l9_562.y,l9_558,l9_565);
unpackValues(l9_562.x,l9_558,l9_565);
unpackValues(l9_563.w,l9_558,l9_565);
unpackValues(l9_563.z,l9_558,l9_565);
unpackValues(l9_563.y,l9_558,l9_565);
unpackValues(l9_563.x,l9_558,l9_565);
int l9_574[8]=l9_555;
unpackValues(l9_564.w,l9_558,l9_574);
unpackValues(l9_564.z,l9_558,l9_574);
unpackValues(l9_564.y,l9_558,l9_574);
unpackValues(l9_564.x,l9_558,l9_574);
}
l9_558++;
continue;
}
...
vec4 l9_579=texture(sc_OITFilteredDepthBoundsTexture,l9_553);
vec2 l9_580=l9_579.xy;
int l9_581;
#if (sc_SkinBonesCount>0)
{
l9_581=encodeDepth(((1.0-l9_579.x)*1000.0)+getDepthOrderingEpsilon(),l9_580);
}
#else
{
l9_581=0;
...
#endif
int l9_582=encodeDepth(viewSpaceDepth(),l9_580);
vec4 l9_583;
l9_583=l9_538*l9_538.w;
vec4 l9_584;
int l9_585=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_585<8)
{
int l9_586=l9_554[l9_585];
int l9_587=l9_582-l9_581;
bool l9_588=l9_586<l9_587;
bool l9_589;
if (l9_588)
{
l9_589=l9_554[l9_585]>0;
}
else
{
l9_589=l9_588;
...
if (l9_589)
{
vec3 l9_590=l9_583.xyz*(1.0-(float(l9_555[l9_585])/255.0));
l9_584=vec4(l9_590.x,l9_590.y,l9_590.z,l9_583.w);
}
else
{
l9_584=l9_583;
...
sc_writeFragData0Internal(l9_583,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_538,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_537,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
