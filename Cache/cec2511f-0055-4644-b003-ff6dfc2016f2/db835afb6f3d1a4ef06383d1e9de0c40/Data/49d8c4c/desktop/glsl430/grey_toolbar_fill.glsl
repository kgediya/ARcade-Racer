...
#if (sc_FramebufferFetch)
{
vec4 l9_123=sc_readFragData0_Platform();
vec4 l9_124;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_125=l9_123;
l9_125.x=l9_123.x+_sc_framebufferFetchMarker;
l9_124=l9_125;
}
#else
{
...
{
l9_128=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_126,sc_ScreenTextureLayout,l9_127),0.0);
}
#else
{
l9_128=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_126,sc_ScreenTextureLayout,l9_127).xy,0.0);
}
#endif
l9_122=l9_128;
}
...
{
vec4 l9_130=l9_122;
l9_130.x=l9_122.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_129=l9_130;
}
#else
{
...
#endif
vec3 l9_131=mix(l9_129.xyz,definedBlend(l9_129.xyz,l9_103.xyz).xyz,vec3(l9_104));
vec4 l9_132=vec4(l9_131.x,l9_131.y,l9_131.z,vec4(0.0).w);
l9_132.w=1.0;
l9_121=l9_132;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_133=vec4(mix(vec3(1.0),l9_103.xyz,vec3(l9_104)),l9_104);
}
#else
{
vec4 l9_134;
...
#endif
l9_134=vec4(l9_103.xyz*l9_135,l9_135);
}
#else
{
l9_134=l9_103;
...
{
l9_138=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_138=vec4(0.0);
...
vec4 l9_140=outputMotionVectorsIfNeeded(varPos,max(l9_139,vec4(0.0)));
vec4 l9_141=clamp(l9_140,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_142=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_142-0.0039215689)),min(1.0,l9_142+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_143).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_144=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_143).xy);
float l9_145=packValue(l9_144);
int l9_152=int(l9_141.w*255.0);
float l9_153=packValue(l9_152);
sc_writeFragData0Internal(vec4(packValue(l9_144),packValue(l9_144),packValue(l9_144),packValue(l9_144)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_145,packValue(l9_144),packValue(l9_144),packValue(l9_144)));
sc_writeFragData2(vec4(l9_153,packValue(l9_152),packValue(l9_152),packValue(l9_152)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_156).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_161==0)
{
l9_164=texture(sc_OITAlpha0,l9_156);
l9_163=texture(sc_OITDepthLow0,l9_156);
l9_162=texture(sc_OITDepthHigh0,l9_156);
}
else
{
l9_164=vec4(0.0);
...
if (l9_161==1)
{
l9_167=texture(sc_OITAlpha1,l9_156);
l9_166=texture(sc_OITDepthLow1,l9_156);
l9_165=texture(sc_OITDepthHigh1,l9_156);
}
else
{
l9_167=l9_164;
...
if (any(notEqual(l9_165,vec4(0.0)))||any(notEqual(l9_166,vec4(0.0))))
{
int l9_168[8]=l9_157;
unpackValues(l9_165.w,l9_161,l9_168);
unpackValues(l9_165.z,l9_161,l9_168);
unpackValues(l9_165.y,l9_161,l9_168);
unpackValues(l9_165.x,l9_161,l9_168);
unpackValues(l9_166.w,l9_161,l9_168);
unpackValues(l9_166.z,l9_161,l9_168);
unpackValues(l9_166.y,l9_161,l9_168);
unpackValues(l9_166.x,l9_161,l9_168);
int l9_177[8]=l9_158;
unpackValues(l9_167.w,l9_161,l9_177);
unpackValues(l9_167.z,l9_161,l9_177);
unpackValues(l9_167.y,l9_161,l9_177);
unpackValues(l9_167.x,l9_161,l9_177);
}
l9_161++;
continue;
}
...
vec4 l9_182=texture(sc_OITFilteredDepthBoundsTexture,l9_156);
vec2 l9_183=l9_182.xy;
int l9_184;
#if (sc_SkinBonesCount>0)
{
l9_184=encodeDepth(((1.0-l9_182.x)*1000.0)+getDepthOrderingEpsilon(),l9_183);
}
#else
{
l9_184=0;
...
#endif
int l9_185=encodeDepth(viewSpaceDepth(),l9_183);
vec4 l9_186;
l9_186=l9_141*l9_141.w;
vec4 l9_187;
int l9_188=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_188<8)
{
int l9_189=l9_157[l9_188];
int l9_190=l9_185-l9_184;
bool l9_191=l9_189<l9_190;
bool l9_192;
if (l9_191)
{
l9_192=l9_157[l9_188]>0;
}
else
{
l9_192=l9_191;
...
if (l9_192)
{
vec3 l9_193=l9_186.xyz*(1.0-(float(l9_158[l9_188])/255.0));
l9_187=vec4(l9_193.x,l9_193.y,l9_193.z,l9_186.w);
}
else
{
l9_187=l9_186;
...
sc_writeFragData0Internal(l9_186,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
