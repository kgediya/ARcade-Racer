...
//sampler sampler matcapTextureSmpSC 0:17
...
//texture texture2D matcapTexture 0:1:0:17
...
//texture texture2DArray matcapTextureArrSC 0:26:0:17
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_matcapTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_matcapTexture 81 -1
//spec_const int intensityTextureLayout 82 0
//spec_const int matcapTextureLayout 83 0
...
float l9_30=scaleFactor+1.234e-06;
vec3 l9_31;
vec3 l9_32;
vec3 l9_33;
if (l9_25)
...
l9_33=varTangent.xyz;
l9_32=l9_29;
l9_31=(sc_ModelMatrix*vec4((((scaleX*(varColor.x-Port_Input1_N021))*Port_Input2_N014)/l9_30)+l9_28.x,(((scaleY*((varColor.y-Port_Input1_N018)*Port_Input1_N002))*Port_Input2_N019)/l9_30)+l9_28.y,l9_28.z+(((scaleZ*(varColor.z-Port_Input1_N008))*Port_Input2_N023)/l9_30),1.0)).xyz;
}
varPos=l9_31;
...
float l9_18=(((l9_17-Port_RangeMinA_N112)/((Port_RangeMaxA_N112-Port_RangeMinA_N112)+1e-06))*(Port_RangeMaxB_N112-Port_RangeMinB_N112))+Port_RangeMinB_N112;
float l9_19;
...
float l9_22=(((l9_17-Port_RangeMinA_N053)/((Port_RangeMaxA_N053-Port_RangeMinA_N053)+1e-06))*(Port_RangeMaxB_N053-Port_RangeMinB_N053))+Port_RangeMinB_N053;
float l9_23;
...
float l9_27=(((borderAlpha-Port_RangeMinA_N110)/((Port_RangeMaxA_N110-Port_RangeMinA_N110)+1e-06))*(Port_RangeMaxB_N110-Port_RangeMinB_N110))+Port_RangeMinB_N110;
float l9_28;
...
{
bool l9_50=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0));
float l9_51=l9_48.x;
sc_SoftwareWrapEarly(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x);
float l9_52=l9_51;
float l9_53=l9_48.y;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y);
float l9_54=l9_53;
vec2 l9_55;
float l9_56;
#if (SC_USE_UV_MIN_MAX_matcapTexture)
{
bool l9_57;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_58=l9_52;
float l9_59=1.0;
sc_ClampUV(l9_58,matcapTextureUvMinMax.x,matcapTextureUvMinMax.z,l9_57,l9_59);
float l9_60=l9_58;
float l9_61=l9_59;
bool l9_62;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y==3;
}
#else
{
l9_62=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_63=l9_54;
float l9_64=l9_61;
sc_ClampUV(l9_63,matcapTextureUvMinMax.y,matcapTextureUvMinMax.w,l9_62,l9_64);
l9_56=l9_64;
l9_55=vec2(l9_60,l9_63);
}
#else
...
#endif
vec2 l9_65=sc_TransformUV(l9_55,(int(SC_USE_UV_TRANSFORM_matcapTexture)!=0),matcapTextureTransform);
float l9_66=l9_65.x;
float l9_67=l9_56;
sc_SoftwareWrapLate(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x,l9_50,l9_67);
float l9_68=l9_65.y;
float l9_69=l9_67;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y,l9_50,l9_69);
float l9_70=l9_69;
vec3 l9_71=sc_SamplingCoordsViewToGlobal(vec2(l9_66,l9_68),matcapTextureLayout,matcapTextureGetStereoViewIndex());
vec4 l9_72=texture(matcapTextureArrSC,l9_71,0.0);
vec4 l9_73;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_73=mix(matcapTextureBorderColor,l9_72,vec4(l9_70));
}
#else
{
l9_73=l9_72;
...
#else
{
bool l9_74=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0));
float l9_75=l9_48.x;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x);
float l9_76=l9_75;
float l9_77=l9_48.y;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y);
float l9_78=l9_77;
vec2 l9_79;
float l9_80;
#if (SC_USE_UV_MIN_MAX_matcapTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_82=l9_76;
float l9_83=1.0;
sc_ClampUV(l9_82,matcapTextureUvMinMax.x,matcapTextureUvMinMax.z,l9_81,l9_83);
float l9_84=l9_82;
float l9_85=l9_83;
bool l9_86;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_86=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y==3;
}
#else
{
l9_86=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_87=l9_78;
float l9_88=l9_85;
sc_ClampUV(l9_87,matcapTextureUvMinMax.y,matcapTextureUvMinMax.w,l9_86,l9_88);
l9_80=l9_88;
l9_79=vec2(l9_84,l9_87);
}
#else
...
#endif
vec2 l9_89=sc_TransformUV(l9_79,(int(SC_USE_UV_TRANSFORM_matcapTexture)!=0),matcapTextureTransform);
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x,l9_74,l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y,l9_74,l9_93);
float l9_94=l9_93;
vec3 l9_95=sc_SamplingCoordsViewToGlobal(vec2(l9_90,l9_92),matcapTextureLayout,matcapTextureGetStereoViewIndex());
vec4 l9_96=texture(matcapTexture,l9_95.xy,0.0);
vec4 l9_97;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_97=mix(matcapTextureBorderColor,l9_96,vec4(l9_94));
}
#else
{
l9_97=l9_96;
...
{
l9_98=pow(l9_44,Port_Input1_N087);
}
vec4 l9_99=vec4(l9_98);
vec4 l9_100=max(l9_45,mix(Port_Input0_N024,Port_Input1_N024,l9_99));
float l9_101=borderAlpha*l9_44;
float l9_102;
if (l9_32<=0.0)
{
l9_102=0.0;
...
{
l9_102=pow(l9_32,(((borderAlpha-Port_RangeMinA_N129)/((Port_RangeMaxA_N129-Port_RangeMinA_N129)+1e-06))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_103=(backingAlpha*Port_Input1_N052)*l9_102;
float l9_104=(isHovered*smoothstep(Port_Input0_N166*l9_2,Port_Input1_N165,l9_16))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_33),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_33),0.0,1.0))*((((0.0+((l9_36*l9_39)*scaleHandles.x))+((l9_41*l9_39)*scaleHandles.y))+((l9_41*l9_43)*scaleHandles.z))+((l9_36*l9_43)*scaleHandles.w)));
vec4 l9_105=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_105.w=l9_104;
vec4 l9_106=mix(vec4((Port_Value_N151.xyz*l9_103)+((l9_100*vec4(Port_Input1_N149)).xyz*l9_101),max(l9_103,l9_101)),l9_105,vec4(l9_104));
vec3 l9_107=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_21),vec3(l9_25))+l9_106.xyz;
float l9_108=max((l9_106.w*opacity)*max(Port_Input0_N107-cutOutCenter,smoothstep(Port_Input0_N106,Port_Input0_N091/l9_1,length(max(abs(l9_12)-vec2(Port_Input1_N085),Port_Input1_N102)/l9_15))),l9_25*((Port_Value_N116+0.001)-0.001));
vec4 l9_109=vec4(l9_107.x,l9_107.y,l9_107.z,vec4(0.0).w);
l9_109.w=l9_108;
if ((step(l9_108,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_108<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_108<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_112=clamp(l9_108*2.0,0.0,1.0);
}
#else
{
float l9_113;
...
{
l9_113=clamp(dot(l9_109.xyz,vec3(l9_108)),0.0,1.0);
}
#else
{
float l9_114;
...
{
l9_115=(1.0-dot(l9_109.xyz,vec3(0.33333001)))*l9_108;
}
#else
{
float l9_116;
...
{
l9_116=(1.0-clamp(dot(l9_109.xyz,vec3(1.0)),0.0,1.0))*l9_108;
}
#else
{
float l9_117;
...
{
l9_117=clamp(dot(l9_109.xyz,vec3(1.0)),0.0,1.0)*l9_108;
}
#else
{
float l9_118;
#if (sc_BlendMode_Add)
{
l9_118=clamp(dot(l9_109.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_119;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_119=clamp(dot(l9_109.xyz,vec3(1.0)),0.0,1.0)*l9_108;
}
#else
{
float l9_120;
...
{
l9_120=dot(l9_109.xyz,vec3(0.33333001))*l9_108;
}
#else
{
float l9_121;
#if (sc_BlendMode_Min)
{
l9_121=1.0-clamp(dot(l9_109.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_122;
#if (sc_BlendMode_Max)
{
l9_122=clamp(dot(l9_109.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_122=1.0;
...
#endif
l9_110=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_109.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_111);
}
#else
{
vec4 l9_123;
...
#if (sc_FramebufferFetch)
{
vec4 l9_126=sc_readFragData0_Platform();
vec4 l9_127;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_128=l9_126;
l9_128.x=l9_126.x+_sc_framebufferFetchMarker;
l9_127=l9_128;
}
#else
{
...
{
l9_131=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_129,sc_ScreenTextureLayout,l9_130),0.0);
}
#else
{
l9_131=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_129,sc_ScreenTextureLayout,l9_130).xy,0.0);
}
#endif
l9_125=l9_131;
}
...
{
vec4 l9_133=l9_125;
l9_133.x=l9_125.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_132=l9_133;
}
#else
{
...
#endif
vec3 l9_134=mix(l9_132.xyz,definedBlend(l9_132.xyz,l9_109.xyz).xyz,vec3(l9_108));
vec4 l9_135=vec4(l9_134.x,l9_134.y,l9_134.z,vec4(0.0).w);
l9_135.w=1.0;
l9_124=l9_135;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_136=vec4(mix(vec3(1.0),l9_109.xyz,vec3(l9_108)),l9_108);
}
#else
{
vec4 l9_137;
...
#endif
l9_137=vec4(l9_109.xyz*l9_138,l9_138);
}
#else
{
l9_137=l9_109;
...
{
l9_141=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_141=vec4(0.0);
...
vec4 l9_143=outputMotionVectorsIfNeeded(varPos,max(l9_142,vec4(0.0)));
