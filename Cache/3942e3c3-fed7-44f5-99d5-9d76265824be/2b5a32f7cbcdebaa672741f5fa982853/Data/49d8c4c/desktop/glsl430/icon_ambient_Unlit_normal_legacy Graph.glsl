...
//spec_const bool sc_ProxyAlphaOne 85 0
//spec_const bool sc_RenderAlphaToColor 86 0
//spec_const bool sc_ScreenTextureHasSwappedViews 87 0
//spec_const bool sc_ShaderComplexityAnalyzer 88 0
//spec_const bool sc_TAAEnabled 89 0
//spec_const bool sc_UseFramebufferFetchMarker 90 0
//spec_const bool sc_VertexBlending 91 0
//spec_const bool sc_VertexBlendingUseNormals 92 0
//spec_const bool uv2EnableAnimation 93 0
//spec_const bool uv3EnableAnimation 94 0
//spec_const int NODE_13_DROPLIST_ITEM 95 0
//spec_const int NODE_27_DROPLIST_ITEM 96 0
//spec_const int NODE_38_DROPLIST_ITEM 97 0
//spec_const int NODE_49_DROPLIST_ITEM 98 0
//spec_const int NODE_69_DROPLIST_ITEM 99 0
//spec_const int NODE_76_DROPLIST_ITEM 100 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 101 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 102 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 103 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 104 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 105 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 106 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 107 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 108 -1
//spec_const int baseTexLayout 109 0
//spec_const int emissiveTexLayout 110 0
//spec_const int intensityTextureLayout 111 0
//spec_const int opacityTexLayout 112 0
//spec_const int sc_DepthBufferMode 113 0
//spec_const int sc_RenderingSpace 114 -1
//spec_const int sc_ScreenTextureLayout 115 0
//spec_const int sc_ShaderCacheConstant 116 0
//spec_const int sc_SkinBonesCount 117 0
//spec_const int sc_StereoRenderingMode 118 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 119 0
//spec_const int sc_StereoViewID 120 0
//SG_REFLECTION_END
...
#if (sc_FramebufferFetch)
{
vec4 l9_187=sc_readFragData0_Platform();
vec4 l9_188;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_189=l9_187;
l9_189.x=l9_187.x+_sc_framebufferFetchMarker;
l9_188=l9_189;
}
#else
{
...
{
l9_191=1-sc_GetStereoViewIndex();
}
#else
{
l9_191=sc_GetStereoViewIndex();
}
#endif
vec4 l9_192;
#if (sc_ScreenTextureLayout==2)
{
l9_192=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_190,sc_ScreenTextureLayout,l9_191),0.0);
}
#else
{
l9_192=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_190,sc_ScreenTextureLayout,l9_191).xy,0.0);
}
#endif
l9_186=l9_192;
}
...
{
vec4 l9_194=l9_186;
l9_194.x=l9_186.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_193=l9_194;
}
#else
{
...
#endif
vec3 l9_195=mix(l9_193.xyz,definedBlend(l9_193.xyz,l9_168.xyz).xyz,vec3(l9_112));
vec4 l9_196=vec4(l9_195.x,l9_195.y,l9_195.z,vec4(0.0).w);
l9_196.w=1.0;
l9_185=l9_196;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_197=vec4(mix(vec3(1.0),l9_168.xyz,vec3(l9_112)),l9_112);
}
#else
{
vec4 l9_198;
...
#endif
l9_198=vec4(l9_168.xyz*l9_199,l9_199);
}
#else
{
l9_198=l9_168;
...
{
l9_202=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_202=vec4(0.0);
...
vec4 l9_204=outputMotionVectorsIfNeeded(varPos,max(l9_203,vec4(0.0)));
vec4 l9_205=clamp(l9_204,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_206=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_206-0.0039215689)),min(1.0,l9_206+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_207).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_208=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_207).xy);
float l9_209=packValue(l9_208);
int l9_216=int(l9_205.w*255.0);
float l9_217=packValue(l9_216);
sc_writeFragData0Internal(vec4(packValue(l9_208),packValue(l9_208),packValue(l9_208),packValue(l9_208)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_209,packValue(l9_208),packValue(l9_208),packValue(l9_208)));
sc_writeFragData2(vec4(l9_217,packValue(l9_216),packValue(l9_216),packValue(l9_216)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_220).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_225==0)
{
l9_228=texture(sc_OITAlpha0,l9_220);
l9_227=texture(sc_OITDepthLow0,l9_220);
l9_226=texture(sc_OITDepthHigh0,l9_220);
}
else
{
l9_228=vec4(0.0);
...
if (l9_225==1)
{
l9_231=texture(sc_OITAlpha1,l9_220);
l9_230=texture(sc_OITDepthLow1,l9_220);
l9_229=texture(sc_OITDepthHigh1,l9_220);
}
else
{
l9_231=l9_228;
...
if (any(notEqual(l9_229,vec4(0.0)))||any(notEqual(l9_230,vec4(0.0))))
{
int l9_232[8]=l9_221;
unpackValues(l9_229.w,l9_225,l9_232);
unpackValues(l9_229.z,l9_225,l9_232);
unpackValues(l9_229.y,l9_225,l9_232);
unpackValues(l9_229.x,l9_225,l9_232);
unpackValues(l9_230.w,l9_225,l9_232);
unpackValues(l9_230.z,l9_225,l9_232);
unpackValues(l9_230.y,l9_225,l9_232);
unpackValues(l9_230.x,l9_225,l9_232);
int l9_241[8]=l9_222;
unpackValues(l9_231.w,l9_225,l9_241);
unpackValues(l9_231.z,l9_225,l9_241);
unpackValues(l9_231.y,l9_225,l9_241);
unpackValues(l9_231.x,l9_225,l9_241);
}
l9_225++;
continue;
}
...
vec4 l9_246=texture(sc_OITFilteredDepthBoundsTexture,l9_220);
vec2 l9_247=l9_246.xy;
int l9_248;
#if (sc_SkinBonesCount>0)
{
l9_248=encodeDepth(((1.0-l9_246.x)*1000.0)+getDepthOrderingEpsilon(),l9_247);
}
#else
{
l9_248=0;
...
#endif
int l9_249=encodeDepth(viewSpaceDepth(),l9_247);
vec4 l9_250;
l9_250=l9_205*l9_205.w;
vec4 l9_251;
int l9_252=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_252<8)
{
int l9_253=l9_221[l9_252];
int l9_254=l9_249-l9_248;
bool l9_255=l9_253<l9_254;
bool l9_256;
if (l9_255)
{
l9_256=l9_221[l9_252]>0;
}
else
{
l9_256=l9_255;
...
if (l9_256)
{
vec3 l9_257=l9_250.xyz*(1.0-(float(l9_222[l9_252])/255.0));
l9_251=vec4(l9_257.x,l9_257.y,l9_257.z,l9_250.w);
}
else
{
l9_251=l9_250;
...
sc_writeFragData0Internal(l9_250,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_205,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
