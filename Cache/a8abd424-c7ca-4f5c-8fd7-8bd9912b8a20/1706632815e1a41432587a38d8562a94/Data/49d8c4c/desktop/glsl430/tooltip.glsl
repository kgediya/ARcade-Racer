...
{
l9_90=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_88,sc_ScreenTextureLayout,l9_89),0.0);
}
#else
{
l9_90=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_88,sc_ScreenTextureLayout,l9_89).xy,0.0);
}
#endif
l9_84=l9_90;
}
...
{
vec4 l9_92=l9_84;
l9_92.x=l9_84.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_91=l9_92;
}
#else
{
...
#endif
vec3 l9_93=mix(l9_91.xyz,definedBlend(l9_91.xyz,l9_65.xyz).xyz,vec3(l9_66));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_95=vec4(mix(vec3(1.0),l9_65.xyz,vec3(l9_66)),l9_66);
}
#else
{
vec4 l9_96;
...
#endif
l9_96=vec4(l9_65.xyz*l9_97,l9_97);
}
#else
{
l9_96=l9_65;
...
{
l9_100=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_100=vec4(0.0);
...
vec4 l9_102=outputMotionVectorsIfNeeded(varPos,max(l9_101,vec4(0.0)));
...
#endif
int l9_106=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_105).xy);
...
if (l9_123==0)
{
l9_126=texture(sc_OITAlpha0,l9_118);
l9_125=texture(sc_OITDepthLow0,l9_118);
l9_124=texture(sc_OITDepthHigh0,l9_118);
}
else
{
l9_126=vec4(0.0);
...
if (l9_123==1)
{
l9_129=texture(sc_OITAlpha1,l9_118);
l9_128=texture(sc_OITDepthLow1,l9_118);
l9_127=texture(sc_OITDepthHigh1,l9_118);
}
else
{
l9_129=l9_126;
...
vec4 l9_144=texture(sc_OITFilteredDepthBoundsTexture,l9_118);
