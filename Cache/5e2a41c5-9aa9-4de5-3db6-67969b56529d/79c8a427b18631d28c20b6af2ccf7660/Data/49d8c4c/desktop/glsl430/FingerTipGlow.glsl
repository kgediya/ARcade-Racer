...
//sampler sampler mainTexSmpSC 0:22
...
//texture texture2D mainTex 0:4:0:22
...
//texture texture2DArray mainTexArrSC 0:33:0:22
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTex 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTex 82 -1
//spec_const int intensityTextureLayout 83 0
//spec_const int mainTexLayout 84 0
...
#if (mainTexLayout==2)
{
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0));
float l9_4=l9_0.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x);
float l9_5=l9_4;
float l9_6=l9_0.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,mainTexUvMinMax.x,mainTexUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,mainTexUvMinMax.y,mainTexUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),mainTexLayout,mainTexGetStereoViewIndex());
vec4 l9_25=texture(mainTexArrSC,l9_24,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_26=mix(mainTexBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#else
{
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0));
float l9_28=l9_0.x;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x);
float l9_29=l9_28;
float l9_30=l9_0.y;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
#if (SC_USE_UV_MIN_MAX_mainTex)
...
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,mainTexUvMinMax.x,mainTexUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,mainTexUvMinMax.y,mainTexUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x,l9_27,l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y,l9_27,l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),mainTexLayout,mainTexGetStereoViewIndex());
vec4 l9_49=texture(mainTex,l9_48.xy,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_50=mix(mainTexBorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
#endif
vec3 l9_51=vec3(l9_2.xyz)*vec3(glowColor.xyz);
float l9_52=((glowColor.w*l9_2.w)*brightness)*max(pinchBrightness,pokeBrightness);
...
#endif
sc_writeFragData0Internal(max(l9_54,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_56;
...
{
l9_77=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_75,sc_ScreenTextureLayout,l9_76),0.0);
}
#else
{
l9_77=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_75,sc_ScreenTextureLayout,l9_76).xy,0.0);
}
#endif
l9_71=l9_77;
}
...
#endif
vec3 l9_80=mix(l9_78.xyz,definedBlend(l9_78.xyz,l9_53.xyz).xyz,vec3(l9_52));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_82=vec4(mix(vec3(1.0),l9_53.xyz,vec3(l9_52)),l9_52);
}
#else
{
vec4 l9_83;
...
#endif
l9_83=vec4(l9_53.xyz*l9_84,l9_84);
}
#else
{
l9_83=l9_53;
