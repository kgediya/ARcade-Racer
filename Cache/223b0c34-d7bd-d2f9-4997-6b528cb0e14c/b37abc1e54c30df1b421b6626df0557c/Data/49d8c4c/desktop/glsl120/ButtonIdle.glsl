...
vec3 l9_6=l9_3*l9_5;
vec3 l9_7=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_6,0.0)).xyz*vec3(Port_Input1_N053))+vec3(Port_Input2_N053);
int l9_8;
...
#endif
bool l9_9=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0));
float l9_10=l9_7.x;
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_11=l9_10;
float l9_12=l9_7.y;
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_13=l9_12;
vec2 l9_14;
float l9_15;
...
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_17=l9_11;
float l9_18=1.0;
sc_ClampUV(l9_17,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_16,l9_18);
float l9_19=l9_17;
float l9_20=l9_18;
bool l9_21;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_21=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_22=l9_13;
float l9_23=l9_20;
sc_ClampUV(l9_22,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_21,l9_23);
l9_15=l9_23;
...
#endif
vec2 l9_24=sc_TransformUV(l9_14,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_25=l9_24.x;
float l9_26=l9_15;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,l9_9,l9_26);
float l9_27=l9_24.y;
float l9_28=l9_26;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,l9_9,l9_28);
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),additional_settings_btn_refl_texLayout,l9_8);
vec4 l9_31=texture2D(additional_settings_btn_refl_tex,l9_30.xy,0.0);
vec4 l9_32;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_32=mix(additional_settings_btn_refl_texBorderColor,l9_31,vec4(l9_29));
}
#else
{
l9_32=l9_31;
...
#endif
vec4 l9_33=vec4(Port_Import_N006)*l9_32;
float l9_34=clamp(length((varPackedTex.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_35;
if (l9_34<Port_Position1_N007)
{
l9_35=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_34/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_36;
if (l9_34<Port_Position2_N007)
{
l9_36=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_34-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_36=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_34-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_35=l9_36;
}
bool l9_37=PreviewEnabled==1;
bool l9_38;
if (l9_37)
{
l9_38=!l9_0;
...
float l9_42=clamp(l9_35.x,0.0,1.0);
float l9_43;
if (l9_42<Port_Position1_N018)
{
l9_43=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_42/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_44;
if (l9_42<Port_Position2_N018)
{
l9_44=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_42-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_45;
if (l9_42<Port_Position3_N018)
{
l9_45=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_42-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_45=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_42-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_44=l9_45;
}
l9_43=l9_44;
}
vec4 l9_46=vec4(l9_35.x,l9_35.y,l9_35.z,vec4(0.0).w);
l9_46.w=l9_43;
vec2 l9_47=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
bool l9_48=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0));
float l9_49=l9_47.x;
float l9_50=l9_49;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_51=l9_50;
float l9_52=l9_47.y;
float l9_53=l9_52;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_54=l9_53;
vec2 l9_55;
float l9_56;
...
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_58=l9_51;
float l9_59=1.0;
sc_ClampUV(l9_58,iconUvMinMax.x,iconUvMinMax.z,l9_57,l9_59);
float l9_60=l9_58;
float l9_61=l9_59;
bool l9_62;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_62=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_63=l9_54;
float l9_64=l9_61;
sc_ClampUV(l9_63,iconUvMinMax.y,iconUvMinMax.w,l9_62,l9_64);
l9_56=l9_64;
...
{
l9_56=1.0;
l9_55=vec2(l9_51,l9_54);
}
#endif
vec2 l9_65=sc_TransformUV(l9_55,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_66=l9_65.x;
float l9_67=l9_56;
sc_SoftwareWrapLate(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_48,l9_67);
float l9_68=l9_65.y;
float l9_69=l9_67;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_48,l9_69);
float l9_70=l9_69;
vec3 l9_71=sc_SamplingCoordsViewToGlobal(vec2(l9_66,l9_68),iconLayout,iconGetStereoViewIndex());
vec4 l9_72=texture2D(icon,l9_71.xy,0.0);
vec4 l9_73;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_73=mix(iconBorderColor,l9_72,vec4(l9_70));
}
#else
{
l9_73=l9_72;
...
{
float l9_75=l9_49;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_76=l9_75;
float l9_77=l9_52;
...
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,l9_48,l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,l9_48,l9_93);
float l9_94=l9_93;
...
{
l9_74=Port_Input2_N003;
}
vec4 l9_98=vec4(l9_74);
vec4 l9_99=mix(l9_33+l9_46,l9_73,l9_98);
...
{
l9_103=clamp(l9_100*2.0,0.0,1.0);
}
#else
{
float l9_104;
...
{
l9_104=clamp(dot(l9_99.xyz,vec3(l9_100)),0.0,1.0);
}
#else
{
float l9_105;
...
{
l9_106=(1.0-dot(l9_99.xyz,vec3(0.33333001)))*l9_100;
}
#else
{
float l9_107;
...
{
l9_107=(1.0-clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0))*l9_100;
}
#else
{
float l9_108;
...
{
l9_108=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0)*l9_100;
}
#else
{
float l9_109;
#if (sc_BlendMode_Add)
{
l9_109=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_111=dot(l9_99.xyz,vec3(0.33333001))*l9_100;
}
#else
{
float l9_112;
#if (sc_BlendMode_Min)
{
l9_112=1.0-clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_113;
#if (sc_BlendMode_Max)
{
l9_113=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_113=1.0;
...
#endif
l9_101=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_99.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_102);
}
#else
{
vec4 l9_114;
...
#if (sc_FramebufferFetch)
{
vec4 l9_117=sc_readFragData0_Platform();
vec4 l9_118;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_119=l9_117;
l9_119.x=l9_117.x+_sc_framebufferFetchMarker;
l9_118=l9_119;
}
#else
{
...
#endif
l9_116=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_120,sc_ScreenTextureLayout,l9_121).xy,0.0);
}
#endif
vec4 l9_122;
...
{
vec4 l9_123=l9_116;
l9_123.x=l9_116.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_122=l9_123;
}
#else
{
...
#endif
vec3 l9_124=mix(l9_122.xyz,definedBlend(l9_122.xyz,l9_99.xyz).xyz,vec3(l9_100));
vec4 l9_125=vec4(l9_124.x,l9_124.y,l9_124.z,vec4(0.0).w);
l9_125.w=1.0;
l9_115=l9_125;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_126=vec4(mix(vec3(1.0),l9_99.xyz,vec3(l9_100)),l9_100);
}
#else
{
vec4 l9_127;
...
#endif
l9_127=vec4(l9_99.xyz*l9_128,l9_128);
}
#else
{
l9_127=l9_99;
...
{
l9_131=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_131=vec4(0.0);
...
vec4 l9_133=outputMotionVectorsIfNeeded(varPos,max(l9_132,vec4(0.0)));
vec4 l9_134=clamp(l9_133,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_135=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_135-0.0039215689)),min(1.0,l9_135+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_136).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_137=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_136).xy);
float l9_138=packValue(l9_137);
int l9_145=int(l9_134.w*255.0);
float l9_146=packValue(l9_145);
sc_writeFragData0Internal(vec4(packValue(l9_137),packValue(l9_137),packValue(l9_137),packValue(l9_137)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_138,packValue(l9_137),packValue(l9_137),packValue(l9_137)));
sc_writeFragData2(vec4(l9_146,packValue(l9_145),packValue(l9_145),packValue(l9_145)));
...
if (l9_154==0)
{
l9_157=texture2D(sc_OITAlpha0,l9_149);
l9_156=texture2D(sc_OITDepthLow0,l9_149);
l9_155=texture2D(sc_OITDepthHigh0,l9_149);
}
else
{
l9_157=vec4(0.0);
...
if (l9_154==1)
{
l9_160=texture2D(sc_OITAlpha1,l9_149);
l9_159=texture2D(sc_OITDepthLow1,l9_149);
l9_158=texture2D(sc_OITDepthHigh1,l9_149);
}
else
{
l9_160=l9_157;
...
if (any(notEqual(l9_158,vec4(0.0)))||any(notEqual(l9_159,vec4(0.0))))
{
int l9_161[8]=l9_150;
unpackValues(l9_158.w,l9_154,l9_161);
unpackValues(l9_158.z,l9_154,l9_161);
unpackValues(l9_158.y,l9_154,l9_161);
unpackValues(l9_158.x,l9_154,l9_161);
unpackValues(l9_159.w,l9_154,l9_161);
unpackValues(l9_159.z,l9_154,l9_161);
unpackValues(l9_159.y,l9_154,l9_161);
unpackValues(l9_159.x,l9_154,l9_161);
int l9_170[8]=l9_151;
unpackValues(l9_160.w,l9_154,l9_170);
unpackValues(l9_160.z,l9_154,l9_170);
unpackValues(l9_160.y,l9_154,l9_170);
unpackValues(l9_160.x,l9_154,l9_170);
}
l9_154++;
continue;
}
...
vec4 l9_175=texture2D(sc_OITFilteredDepthBoundsTexture,l9_149);
vec2 l9_176=l9_175.xy;
int l9_177;
#if (sc_SkinBonesCount>0)
{
l9_177=encodeDepth(((1.0-l9_175.x)*1000.0)+getDepthOrderingEpsilon(),l9_176);
}
#else
{
l9_177=0;
...
#endif
int l9_178=encodeDepth(viewSpaceDepth(),l9_176);
vec4 l9_179;
l9_179=l9_134*l9_134.w;
vec4 l9_180;
int l9_181=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_181<8)
{
int l9_182=l9_150[l9_181];
int l9_183=l9_178-l9_177;
bool l9_184=l9_182<l9_183;
bool l9_185;
if (l9_184)
{
l9_185=l9_150[l9_181]>0;
}
else
{
l9_185=l9_184;
...
if (l9_185)
{
vec3 l9_186=l9_179.xyz*(1.0-(float(l9_151[l9_181])/255.0));
l9_180=vec4(l9_186.x,l9_186.y,l9_186.z,l9_179.w);
}
else
{
l9_180=l9_179;
