...
// @input SceneObject colliderPlane
...
var Module = require("../../../../Modules/Src/Assets/World Query Hit - Spawn On Surface.lspkg/WorldQueryHitExample");
Object.setPrototypeOf(script, Module.NewScript.prototype);
script.__initialize();
let awakeEvent = script.createEvent("OnAwakeEvent");
awakeEvent.bind(() => {
    checkUndefined("indexToSpawn", []);
    checkUndefined("colliderPlane", []);
