...
if ((status*1.0)!=0.0)
{
float l9_4=(((size-Port_RangeMinA_N050)/((Port_RangeMaxA_N050-Port_RangeMinA_N050)+1e-06))*(Port_RangeMaxB_N050-Port_RangeMinB_N050))+Port_RangeMinB_N050;
float l9_5=clamp(((((vec2((sc_ModelMatrixInverse*vec4(varPos,1.0)).y*Port_Input1_N049)+vec2((((offset-Port_RangeMinA_N035)/((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*(((((size-Port_RangeMinA_N048)/((Port_RangeMaxA_N048-Port_RangeMinA_N048)+1e-06))*(Port_RangeMaxB_N048-Port_RangeMinB_N048))+Port_RangeMinB_N048)-l9_4))+l9_4,0.0))-Port_Center_N039)*vec2((((scale-Port_RangeMinA_N046)/((Port_RangeMaxA_N046-Port_RangeMinA_N046)+1e-06))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046))+Port_Center_N039).x,0.0,1.0);
vec4 l9_6;
...
#endif
l9_31=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_35,sc_ScreenTextureLayout,l9_36).xy,0.0);
}
#endif
vec4 l9_37;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_50-0.0039215689)),min(1.0,l9_50+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_52),packValue(l9_52),packValue(l9_52),packValue(l9_52)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_49,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_48,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
