...
if ((status*1.0)!=0.0)
{
float l9_6=(((size-Port_RangeMinA_N050)/((Port_RangeMaxA_N050-Port_RangeMinA_N050)+1e-06))*(Port_RangeMaxB_N050-Port_RangeMinB_N050))+Port_RangeMinB_N050;
float l9_7=clamp(((((vec2(l9_1.y*Port_Input1_N049)+vec2((((offset-Port_RangeMinA_N035)/((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*(((((size-Port_RangeMinA_N048)/((Port_RangeMaxA_N048-Port_RangeMinA_N048)+1e-06))*(Port_RangeMaxB_N048-Port_RangeMinB_N048))+Port_RangeMinB_N048)-l9_6))+l9_6,0.0))-Port_Center_N039)*vec2((((scale-Port_RangeMinA_N046)/((Port_RangeMaxA_N046-Port_RangeMinA_N046)+1e-06))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046))+Port_Center_N039).x,0.0,1.0);
vec4 l9_8;
...
{
l9_41=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_39,sc_ScreenTextureLayout,l9_40),0.0);
}
#else
{
l9_41=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_39,sc_ScreenTextureLayout,l9_40).xy,0.0);
}
#endif
l9_35=l9_41;
}
